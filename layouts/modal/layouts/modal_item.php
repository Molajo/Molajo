...
?>
<form action="<?php echo JRoute::_('index.php?option='.$this->state->get('request.option').'&view='.$this->state->get('request.view').$function); ?>" method="post" name="adminForm" id="adminForm">
