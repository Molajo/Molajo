...
?>
<form action="<?php //echo MolajoRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="form-login">
	<fieldset class="loginform">
				...
				<label id="mod-login-language-lbl" for="lang">
                    <?php echo MolajoText::_('MOD_LOGIN_LANGUAGE'); ?>
                </label>
				<?php //echo $langs; ?>
					...
					<div class="button1">
						<div class="next">
							<a href="#" onclick="document.getElementById('form-login').submit();">
								<?php echo MolajoText::_('MOD_LOGIN_LOGIN'); ?></a>
						</div>
					</div>
				</div>

		<div class="clr"></div>
		<input type="submit" class="hidebtn" value="<?php echo MolajoText::_( 'MOD_LOGIN_LOGIN' ); ?>" />
