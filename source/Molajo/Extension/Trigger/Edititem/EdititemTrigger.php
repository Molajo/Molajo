 ...
 */
namespace Molajo\Extension\Trigger\Edititem;
 ...
 * @since       1.0
 */
class EdititemTrigger extends ContentTrigger
{
    /**
    ...
    protected function setFilter($connect, $primary_prefix)
    {
        ...
        Services::Registry()->set('Triggerdata', 'AdminGridFilters', $lists);
...
*/
    ...
    protected function setBatch($connect, $primary_prefix)
    {
        ...
        Services::Registry()->set('Triggerdata', 'AdminGridBatchFilters', $names_of_lists);
