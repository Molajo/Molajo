...
define([
    ...
    function (jQuery, Plugin, FloatingMenu, i18n, i18nCore) {
        ...
        // Creates a selector string with this resource's namepsace prefixed the each classname
        function nsSel() {
            var strBldr = [], prx = ns;
        ...
        // Creates string with this resource's namepsace prefixed the each classname
        function nsClass() {
            var strBldr = [], prx = ns;
            $.each(arguments, function () {
                strBldr.push(this == '' ? prx : prx + '-' + this);
