...
// collapsed, and at least one of the following holds:"
        function isEffectivelyContained(node, range) {
            ...
            if (node.hasChildNodes()
                && $_(node.childNodes).every(function (child) {
...
//@{
        ...
        function fixDisallowedAncestors(node, range) {
            ...
            if ($_(getAncestors(node)).every(function (ancestor) {
                ...
                if (isHtmlElement(node, ["dd", "dt"])) {
                    wrap([node],
                        function (sibling) {
                            return isHtmlElement(sibling, "dl") && !sibling.attributes.length
                        },
                        function () {
        ...
        function getSelectionListState() {
            ...
            if ($_(nodeList).every(function (node) {
                ...
                return isHtmlElement(node, "ul") || ("querySelector" in node && node.querySelector("ul"))
            })) {
                return "ol";
            }
            ...
            if ($_(nodeList).every(function (node) {
                ...
                && !$_(nodeList).some(function (node) {
                return isHtmlElement(node, "ol") || ("querySelector" in node && node.querySelector("ol"))
            })) {
                return "ul";
            }
        ...
        function blockExtend(range) {
            ...
            var liAncestors = $_(getAncestors(startNode).concat(startNode))
                .filter(function (ancestor) {
                    return isHtmlElement(ancestor, "li")
                })
                .slice(-1);
                ...
                $_(getAllContainedNodes(newRange, function (node) {
                    return isEditable(node)
                        ...
                        if ((isEditable(list.previousSibling) && isHtmlElement(list.previousSibling, tagName))
                            ...
                            wrap(children,
                                function (node) {
                                    return isHtmlElement(node, tagName)
                                },
                                function () {
                                    return null
                                },
                    ...
                    fixDisallowedAncestors(
                        wrap(sublist,
                            $_(["div", "p"]).indexOf(value) == -1
                                ? function (node) {
                                return isHtmlElement(node, value) && !node.attributes.length
                            }
                                : function () {
                                return false
                            },
