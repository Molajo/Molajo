<?php $page_title = "QA, Browser Support and Known Issues"; ?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="six columns">
                <h3>QA</h3>
                <h4 class="subheader">Foundation's no use to you or anyone else if it doesn't work. On this page you can
                    see the current state of browser support, as well as known issues, for Foundation. Found a bug? <a
                        href="mailto:foundation@zurb.com">Let us know &rarr;</a></h4>
                <hr/>
...
-->
                ...
                <ol>
                    <li>Reveal uses RGBa colors, which IE7 does not support. You can manually exchange RGBa for PNGs to
                        provide IE7 support in Reveal
                    </li>
                    <li>This includes the shipping browser on the Motorola XOOM and several newer Android phones.
                        However, there is no single Android browser so testing is slightly constrained.
                    </li>
                </ol>
                ...
                <h4>Known Issues</h4>
                <ul class="disc">
                    <li><em>There are currently no major known issues. Visit the <a
                        href="https://github.com/zurb/foundation/issues?sort=created&direction=desc&state=open">Github
                        Issues page</a> for individual reports on smaller bugs.</em></li>
                </ul>
