...
<?php include("includes/_documentation_head.php"); ?>
    ...
    <div class="container">
            ...
            <div class="six columns">
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <br/>
                        <strong>OR</strong> the new hotness option is to just add a data-reveal-id to the object which
                        you want to fire the modal when clicked...<br/><br/>
                        ...
                        trigger (since the trigger is always listening for this). You can also pass any of the
                        parameters
        ...
        <div id="testModal" class="reveal-modal">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In ultrices aliquet placerat. Duis pulvinar orci
                et nisi euismod vitae tempus lorem consectetur. Duis at magna quis turpis mattis venenatis eget id
                diam. </p>
