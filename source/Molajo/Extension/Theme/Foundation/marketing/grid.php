<?php $page_title = "Flexible, Fluid Grid" ?>
    ...
    <div id="insideContainer" class="container">
        ...
        <div class="row">
            <div class="twelve columns">
                ...
                <p>You've probably used a grid framework before &mdash; we think you'll like this one. It's a 12 column
                    flexible grid that can scale out to an arbitrary size (defined by the max-width of the row) that's
                    also easily nested, so you can build out complicated layouts without creating a lot of custom
                    elements. And when the Grid isn't enough for your site, it just gets out of the way. <a
                        href="docs/grid.php">Grid docs &rarr;</a></p>
            </div>
        </div>
        <br><br>
