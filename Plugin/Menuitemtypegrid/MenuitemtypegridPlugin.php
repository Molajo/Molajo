 ...
 */
namespace Molajo\Plugin\Menuitemtypegrid;
 ...
 * @since       1.0
 */
class MenuitemtypegridPlugin extends Plugin
{
    /**
     * Prepares data for the Administrator Grid  - run MenuitemtypegridPlugin after AdminmenuPlugin
     *
     * @return boolean
     * @since   1.0
     */
