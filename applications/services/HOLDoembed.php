 ...
 *
 * @package     Molajo
 * @subpackage  Oembed Service
 * @since       1.0
 */

/**
 * Usage:
 * MolajoOembedService::getProvider
...
class MolajoOembedService
{
    ...
    function getProvider($option_URL, $option_MediaClass = '')
    {
        ...
        $read = JFile::readfile(MOLAJO_BASE_FOLDER . '/media/MediaEmbedConfiguration.json');
