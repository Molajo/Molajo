...
//        $results = Molajo::App()->triggerEvent('onUserLogout', array($parameters, $options));
...
//        Molajo::App()->triggerEvent('onUserLogoutFailure', array($parameters));
