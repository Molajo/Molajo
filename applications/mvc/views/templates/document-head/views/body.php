...
?>
    ...
    <link rel="stylesheet" href="<?php echo $this->row->url; ?>"<?php if ((int)Molajo::App()->get('html5', 1) == 0): ?> type="<?php echo $this->row->mimetype; ?>"<?php endif; ?><?php if ($this->row->media != null): ?> type="<?php echo $this->row->media; ?>"<?php endif; ?><?php if (trim($this->row->attributes) != ''): ?><?php echo $this->row->attributes;?><?php endif; ?><?php echo $end; ?>
<?php
...
?>
    <style<?php if ((int)Molajo::App()->get('html5', 1) == 0): ?> type="<?php echo $this->row->mimetype; ?>" <?php endif; ?>>
    <?php
