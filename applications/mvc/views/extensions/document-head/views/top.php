...
<?php if ($this->parameters->get('html5', true) === true): ?>
    <meta charset="UTF-8" />
<?php else : ?>
...
<?php if (trim($this->row->favicon) == ''):
    ...
    <link rel="shortcut icon" href="<?php echo $this->row->favicon; ?>" <?php if ($this->parameters->get('html5', true) === false): ?>type="image/x-icon" <?php endif;?>/>
<?php endif; ?>