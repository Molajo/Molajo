...
/**
 * MolajoForm's helper class.
 * Provides a storage for filesystem's paths where MolajoForm's entities reside and methods for creating those entities.
...
class MolajoFormHelper
{
    ...
    /**
     * Static array of MolajoForm's entity objects for re-use.
    ...
    /**
     * Attempt to import the MolajoFormField class file if it isn't already imported.
     * You can use this method outside of MolajoForm for loading a field for inheritance or composition.
     *
    ...
    /**
     * Attempt to import the MolajoFormRule class file if it isn't already imported.
     * You can use this method outside of MolajoForm for loading a rule for inheritance or composition.
     *
    ...
    protected static function loadClass($entity, $type)
    {
        ...
        $paths = MolajoFormHelper::addPath($entity);
