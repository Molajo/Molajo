...
class MolajoFormFieldEditors extends MolajoFormFieldList
{
    ...
    protected function getOptions()
    {
        ...
        foreach ($options as $i => $option) {
            ...
            || $lang->load('plg_editors_' . $option->value, MOLAJO_DISTRO_PLUGINS . '/editors/' . $option->value, null, false, false)
            || $lang->load('plg_editors_' . $option->value, MOLAJO_BASE_FOLDER, $lang->getDefault(), false, false)
            || $lang->load('plg_editors_' . $option->value, MOLAJO_DISTRO_PLUGINS . '/editors/' . $option->value, $lang->getDefault(), false, false);
