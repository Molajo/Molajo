...
/**
 * Utility class for managing data attributes
 *
 * @package      Molajo
 * @subpackage   Attributes
 * @since        1.0
...
class MolajoAttribute
{
    ...
    public function requireClassFile($reportError = true)
    {
        ...
        if ($reportError === true) {
            MolajoController::getApplication()->setMessage(MolajoTextHelper::_('MOLAJO_INVALID_ATTRIBUTE_FILENAME') . ' ' . $class . ' ' . $classFile, 'error');
            return false;
        }
