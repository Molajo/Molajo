...
class MolajoAdapterTheme extends MolajoAdapterInstance
{
    ...
    public function install()
    {
        ...
        $this->parent->set('message', Services::Language()->_((string)$xml->description));

        // Lastly, we will copy the manifest file to its appropriate place.
        if (!$this->parent->copyManifest(-1)) {
            // Install failed, rollback changes
            $this->parent->abort(Services::Language()->_('JLIB_INSTALLER_ABORT_TPL_INSTALL_COPY_SETUP'));
    ...
    public function uninstall($id)
    {
        ...
        if (!$row->load((int)$id) || !strlen($row->element)) {
            MolajoError::raiseWarning(100, Services::Language()->_('JLIB_INSTALLER_ERROR_TPL_UNINSTALL_ERRORUNKOWNEXTENSION'));
            return false;
        }
        ...
        if (!$name) {
            MolajoError::raiseWarning(100, Services::Language()->_('JLIB_INSTALLER_ERROR_TPL_UNINSTALL_THEME_ID_EMPTY'));
        ...
        if ($db->loadResult() != 0) {
            MolajoError::raiseWarning(100, Services::Language()->_('JLIB_INSTALLER_ERROR_TPL_UNINSTALL_THEME_DEFAULT'));
        ...
        if (!$client) {
            MolajoError::raiseWarning(100, Services::Language()->_('JLIB_INSTALLER_ERROR_TPL_UNINSTALL_INVALID_CLIENT'));
            return false;
        }
        ...
        if (!($manifest instanceof SimpleXMLElement)) {
            ...
            MolajoError::raiseWarning(100, Services::Language()->_('JLIB_INSTALLER_ERROR_TPL_UNINSTALL_INVALID_NOTFOUND_MANIFEST'));
        ...
        {
            MolajoError::raiseWarning(100, Services::Language()->_('JLIB_INSTALLER_ERROR_TPL_UNINSTALL_THEME_DIRECTORY'));
            $retval = false;
        }
    ...
    function discover_install()
    {
        ...
        {
            MolajoError::raiseWarning(101, Services::Language()->_('JLIB_INSTALLER_ERROR_TPL_DISCOVER_STORE_DETAILS'));
    ...
    public function refreshManifestCache()
    {
        ...
        {
            MolajoError::raiseWarning(101, Services::Language()->_('JLIB_INSTALLER_ERROR_TPL_REFRESH_MANIFEST_CACHE'));
            return false;
        }
    }
}
