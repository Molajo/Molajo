            ...
            switch ($this->type)
            {
                ...
                case 'language':
                    ...
                    if ($tmp_application_id == null) {
                        MolajoError::raiseWarning(100, Services::Language()->translate('JLIB_INSTALLER_ERROR_EXTENSION_INVALID_CLIENT_IDENTIFIER'));
                    }
                    else
                    {
                ...
                default:
                    ...
                    if ($application = (string)$element->attributes()->application) {
                        $this->application_id = ApplicationHelper::getApplicationInfo($this->application, 1);
