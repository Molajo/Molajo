...
class MolajoAuthentication extends JObservable
{
    ...
    public function __construct()
    {
        ...
        if ($isLoaded) {
            ...
            MolajoError::raiseWarning('SOME_ERROR_CODE', TextHelper::_('JLIB_USER_ERROR_AUTHENTICATION_LIBRARIES'));
        }
    }
    ...
    public function authenticate($credentials, $options = Array())
    {
        ...
        foreach ($plugins as $plugin)
        {
            ...
            if (class_exists($className)) {
                ...
                MolajoError::raiseWarning(50, TextHelper::sprintf('JLIB_USER_ERROR_AUTHENTICATION_FAILED_LOAD_PLUGIN', $className));
                continue;
            }
                ...
                if (isset($options['silent']) && $options['silent']) {
                    ...
                    switch ($authorisation->status)
                    {
                        case MolajoAuthentication::STATUS_EXPIRED:
                            ...
                            return MolajoError::raiseWarning('102002', TextHelper::_('JLIB_LOGIN_EXPIRED'));
                            break;
                        case MolajoAuthentication::STATUS_DENIED:
                            $response->status = STATUS_DENIED;
                            return MolajoError::raiseWarning('102003', TextHelper::_('JLIB_LOGIN_DENIED'));
                            break;
                        default:
                            $response->status = STATUS_FAILURE;
                            return MolajoError::raiseWarning('102004', TextHelper::_('JLIB_LOGIN_AUTHORISATION'));
                            break;
                    }
                }
            }
