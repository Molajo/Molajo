 ...
 */
$fileHelper->requireClassFile(MOLAJO_EXTENSIONS_CORE . '/core/responder.php', 'MolajoResponder');
$fileHelper->requireClassFile(MOLAJO_EXTENSIONS_CORE . '/core/request.php', 'MolajoRequest');
$fileHelper->requireClassFile(MOLAJO_EXTENSIONS_CORE . '/core/parser.php', 'MolajoParser');
