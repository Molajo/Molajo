...
class MolajoMessage
{
    ...
    public static function renderMessage($MessageObject, $attribs = array())
    {
        ...
        $path = MOLAJO_EXTENSIONS_MessageS . '/' . $Message->extension_name . '/' . $Message->extension_name . '.php';

        // Load the Message
        if (file_exists($path)) {

            $lang = MolajoFactory::getLanguage();
            $lang->load($Message->extension_name, MOLAJO_EXTENSIONS_MessageS . '/' . $Message->extension_name, $lang->getDefault(), false, false);
