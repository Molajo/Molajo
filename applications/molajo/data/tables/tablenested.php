 ...
 * @link
 */
class MolajoTableNested extends MolajoTable
{
    /**
    ...
    public function setLocation($referenceId, $position = 'after')
    {
        ...
        if (($position != 'before') && ($position != 'after') &&
            ...
            $e = new MolajoException(MolajoTextHelper::sprintf('MOLAJO_DATABASE_ERROR_INVALID_LOCATION', get_class($this)));
            $this->setError($e);
            return false;
        }
    ...
    public function moveByReference($referenceId, $position = 'after', $pk = null)
    {
        ...
        if (in_array($referenceId, $children)) {
            $e = new MolajoException(MolajoTextHelper::sprintf('MOLAJO_DATABASE_ERROR_INVALID_NODE_RECURSION', get_class($this)));
            $this->setError($e);
            return false;
        }
    ...
    public function check()
    {
        ...
        if ($this->parent_id > 0) {
            ...
            else
            {
                ...
                {
                    $e = new MolajoException(MolajoTextHelper::sprintf('MOLAJO_DATABASE_ERROR_INVALID_PARENT_ID', get_class($this)));
                    $this->setError($e);
                }
            }
        }
    ...
    public function store($updateNulls = false)
    {
        ...
        if (empty($this->$k)) {
            ...
            else
            {
                ...
                $e = new MolajoException(MolajoTextHelper::_('MOLAJO_DATABASE_ERROR_INVALID_PARENT_ID'));
                $this->setError($e);
                return false;
            }
        }
    ...
    public function publish($pks = null, $state = 1, $userId = 0)
    {
        ...
        if (empty($pks)) {
            ...
            {
                $e = new MolajoException(MolajoTextHelper::sprintf('MOLAJO_DATABASE_ERROR_NO_ROWS_SELECTED', get_class($this)));
                $this->setError($e);
                return false;
            }
        }
            ...
            if ($node->parent_id) {
                ...
                if (!empty($rows)) {
                    $e = new MolajoException(
                        MolajoTextHelper::_('MOLAJO_DATABASE_ERROR_ANCESTOR_NODES_LOWER_STATUS')
                    );
                    $this->setError($e);
                    return false;
                }
    ...
    public function getRootId()
    {
        ...
        else
        {
            ...
            elseif (property_exists($this, 'alias'))
            {
                ...
                {
                    $e = new MolajoException(MolajoTextHelper::_('MOLAJO_DATABASE_ERROR_ROOT_NODE_NOT_FOUND'));
                    $this->setError($e);
                    return false;
                }
            }
