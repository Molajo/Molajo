 ...
 * data\Entity\ExtensionInstances
 *
...
class ExtensionInstances
{
     ...
     */
    public function addAssets(\data\Entity\Assets $asset)
    {
        $this->asset[] = $asset;
    }
     ...
     * Set extension
     *
     * @param data\Entity\Extensions $extension
     */
    public function setExtension(\data\Entity\Extensions $extension)
    {
