...
class MolajoFormFieldList extends MolajoFormField
{
    ...
    protected function getOptions()
    {
        ...
        foreach ($this->element->children() as $option) {
            ...
            $tmp = MolajoHTML::_('select.option', (string)$option['value'], MolajoTextHelper::alt(trim((string)$option), preg_replace('/[^a-zA-Z0-9_\-]/', '_', $this->name)), 'value', 'text', ((string)$option['disabled'] == 'true'));
