...
if (defined('JPATH_ROOT')) { } else { define('JPATH_ROOT', MOLAJO_BASE_FOLDER); }
if (defined('JPATH_CONFIGURATION')) { } else { define('JPATH_CONFIGURATION', MOLAJO_SITE_PATH); }
if (defined('JPATH_LIBRARIES')) { } else { define('JPATH_LIBRARIES', PLATFORM); }
if (defined('JOOMLA_LIBRARY')) { } else { define('JOOMLA_LIBRARY', PLATFORM.'/jplatform/joomla'); }
if (defined('JPATH_SITE')) { } else { define('JPATH_SITE', MOLAJO_BASE_FOLDER); }
if (defined('JPATH_ADMINISTRATOR')) { } else { define('JPATH_ADMINISTRATOR', MOLAJO_BASE_FOLDER); }
if (defined('JPATH_PLUGINS')) { } else { define('JPATH_PLUGINS', MOLAJO_CMS_PLUGINS); }
if (defined('JPATH_CACHE')) { } else { define('JPATH_CACHE', MOLAJO_SITE_PATH.'/cache'); }
if (defined('JPATH_MANIFESTS')) { } else { define('JPATH_MANIFESTS', MOLAJO_CMS_MANIFESTS); }
if (defined('JPATH_THEMES')) { } else { define('JPATH_THEMES', MOLAJO_CMS_TEMPLATES); }
if (defined('JPATH_COMPONENT')) { } else { define('JPATH_COMPONENT', MOLAJO_CMS_COMPONENTS); }
...
require_once MOLAJO_PLATFORM.'/language/text.php';
...
$filehelper->requireClassFile(MOLAJO_PLATFORM.'/language/language.php', 'MolajoLanguage');
