...
class MolajoFieldFeatured extends MolajoField
{
    ...
    {
        $options = array();
        $options[] = MolajoHTML::_('select.option', '0', TextServices::_('MOLAJO_OPTION_UNFEATURED'));
        $options[] = MolajoHTML::_('select.option', '1', TextServices::_('MOLAJO_OPTION_FEATURED'));
        return $options;
    }
