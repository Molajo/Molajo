...
class MolajoTextHelper
{
    ...
    public static function script($string = null, $jsSafe = false, $interpretBackSlashes = true)
    {
        ...
        if ($string !== null) {
            ...
            self::$strings[strtoupper($string)] = Molajo::Applicationlication()->getLanguage()->_($string, $jsSafe, $interpretBackSlashes);
        }
    ...
    {
        $buffer = preg_replace($change_from, $change_to, Molajo::Applicationlication()->getBody());
        Molajo::Applicationlication()->setBody($buffer);
    }
