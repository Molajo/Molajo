 ...
 * Request
 *
 * Establishes parameter values given inheritence chain:
 * 1. Menu Item
...
//		echo 'Past it' . Services::Registry()->get('request\\request_url_query', '');
//		die;

		$array = Services::Registry()->getArray('request');
		/** Home */
