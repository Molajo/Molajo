...
<?php endif; ?>
<html xmlns="http://www.w3.org/1999/xhtml" dir="<?php echo Service::Language()->get('direction'); ?>" lang="<?php echo Service::Language()->get('tag'); ?>">
<head>
    <base href="<?php echo MOLAJO_BASE_URL . '"' . $end; ?>
<?php if ((int)Service::Configuration()->get('html5', 1) == 1): ?>
