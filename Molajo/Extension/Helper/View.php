                                           ...
                                           $id = 0)
    {
        ...
        if ($type == 'template') {
            if ($task == 'add' || $task == 'edit') {
                $view = (int)Service::Configuration()->get('default_edit_template_view_id', 0);;

            } else if ((int)$id == 0) {
                $view = (int)Service::Configuration()->get('default_items_template_view_id', 0);

            } else {
                $view = (int)Service::Configuration()->get('default_item_template_view_id', 0);
            }
        }

        if ($type == 'wrap') {
            if ($task == 'add' || $task == 'edit') {
                $view = (int)Service::Configuration()->get('default_edit_wrap_view_id', 0);

            } else if ((int)$id == 0) {
                $view = (int)Service::Configuration()->get('default_items_wrap_view_id', 0);

            } else {
                $view = (int)Service::Configuration()->get('default_item_wrap_view_id', 0);
            }
        }
        return $view;
    }
