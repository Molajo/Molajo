...
INSERT INTO `molajo_asset_types` (`id`, `title`, `protected`, `source_table`, `component_option`)
  ...
  (1000, 'Core', 1, '__extension_instances', 'extensions'),
  ...
  (1200, 'Libraries', 1, '__extension_instances', 'extensions'),
  (1250, 'Manifests', 1, '__extension_instances', 'extensions'),
  (1300, 'Menus', 1, '__extension_instances', 'extensions'),
  (1350, 'Modules', 1, '__extension_instances', 'extensions'),
  (1400, 'Parameters', 1, '__extension_instances', 'extensions'),
