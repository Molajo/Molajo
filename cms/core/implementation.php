...
/**
 * Molajo Implementation Class
 *
 * Base class
 */
class MolajoImplementation
{
    /**
    ...
    public static function getInstance($prefix = 'Molajo')
    {
        ...
        if (empty($instances[MOLAJO_APPLICATION])) {
            ...
            $info = MolajoImplementationHelper::getImplementationInfo(MOLAJO_APPLICATION, true);
            if ($info === false) {
                return false;
            }
            ...
            MolajoImplementationHelper::loadImplementationClasses();

            $classname = $prefix . ucfirst(MOLAJO_APPLICATION) . 'Implementation';
     ...
     *
     * @see     MolajoImplementation::enqueueMessage()
     * @since  1.0
     */
     ...
     * getConfig
     *
     * Creates the Implementation configuration object.
     *
     ...
     * get
     *
     * Returns a property of the Implementation object
     ...
     * set
     *
     * Modifies a property of the Implementation object, creating it if it does not already exist.
     *
     * @param   string  $key    The name of the property.
