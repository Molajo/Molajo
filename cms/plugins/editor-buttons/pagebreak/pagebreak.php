...
class plgButtonPagebreak extends MolajoPlugin
{
    ...
    public function onDisplay($name)
    {
        ...
        $link = 'index.php?option=articles&amp;view=article&amp;layout=pagebreak&amp;layout=component&amp;e_name=' . $name;
        ...
        $button->set('text', MolajoTextHelper::_('PLG_EDITORSXTD_PAGEBREAK_BUTTON_PAGEBREAK'));
