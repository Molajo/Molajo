...
class plgSystemTamka_Router extends MolajoPlugin
{
    ...
    /**
     * Build URL for articles given SEF URL options
     */
    ...
    function TamkaParseURL(&$router, &$uri)
    {
         ...
         *             index.php?option=articles&view=article&id=5:joomla-license-guidelines&catid=25:the-project&Itemid=2
        ...
        $plugin =& MolajoPlugin::getPlugin('system', 'tamka_router');
    ...
    function process404s($uriPathPreserved, $parameterExtension)
    {
        ...
        $TamkaErrorUrl = 'index.php?option=tamkaerror&view=error';
