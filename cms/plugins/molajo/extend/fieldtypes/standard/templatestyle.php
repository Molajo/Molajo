	...
	protected function getGroups()
	{
		...
		if ($styles)
		{
			foreach($styles as $style) {
				...
				$lang->load('template_'.$template.'.sys', $client->path, null, false, false)
			||	$lang->load('template_'.$template.'.sys', $client->path.'/templates/'.$template, null, false, false)
			||	$lang->load('template_'.$template.'.sys', $client->path, $lang->getDefault(), false, false)
			||	$lang->load('template_'.$template.'.sys', $client->path.'/templates/'.$template, $lang->getDefault(), false,false);
