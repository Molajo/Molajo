...
class JFormFieldMedia extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        $html[] = '		<a class="modal" title="' . MolajoTextHelper::_('JSELECT') . '"' .
        ...
        $html[] = '			' . MolajoTextHelper::_('JSELECT') . '</a>';
        $html[] = '	</div>';
        $html[] = '</div>';

        $html[] = '<div class="button2-left">';
        $html[] = '	<div class="blank">';
        $html[] = '		<a title="' . MolajoTextHelper::_('JCLEAR') . '"' .
                  ' href="#"' .
                  ' onclick="javascript:document.getElementById(\'' . $this->id . '\').value=\'\';">';
        $html[] = '			' . MolajoTextHelper::_('JCLEAR') . '</a>';
        $html[] = '	</div>';
        $html[] = '</div>';
