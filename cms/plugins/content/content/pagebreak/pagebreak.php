...
class plgContentPagebreak extends MolajoPlugin
{
    ...
    {
        $canProceed = $context == 'articles.article';
    ...
    {
        $heading = isset($row->title) ? $row->title : MolajoTextHelper::_('PLG_CONTENT_PAGEBREAK_NO_TITLE');
        ...
        if ($this->parameters->get('article_index') == 1) {
            $headingtext = MolajoTextHelper::_('PLG_CONTENT_PAGEBREAK_ARTICLE_INDEX');
        ...
        foreach ($matches as $bot) {
            ...
            if (@$bot[0]) {
                ...
                if (@$attrs2['alt']) {
                    ...
                    $title = MolajoTextHelper::sprintf('Page #', $i);
                }
            } else {
                $title = MolajoTextHelper::sprintf('Page #', $i);
            }
        ...
        if ($this->parameters->get('showall')) {
			...
			<li>
					...
					<a href="' . $link . '" class="toclink">'
                         . MolajoTextHelper::_('PLG_CONTENT_PAGEBREAK_ALL_PAGES') .
                         '</a>
    ...
    {
        $pnSpace = '';
        if (MolajoTextHelper::_('JGLOBAL_LT') || MolajoTextHelper::_('JGLOBAL_LT')) {
            $pnSpace = ' ';
        }
        ...
        if ($page < $n - 1) {
            ...
            // Next >>
            $next = '<a href="' . $link_next . '">' . MolajoTextHelper::_('JNEXT') . $pnSpace . MolajoTextHelper::_('JGLOBAL_GT') . MolajoTextHelper::_('JGLOBAL_GT') . '</a>';
        } else {
            $next = MolajoTextHelper::_('JNEXT');
        }
        ...
        if ($page > 0) {
            ...
            // << Prev
            $prev = '<a href="' . $link_prev . '">' . MolajoTextHelper::_('JGLOBAL_LT') . MolajoTextHelper::_('JGLOBAL_LT') . $pnSpace . MolajoTextHelper::_('JPREV') . '</a>';
        } else {
            $prev = MolajoTextHelper::_('JPREV');
        }
