...
class ResponsesSocialBookmarks extends MolajoApplicationPlugin
{
	...
	*/
		...
		$option = JRequest::getVar('option','articles');
		if ($option !== 'articles') {
				return;
		}
		...
		//	Get Parameters
		$plugin =& MolajoApplicationPlugin::getPlugin('content', 'tamka_article_social_bookmark');
