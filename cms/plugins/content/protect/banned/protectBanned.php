...
class protectBanned
{
    ...
    function checkIP($userip)
    {
        ...
        if ($banned == true) {
            JError::raiseError(600, MolajoTextHelper::_("IP Address has been banned: ") . $userip);
            return true;
        }
    }
    ...
    function checkEmail( #email)
    {
        ...
        if ($banned == true) {
            JError::raiseError(601, MolajoTextHelper::_("Email address has been banned: ") . $useremail);
            return true;
        }
    }
    ...
    function checkURL($url)
    {
        ...
        if ($banned == true) {
            JError::raiseError(602, MolajoTextHelper::_("URL has been banned: ") . $useruri);
            return true;
        }
