...
class MolajoLinksFootnotes
{
    ...
    function driver($context, &$content, &$parameters, $page, $location)
    {
        ...
        for ($i = 0; $i < count($matches); $i++) {
            ...
            /** layout **/
            $layoutPath = MolajoPlugin::getLayoutPath(array('type' => 'molajo', 'name' => 'links'), $layout = 'footnote');
        ...
        /** layout **/
        $layoutPath = MolajoPlugin::getLayoutPath(array('type' => 'molajo', 'name' => 'links'), $layout = 'footnote_footer');
        $renderedLayout = MolajoPlugin::generateLayout($layoutPath);
