...
<form action="<?php echo MolajoRouteHelper::_('index.php', true, $this->parameters->get('usesecure')); ?>" method="post"
    ...
    <fieldset class="loginform">
        ...
        <label id="" class=""
               for="lang"><?php echo MolajoTextHelper::_('LAYOUT_EXTENSION_ADMINISTER_LOGIN_LANGUAGE'); ?>
            <?php echo $langs; ?>
        </label>
        ...
        <?php /* <a href="#" onclick="document.getElementById('form-login').submit();">
			<?php echo MolajoTextHelper::_('LAYOUT_EXTENSION_ADMINISTER_LOGIN_LOGIN'); ?></a> */ ?>
        <input type="submit" value="<?php echo MolajoTextHelper::_('LAYOUT_EXTENSION_ADMINISTER_LOGIN_LOGIN'); ?>"/>
