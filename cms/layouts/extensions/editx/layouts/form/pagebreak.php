    ...
    <table width="100%" align="center">
        <tr width="40%">
            <td class="key" align="right">
                <label for="title">
                    <?php echo MolajoTextHelper::_('CONTENT_PAGEBREAK_TITLE'); ?>
                </label>
            </td>
            <td>
        ...
        <tr width="60%">
            <td class="key" align="right">
                <label for="alias">
                    <?php echo MolajoTextHelper::_('CONTENT_PAGEBREAK_TOC'); ?>
                </label>
            </td>
            <td>
...
<button onclick="insertPagebreak();"><?php echo MolajoTextHelper::_('CONTENT_PAGEBREAK_INSERT_BUTTON'); ?></button>
