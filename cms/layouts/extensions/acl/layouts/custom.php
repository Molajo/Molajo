...
<form action="<?php //echo MolajoRouteHelper::_('index.php', true, $parameters->get('usesecure')); ?>" method="post"
    ...
    <fieldset class="loginform">
        ...
        <label id="mod-login-username-lbl" for="mod-login-username">
            <?php echo MolajoTextHelper::_('JGLOBAL_USERNAME'); ?>
        </label>
            ...
            <div class="button1">
                <div class="next">
                    <a href="#" onclick="document.getElementById('form-login').submit();">
                        <?php echo MolajoTextHelper::_('LOGIN_LOGIN'); ?></a>
                </div>
            </div>
        </div>

        <div class="clr"></div>
        <input type="submit" class="hidebtn" value="<?php echo MolajoTextHelper::_('LOGIN_LOGIN'); ?>"/>
