...
class InstallerHelper
{
	...
	public static function addSubmenu($vName = 'install')
	{
		JSubMenuHelper::addEntry(
			MolajoText::_('INSTALLER_SUBMENU_INSTALL'),
			'index.php?option=installer',
			$vName == 'install'
		);
		JSubMenuHelper::addEntry(
			MolajoText::_('INSTALLER_SUBMENU_UPDATE'),
			'index.php?option=installer&view=update',
			$vName == 'update'
		);
		JSubMenuHelper::addEntry(
			MolajoText::_('INSTALLER_SUBMENU_MANAGE'),
			'index.php?option=installer&view=manage',
			$vName == 'manage'
		);
		JSubMenuHelper::addEntry(
			MolajoText::_('INSTALLER_SUBMENU_DISCOVER'),
			'index.php?option=installer&view=discover',
			$vName == 'discover'
		);
		JSubMenuHelper::addEntry(
			MolajoText::_('INSTALLER_SUBMENU_WARNINGS'),
