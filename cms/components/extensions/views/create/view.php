...
class InstallerViewDefault extends JView
{
	...
	function __construct($config = null)
	{
		...
		$this->_addPath('template', JPATH_THEMES.'/'.$app->getTemplate().'/html/installer/default');
	}
	...
	protected function addToolbar()
	{
		...
		MolajoToolbarHelper::title(MolajoText::_('INSTALLER_HEADER_'.$this->getName()), 'install.png');
		...
		$document->setTitle(MolajoText::_('INSTALLER_TITLE_'.$this->getName()));
	}
}
