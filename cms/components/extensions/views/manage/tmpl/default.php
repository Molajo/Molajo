...
?>
<form action="<?php echo MolajoRouteHelper::_('index.php?option=installer&view=manage');?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		...
		<?php foreach ($this->items as $i => $item): ?>
			<tr class="row<?php echo $i%2; if ($item->protected) echo ' protected';?>">
				...
				<td class="center">
					<?php echo MolajoText::_('INSTALLER_TYPE_'.$item->type); ?>
				</td>
				<td class="center">
				...
				<td class="center">
					<?php echo @$item->folder != '' ? $item->folder : MolajoText::_('INSTALLER_TYPE_NONAPPLICABLE'); ?>
				</td>
				<td>
