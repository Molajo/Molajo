...
?>
<form action="<?php echo MolajoRouteHelper::_('index.php?option=installer&view=discover');?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th class="center"><?php echo MolajoHTML::_('grid.sort', 'INSTALLER_HEADING_TYPE', 'type', $listDirn, $listOrder); ?></th>
				...
				<th width="10"><?php echo MolajoHTML::_('grid.sort', 'INSTALLER_HEADING_ID', 'extension_id', $listDirn, $listOrder); ?></th>
			</tr>
		</thead>
		...
		<?php foreach ($this->items as $i => $item): ?>
			<tr class="row<?php echo $i%2;?>">
				...
				<td class="center"><?php echo MolajoText::_('INSTALLER_TYPE_'.$item->type); ?></td>
				...
				<td class="center">
					<span class="editlinktip hasTip" title="<?php echo addslashes(htmlspecialchars(MolajoText::_('INSTALLER_AUTHOR_INFORMATION').'::'.$item->author_info)); ?>">
	...
	<?php echo MolajoText::_('INSTALLER_MSG_DISCOVER_DESCRIPTION'); ?>
	<?php else : ?>
		<p>
			<?php echo MolajoText::_('INSTALLER_MSG_DISCOVER_DESCRIPTION'); ?>
		</p>
		<p>
			<?php echo MolajoText::_('INSTALLER_MSG_DISCOVER_NOEXTENSION'); ?>
		</p>
	<?php endif; ?>
