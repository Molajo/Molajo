...
?>
<form action="<?php echo MolajoRouteHelper::_('index.php?option=installer&view=update');?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist" cellspacing="1">
		<thead>
			<tr>
				...
				<th width="25%"><?php echo MolajoText::_('INSTALLER_HEADING_DETAILSURL'); ?></th>
			</tr>
		</thead>
		<tfoot>
			<tr>
		...
		<?php foreach($this->items as $i=>$item):?>
			<tr class="row<?php echo $i%2; ?>">
				...
				<td>
					<span class="editlinktip hasTip" title="<?php echo MolajoText::_('JGLOBAL_DESCRIPTION');?>::<?php echo $item->description ? $item->description : MolajoText::_('INSTALLER_MSG_UPDATE_NODESC'); ?>">
					<?php echo $item->name; ?>
					</span>
				</td>
				<td class="center">
					<?php echo $item->extension_id ? MolajoText::_('INSTALLER_MSG_UPDATE_UPDATE') : MolajoText::_('INSTALLER_NEW_INSTALL') ?>
				</td>
				<td><?php echo MolajoText::_('INSTALLER_TYPE_'.$item->type) ?></td>
				<td class="center"><?php echo $item->version ?></td>
				<td class="center"><?php echo @$item->folder != '' ? $item->folder : MolajoText::_('INSTALLER_TYPE_NONAPPLICABLE'); ?></td>
				<td class="center"><?php echo @$item->application != '' ? MolajoText::_('INSTALLER_TYPE_'.$item->application) : MolajoText::_('INSTALLER_TYPE_NONAPPLICABLE'); ?></td>
	...
	<?php else : ?>
		<p class="nowarning"><?php echo MolajoText::_('INSTALLER_MSG_UPDATE_NOUPDATES'); ?></p>
	<?php endif; ?>
