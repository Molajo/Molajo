...
?>
<fieldset title="<?php echo MolajoText::_('INSTALLER_MSG_DESCFTPTITLE'); ?>">
	<legend><?php echo MolajoText::_('INSTALLER_MSG_DESCFTPTITLE'); ?></legend>

	<?php echo MolajoText::_('INSTALLER_MSG_DESCFTP'); ?>
