 ...
 *  Line 1
 */
if (JString::strpos(MolajoText :: _('FOOTER_LINE1'), '%date%')) {
	$line1 = str_replace('%date%', MolajoFactory::getDate()->format('Y'), MolajoText :: _('FOOTER_LINE1'));
} else {
    $line1 = MolajoText :: _('FOOTER_LINE1');
}
