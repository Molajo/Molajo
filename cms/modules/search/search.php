...
$button_text	= htmlspecialchars($parameters->get('button_text', MolajoText::_('SEARCH_SEARCHBUTTON_TEXT')));
$width			= intval($parameters->get('width', 20));
$maxlength		= $upper_limit;
$text			= htmlspecialchars($parameters->get('text', MolajoText::_('SEARCH_SEARCHBOX_TEXT')));
$label			= htmlspecialchars($parameters->get('label', MolajoText::_('SEARCH_LABEL_TEXT')));
...
require MolajoApplicationModule::getLayoutPath('search', $parameters->get('layout', 'default'));
