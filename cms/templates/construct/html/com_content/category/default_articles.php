...
<?php if ($this->params->get('show_no_articles', 1)) : ?>
    <p><?php echo JText::_('CONTENT_NO_ARTICLES'); ?></p>
    <?php endif; ?>
...
<form action="<?php echo JFilterOutput::ampReplace(JFactory::getURI()->toString()); ?>" method="post" name="adminForm"
    ...
    <fieldset class="filters">
        ...
        <label class="filter-search-lbl"
               for="filter-search"><?php echo JText::_('CONTENT_' . $this->params->get('filter_field') . '_FILTER_LABEL') . '&#160;'; ?>
            <input type="text" name="filter-search" id="filter-search"
                   value="<?php echo $this->escape($this->state->get('list.filter')); ?>" class="inputbox"
                   onchange="document.adminForm.submit();"
                   title="<?php echo JText::_('CONTENT_FILTER_SEARCH_DESC'); ?>"/>
...
<table class="category">
    ...
    <tr>
        ...
        <th class="list-date" id="tableOrdering2">
            <?php echo JHtml::_('grid.sort', 'CONTENT_' . $date . '_DATE', 'a.created', $listDirn, $listOrder); ?>
        </th>
        <?php endif; ?>
        ...
        <?php if (in_array($article->access, $this->user->getAuthorisedViewLevels())) : ?>
            ...
            <td>
                ...
                <a href="<?php echo $fullURL; ?>" class="register">
                    <?php echo JText::_('CONTENT_REGISTER_TO_READ_MORE'); ?></a>
            </td>
            <?php endif; ?>
				</tr>
		<?php endforeach; ?>
