...
<article class="item-page<?php echo $this->pageclass_sfx?>">
    ...
    <address class="createdby" rel="author">
        ...
        ?>
        <?php echo JText::sprintf('CONTENT_WRITTEN_BY', JHtml::_('link', JRoute::_($cntlink), $author)); ?>
        <?php else: ?>
...
<article id="item-page<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
    ...
    <address class="createdby" rel="author">
        <?php JText::printf('Written by', ($this->article->created_by_alias
                ? $this->escape($this->article->created_by_alias) : $this->escape($this->article->author))); ?>
    </address>
    <?php endif; ?>
