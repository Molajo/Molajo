...
<section class="section-list<?php echo $this->escape($this->params->get('pageclass_sfx')); ?>">
    ...
    <section class="section-desc clearfix">
        ...
        <img src="<?php echo $this->baseurl . '/' . $this->escape($cparams->get('image_path')) . '/' . $this->escape($this->section->image); ?>"
             class="image_<?php echo $this->escape($this->section->image_position); ?>"/>
        <?php endif; ?>
