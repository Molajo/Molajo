...
<section class="edit item-page<?php echo $this->pageclass_sfx; ?>">
    ...
    <form action="<?php echo JRoute::_('index.php?option=com_content&a_id=' . (int)$this->item->id); ?>" method="post"
        ...
        <fieldset>
            <legend><?php echo JText::_('CONTENT_PUBLISHING'); ?></legend>
            <div class="formelm">
            ...
            <?php if (is_null($this->item->id)): ?>
            <div class="form-note">
                <p><?php echo JText::_('CONTENT_ORDERING'); ?></p>
            </div>
            <?php endif; ?>
        </fieldset>
        ...
        <fieldset>
            <legend><?php echo JText::_('CONTENT_METADATA'); ?></legend>
            <div class="formelm-area">
