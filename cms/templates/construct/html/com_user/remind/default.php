...
<section class="remind<?php echo $this->escape($this->params->get('pageclass_sfx')) ?>">
    ...
    <form id="user-registration" action="<?php echo JRoute::_('index.php?option=com_user&task=remindusername'); ?>"
        ...
        <fieldset>
            <label for="email" class="hasTip"
                   title="<?php echo JText::_('REMIND_USERNAME_EMAIL_TIP_TITLE'); ?>::<?php echo JText::_('REMIND_USERNAME_EMAIL_TIP_TEXT'); ?>">
