...
// Joomla 1.6+ ?>
    ...
    <?php if (empty($this->items)) : ?>
	    <p> <?php echo JText::_('NEWSFEEDS_NO_ARTICLES'); ?>	 </p>
    <?php else : ?>
		    ...
		    <thead>
		        <tr>
				    <th class="item-title" id="tableOrdering">
					    <?php echo JHtml::_('grid.sort', 'NEWSFEEDS_FEED_NAME', 'a.name', $listDirn, $listOrder); ?>
				    </th>
				    <?php if ($this->params->get('show_articles')) : ?>
				        <th class="item-num-art" id="tableOrdering2">
					        <?php echo JHtml::_('grid.sort', 'NEWSFEEDS_NUM_ARTICLES', 'a.numarticles', $listDirn, $listOrder); ?>
				        </th>
				    <?php endif; ?>
				    <?php if ($this->params->get('show_link')) : ?>
				        <th class="item-link" id="tableOrdering3">
					        <?php echo JHtml::_('grid.sort', 'NEWSFEEDS_FEED_LINK', 'a.link', $listDirn, $listOrder); ?>
				        </th>
				    <?php endif; ?>
			    </tr>
		    </thead>
