...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo $baseUrl . 'templates/' . $this->template; ?>/favicon.ico"
          type="image/x-icon"/>
    <link rel="icon" href="<?php echo $baseUrl . 'templates/' . $this->template; ?>/favicon.png" type="image/png"/>
    <link rel="stylesheet" href="<?php echo $baseUrl . 'templates/' . $this->template; ?>/css/screen.css"
          type="text/css" media="screen"/>
    <link rel="stylesheet" href="<?php echo $baseUrl . 'templates/' . $this->template; ?>/css/overrides.css"
          type="text/css" media="screen"/>
  ...
  <script>DD_belatedPNG.fix(\'' . $IE6TransFixTargets . '\');</script>' . "\n";
    ...
    <link rel="stylesheet" href="<?php echo $baseUrl . 'templates/' . $this->template; ?>/css/ie6.css" type="text/css"
          media="screen"/>
    <style type="text/css">
        body {
            text-align: center
        ...
        width :                                         <?php echo ($siteWidth - 1); ?> ? "<?php echo $siteWidth . $siteWidthUnit; ?>": "auto" );
            margin: 0 auto
        }
    </style>
    <![endif]-->
...
<header id="header" class="clear clearfix">
    <div class="gutter">
        ...
        <h1 id="logo"><a href="<?php echo $this->baseurl ?>/"
                         title="<?php echo $this->baseurl ?>/"><?php echo $this->baseurl ?></a></h1>
        ...
        <nav>
            <ul id="access">
                ...
                <li><a href="<?php echo $baseUrl; ?>index.php#additional" class="to-additional">Additional
                    Information</a></li>
            </ul>
        </nav>
        ...
        <div id="content-main">
            <div class="gutter">
                ...
                <div id="error-message">
                    ...
                    <p>
                        <strong><?php echo JText::_('You may not be able to visit this page because of:'); ?></strong>
                    </p>
                    <ol>
                    ...
                    <ul>
                        <li><a href="<?php echo $this->baseurl; ?>/"
                               title="<?php echo JText::_('Go to the home page'); ?>"><?php echo JText::_('Home Page'); ?></a>
                        </li>
                    </ul>
