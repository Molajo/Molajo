 ...
 * @since       1.0
 */
Class ModalIncluder extends Includer
{
    /**
     * @param string $name
     * @param string $type
    ...
    protected function setRenderCriteria()
    {
        ...
        /** Standard parameters (overwrite extension title with Modal */
        Services::Registry()->set('Parameters', 'extension_title', 'Modal');
    ...
    /**
     * Loads Media CSS and JS files for Modal and Modal Views
     *
     * @return object
     * @since   1.0
     */
