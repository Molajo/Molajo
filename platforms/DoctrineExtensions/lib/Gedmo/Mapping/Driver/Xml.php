...
abstract class Xml extends File
{
    ...
    const PLATFORM_DOCTRINE_NAMESPACE_URI = 'http://doctrine-project.org/schemas/orm/doctrine-mapping';
    ...
    protected function _loadMappingFile($file)
    {
        ...
        $xmlElement = $xmlElement->children(self::PLATFORM_DOCTRINE_NAMESPACE_URI);
