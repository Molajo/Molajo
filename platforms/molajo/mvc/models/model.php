...
class MolajoModel extends JObject
{
    ...
    /**
     * Add a directory where MolajoModel should search for models. You may
     ...
     * @since   1.0
     */
    public static function DELETEaddTablePath($path)
    {
     ...
     * @since   1.0
     */
    protected static function DELETE_createFileName($type, $parts = array())
    {
        $filename = '';
    ...
    public static function getInstance($type, $prefix = '', $config = array())
    {
        ...
        if (!class_exists($modelClass)) {
            $path = JPath::find(MolajoModel::addIncludePath(null, $prefix), MolajoModel::_createFileName('model', array('name' => $type)));
            if (!$path) {
                $path = JPath::find(MolajoModel::addIncludePath(null, ''), MolajoModel::_createFileName('model', array('name' => $type)));
            }
            if ($path) {
                require_once $path;
     ...
     * @since   1.0
     */
    protected function DELETEpopulateState()
    {
    }
     ...
     * @since   1.0
     */
    protected function DELETEcleanCache($group = null, $client_id = 0)
    {
