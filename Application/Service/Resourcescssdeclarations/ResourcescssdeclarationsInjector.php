<?php
/**
 * Resourcescssdeclarations Dependency Injector
 *
 * @package    Molajo
 * @license    http://www.opensource.org/licenses/mit-license.html MIT License
 * @copyright  2013 Amy Stephen. All rights reserved.
 */
namespace Molajo\Service\Resourcescssdeclarations;

use Molajo\IoC\Handler\AbstractInjector;
use CommonApi\IoC\ServiceHandlerInterface;

/**
 * Resourcesjsdeclarations Service Dependency Injector
 *
 * @author     Amy Stephen
 * @license    http://www.opensource.org/licenses/mit-license.html MIT License
 * @copyright  2013 Amy Stephen. All rights reserved.
 * @since      1.0
 */
class ResourcescssdeclarationsInjector extends AbstractInjector implements ServiceHandlerInterface
{
    /**
     * Constructor
     *
    ...
    public function __construct(array $options = array())
    {
        ...
        $options['service_namespace']        = 'Molajo\\Resources\\Handler\\CssdeclarationsHandler';
    ...
    {
        $this->dependencies['Resources']->setHandlerInstance('CssdeclarationsHandler', $this->service_instance);
