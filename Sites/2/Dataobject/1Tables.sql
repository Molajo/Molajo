...
CREATE TABLE `molajo_groups` (
  ...
  `extension_instance_id` int(11) unsigned NOT NULL DEFAULT '13000',
  `catalog_type_id` int(11) NOT NULL DEFAULT '13000',
  `title` varchar(255) NOT NULL DEFAULT ' ' COMMENT 'Title',
  `subtitle` varchar(255) NOT NULL DEFAULT ' ' COMMENT 'Subtitle',
  `path` varchar(2048) NOT NULL DEFAULT ' ' COMMENT 'URI Path to append to Alias',
  `alias` varchar(255) NOT NULL DEFAULT ' ' COMMENT 'Slug, or alias, associated with Title, must be unique when combined with path.',
...
CREATE TABLE `molajo_group_view_groups` (
  `group_id` int(11) unsigned NOT NULL COMMENT 'FK to the Group table.',
  `view_group_id` int(11) unsigned NOT NULL COMMENT 'FK to the View Groups table.',
...
CREATE TABLE `molajo_actions` (
  ...
  `title` varchar(255) NOT NULL DEFAULT ' ' COMMENT 'Action Title',
...
--
-- Table `molajo_catalog_categories`
--
...
--
-- Table `molajo_application_extension_instances`
--
...
--
-- Table `molajo_site_extension_instances`
--
