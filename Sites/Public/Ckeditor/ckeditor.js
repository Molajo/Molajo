...
(function () {
    ...
    (function () {
        ...
        CKEDITOR.tools = {arrayCompare: function (b, a) {
            ...
            .
            test(a) ? d.push("<style>" + a + "</style>") : d.push('<link type="text/css" rel=stylesheet href="' + a + '">');
            return d.join("")
    ...
    CKEDITOR.dom.element.setMarker = function (a, e, b, c) {
        var d = e.getCustomData("list_marker_id") || e.setCustomData("list_marker_id", CKEDITOR.tools.getNextNumber()).getCustomData("list_marker_id"), g = e.getCustomData("list_marker_names") || e.setCustomData("list_marker_names", {}).getCustomData("list_marker_names");
        a[d] = e;
        g[b] = 1;
    ...
    CKEDITOR.dom.element.clearMarkers = function (a, e, b) {
        var c = e.getCustomData("list_marker_names"), d = e.getCustomData("list_marker_id"), g;
        for (g in c)e.removeCustomData(g);
    ...
    (function () {
        ...
        function b(a) {
            for (var b = 0, e = 0, m = c[a].length; e < m; e++)b = b + (parseInt(this.getComputedStyle(c[a][e]) || 0, 10) || 0);
            return b
        }
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {type: CKEDITOR.NODE_ELEMENT, addClass: function (a) {
            ...
            isEmptyInlineRemoveable: function () {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], j = 0; j < c.length; j++)if (e)for (var i = 0; i < e.length; i++)b.push([a, c[j], e[i]].join("-")); else b.push([a, c[j]].join("-"));
                ...
                var b = 0, c = 0, e = this.getDocument(), j = e.getBody(), i = e.$.compatMode == "BackCompat";
                if (document.documentElement.getBoundingClientRect) {
                    var n = this.$.getBoundingClientRect(), r = e.$.documentElement, o = r.clientTop ||
                        j.$.clientTop || 0, u = r.clientLeft || j.$.clientLeft || 0, f = true;
                    if (CKEDITOR.env.ie) {
                    ...
                    if (f) {
                        b = n.left + (!i && r.scrollLeft || j.$.scrollLeft);
                        b = b - u;
                        c = n.top + (!i && r.scrollTop || j.$.scrollTop);
                        c = c - o
                    }
                } else {
                    j = this;
                    for (e = null; j && !(j.getName() == "body" || j.getName() == "html");) {
                        ...
                        e = j;
                        j = (n = j.$.offsetParent) ? new CKEDITOR.dom.element(n) : null
                    }
                }
                if (a) {
                    j = this.getWindow();
                    e = a.getWindow();
                    if (!j.equals(e) && j.$.frameElement) {
                ...
                function o(a, b) {
                    ...
                    c = a.getWindow();
                    if (!c.equals(b)) {
                        c = o(CKEDITOR.dom.element.get(c.$.frameElement), b);
                        d.x = d.x + c.x;
                        d.y = d.y + c.y
                    }
                    return d
                ...
                !a && (a = this.getWindow());
                i = a.getDocument();
                var f = i.$.compatMode == "BackCompat";
                a instanceof CKEDITOR.dom.window && (a = f ? i.getBody() : i.getDocumentElement());
                i = a.getWindow();
                j = o(this, i);
                var s = o(a, i), y = this.$.offsetHeight;
                e = this.$.offsetWidth;
                var l = a.$.clientHeight, p =
                    a.$.clientWidth;
                i = j.x - u(this, "left") - s.x || 0;
                n = j.y - u(this, "top") - s.y || 0;
                e = j.x + e + u(this, "right") - (s.x + p) || 0;
                j = j.y + y + u(this, "bottom") - (s.y + l) || 0;
                if (n < 0 || j > 0)r(0, b === true ? n : b === false ? j : n < 0 ? n : j);
                if (c && (i < 0 || e > 0))r(i < 0 ? i : e, 0)
                ...
                for (var c = this.$.attributes, b = b || {}, e = 0; e < c.length; e++) {
                    var j = c[e], i = j.nodeName.toLowerCase(), n;
                    if (!(i in b))if (i == "checked" && (n = this.getAttribute(i)))a.setAttribute(i, n); else if (j.specified || CKEDITOR.env.ie && j.nodeValue && i == "value") {
                        n = this.getAttribute(i);
                        if (n === null)n = j.nodeValue;
                        a.setAttribute(i, n)
                    }
                }
                ...
                if (e !== false)for (var c = this.getChildren(), j = 0; j < c.count(); j++) {
                    e = c.getItem(j);
    ...
    (function () {
        function a(a, b) {
            ...
            f = c.endContainer;
            var n = c.startOffset, e = c.endOffset, g, k = this.guard, q = this.type, j = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var t = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(), h = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(e) : f.getNext();
                this._.guardLTR = function (a, b) {
                    return(!b || !t.equals(a)) && (!h || !a.equals(h)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            if (a && !this._.guardRTL) {
                var i = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), w = d.type == CKEDITOR.NODE_ELEMENT ? n ? d.getChild(n - 1) : null : d.getPrevious();
                this._.guardRTL = function (a, b) {
                    return(!b || !i.equals(a)) && (!w || !a.equals(w)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
            ...
            if (this.current)f = this.current[j](false, q, g); else {
                if (a)f.type ==
                    CKEDITOR.NODE_ELEMENT && (f = e > 0 ? f.getChild(e - 1) : g(f, true) === false ? null : f.getPreviousSourceNode(true, q, g)); else {
                    f = d;
                    if (f.type == CKEDITOR.NODE_ELEMENT && !(f = f.getChild(n)))f = g(d, true) === false ? null : d.getNextSourceNode(true, q, g)
                }
                f && g(f) === false && (f = null)
            }
            for (; f && !this._.end;) {
        ...
        function b(a) {
            ...
            if (a.type == CKEDITOR.NODE_ELEMENT) {
                ...
                var b;
                if (b = !CKEDITOR.env.needsBrFiller)if (b = a.is(n))a:{
                    b = 0;
        ...
        CKEDITOR.dom.walker.bookmark = function (a, b) {
            ...
            return function (f) {
                var d, n;
                d = f && f.type != CKEDITOR.NODE_ELEMENT && (n = f.getParent()) && c(n);
                d = a ? d : d || c(f);
                return!!(b ^ d)
            }
        };
        ...
        var g = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, h = CKEDITOR.dom.walker.whitespaces(), m = CKEDITOR.dom.walker.bookmark(), j = CKEDITOR.dom.walker.temp();
        ...
        var i = CKEDITOR.dom.walker.ignored(), n = function (a) {
            var b = {}, c;
        ...
        CKEDITOR.dom.element.prototype.getBogus = function () {
            var a = this;
            do a = a.getPreviousSourceNode(); while (m(a) || h(a) || a.type == CKEDITOR.NODE_ELEMENT && a.is(CKEDITOR.dtd.$inline) && !a.is(CKEDITOR.dtd.$empty));
            return a && (CKEDITOR.env.needsBrFiller ? a.is && a.is("br") : a.getText && g.test(a.getText())) ? a : false
        }
    })();
    ...
    (function () {
        ...
        var c = function (a) {
            ...
            a.optimizeBookmark();
            var f = a.startContainer, e = a.endContainer, g = a.startOffset, l = a.endOffset, p, k;
            if (e.type == CKEDITOR.NODE_TEXT)e = e.split(l);
            else if (e.getChildCount() > 0)if (l >= e.getChildCount()) {
            ...
            } else if (g)if (g >= f.getChildCount()) {
                f = f.append(a.document.createText(""));
                p = true
            } else f = f.getChild(g).getPrevious(); else {
                f = f.append(a.document.createText(""), 1);
                p = true
            }
            var g = f.getParents(), l = e.getParents(), q, j, t;
            for (q = 0; q < g.length; q++) {
                j = g[q];
                t = l[q];
                if (!j.equals(t))break
            }
            for (var h = c, i, w, m, C = q; C < g.length; C++) {
                i =
                    g[C];
                h && !i.equals(f) && (w = h.append(i.clone()));
                for (i = i.getNext(); i;) {
                    if (i.equals(l[C]) || i.equals(e))break;
                    m = i.getNext();
                    if (b == 2)h.append(i.clone(true)); else {
                        i.remove();
                        b == 1 && h.append(i)
                    }
                    i = m
            ...
            h = c;
            for (c = q; c < l.length; c++) {
                i = l[c];
                b > 0 && !i.equals(e) && (w = h.append(i.clone()));
                if (!g[c] || i.$.parentNode != g[c].$.parentNode)for (i = i.getPrevious(); i;) {
                    if (i.equals(g[c]) || i.equals(f))break;
                    m = i.getPrevious();
                    if (b == 2)h.$.insertBefore(i.$.cloneNode(true), h.$.firstChild); else {
                        i.remove();
                        b == 1 && h.$.insertBefore(i.$,
                            h.$.firstChild)
                    }
                    i = m
                }
            ...
            if (b == 2) {
                ...
                if (j && t && (f.$.parentNode != j.$.parentNode || e.$.parentNode != t.$.parentNode)) {
                    b = t.getIndex();
                    p && t.$.parentNode == f.$.parentNode && b--;
                    if (d && j.type == CKEDITOR.NODE_ELEMENT) {
                        d = CKEDITOR.dom.element.createFromHtml('<span data-cke-bookmark="1" style="display:none">&nbsp;</span>',
                            a.document);
                        d.insertAfter(j);
                        j.mergeSiblings(false);
                        a.moveToBookmark({startNode: d})
                    } else a.setStart(t.getParent(), b)
                }
                a.collapse(true)
            }
            p && f.remove();
            k && e.$.parentNode && e.remove()
        }, g = {abbr: 1, acronym: 1, b: 1, bdo: 1, big: 1, cite: 1, code: 1, del: 1, dfn: 1, em: 1, font: 1, i: 1, ins: 1, label: 1, kbd: 1, q: 1, samp: 1, small: 1, span: 1, strike: 1, strong: 1, sub: 1, sup: 1, tt: 1, u: 1, "var": 1}, h = CKEDITOR.dom.walker.bogus(), m = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, j = CKEDITOR.dom.walker.editable(), i = CKEDITOR.dom.walker.ignored(true);
        ...
        {clone: function () {
            ...
            switch (a) {
                ...
                case CKEDITOR.ENLARGE_ELEMENT:
                    ...
                    var e = this.getCommonAncestor(), g = this.root, l, p, k, q, j, t = false, i, h;
                    i = this.startContainer;
                    var m = this.startOffset;
                    if (i.type == CKEDITOR.NODE_TEXT) {
                        if (m) {
                            i = !CKEDITOR.tools.trim(i.substring(0,
                                m)).length && i;
                            t = !!i
                        }
                        if (i && !(q = i.getPrevious()))k = i.getParent()
                    } else {
                        m && (q = i.getChild(m - 1) || i.getLast());
                        q || (k = i)
                    }
                    for (k = c(k); k || q;) {
                        if (k && !q) {
                            !j && k.equals(e) && (j = true);
                            if (f ? k.isBlockBoundary() : !g.contains(k))break;
                            if (!t || k.getComputedStyle("display") != "inline") {
                                t = false;
                                j ? l = k : this.setStartBefore(k)
                            }
                            q = k.getPrevious()
                        }
                        for (; q;) {
                            ...
                            if (q.type == CKEDITOR.NODE_COMMENT)q = q.getPrevious(); else {
                                if (q.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    0 || b && q.is("br")) && !q.data("cke-bookmark"))if (t && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                                    h = q.getText();
                                    if (d.test(h))q = null; else for (var m = q.$.getElementsByTagName("*"), K = 0, C; C = m[K++];)if (!CKEDITOR.dtd.$removeEmpty[C.nodeName.toLowerCase()]) {
                                        q = null;
                                        break
                                    }
                                    q && (i = !!h.length)
                                } else q = null;
                                i && (t ? j ? l = k : k && this.setStartBefore(k) : t = true);
                                if (q) {
                                    i = q.getPrevious();
                                    if (!k && !i) {
                                        k = q;
                    ...
                    var O = function (a, b) {
                        ...
                        for (c.guard = function (a) {
                            ...
                            h = f != a ? f.getText() : f.substring(b);
                            if (d.test(h))return false
                        }
                        return true
                    };
                    if (i.type == CKEDITOR.NODE_TEXT)if (CKEDITOR.tools.trim(i.substring(m)).length)t = true; else {
                        t = !i.getLength();
                        if (m == i.getLength()) {
                            if (!(q = i.getNext()))k = i.getParent()
                        } else O(i,
                            m) && (k = i.getParent())
                    } else(q = i.getChild(m)) || (k = i);
                    for (; k || q;) {
                        if (k && !q) {
                            !j && k.equals(e) && (j = true);
                            if (f ? k.isBlockBoundary() : !g.contains(k))break;
                        ...
                        for (; q;) {
                            ...
                            if (q.type == CKEDITOR.NODE_TEXT) {
                                ...
                                if ((q.$.offsetWidth > 0 || b && q.is("br")) && !q.data("cke-bookmark"))if (t && CKEDITOR.dtd.$removeEmpty[q.getName()]) {
                                    h = q.getText();
                                    if (d.test(h))q = null; else {
                                        m = q.$.getElementsByTagName("*");
                                        for (K = 0; C = m[K++];)if (!CKEDITOR.dtd.$removeEmpty[C.nodeName.toLowerCase()]) {
                                            q = null;
                                            break
                                        }
                                    }
                ...
                case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                    ...
                    var I, v, x = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), G = null, B = function (a) {
                        if (a.type == CKEDITOR.NODE_ELEMENT && a.getAttribute("contenteditable") == "false")if (G) {
                            if (G.equals(a)) {
                                G = null;
                                return
                            }
                        } else G = a; else if (G)return;
                        var b = x(a);
                        b || (I = a);
                        return b
                    }, f = function (a) {
                    ...
                    k = k.lastBackward();
                    I = I || g;
                    this.setStartAt(I, !I.is("br") && (!k && this.checkStartOfBlock() || k && I.contains(k)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
                    if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                        k = this.clone();
                        k = new CKEDITOR.dom.walker(k);
                        var D = CKEDITOR.dom.walker.whitespaces(), V = CKEDITOR.dom.walker.bookmark();
                    ...
                    k = new CKEDITOR.dom.walker(k);
                    k.guard = a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? f : B;
                    I = null;
                    k = k.lastForward();
                    I = I || g;
                    this.setEndAt(I, !k && this.checkEndOfBlock() || k && I.contains(k) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START);
                    v && this.setEndAfter(v)
            }
        }, shrink: function (a, b, c) {
            if (!this.collapsed) {
                var a = a || CKEDITOR.SHRINK_TEXT, d = this.clone(), f = this.startContainer, e = this.endContainer, g = this.startOffset, l = this.endOffset, p = 1, k = 1;
                if (f && f.type == CKEDITOR.NODE_TEXT)if (g)if (g >= f.getLength())d.setStartAfter(f); else {
                    d.setStartBefore(f);
                    p = 0
                } else d.setStartBefore(f);
                if (e && e.type == CKEDITOR.NODE_TEXT)if (l)if (l >= e.getLength())d.setEndAfter(e); else {
                    d.setEndAfter(e);
                    k = 0
                } else d.setEndBefore(e);
                var d = new CKEDITOR.dom.walker(d), q = CKEDITOR.dom.walker.bookmark();
                ...
                d.guard = function (b, d) {
                    if (q(b))return true;
                    if (a == CKEDITOR.SHRINK_ELEMENT && b.type == CKEDITOR.NODE_TEXT || d && b.equals(i) || c === false && b.type == CKEDITOR.NODE_ELEMENT && b.isBlockBoundary() ||
                        b.type == CKEDITOR.NODE_ELEMENT && b.hasAttribute("contenteditable"))return false;
                    !d && b.type == CKEDITOR.NODE_ELEMENT && (i = b);
                    return true
                };
                if (p)(f = d[a == CKEDITOR.SHRINK_ELEMENT ? "lastForward" : "next"]()) && this.setStartAt(f, b ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_BEFORE_START);
                if (k) {
                    d.reset();
            ...
            return function (b) {
                for (var c = this.createBookmark(),
                         d = this[b ? "endPath" : "startPath"](), e = d.block || d.blockLimit, l; e && !e.equals(d.root) && !e.getFirst(a(e));) {
                    l = e.getParent();
            ...
            for (var c = 0; a;) {
                if (a.type == CKEDITOR.NODE_TEXT) {
                    b && this.endContainer &&
                        this.checkEndOfBlock() && m.test(a.getText()) ? this.moveToPosition(a, CKEDITOR.POSITION_BEFORE_START) : this.moveToPosition(a, b ? CKEDITOR.POSITION_AFTER_END : CKEDITOR.POSITION_BEFORE_START);
                    c = 1;
                    break
                }
    ...
    (function () {
        ...
        function c(a, d, e, g) {
            ...
            if (!g)return 0;
            if ((h = CKEDITOR.filter.instances[g.element.data("cke-filter")]) && !h.check(d))return c(a, d, e, g.remaining);
            d = new CKEDITOR.dom.range(g.element);
            d.selectNodeContents(g.element);
            d = d.createIterator();
            d.enlargeBr = a.enlargeBr;
            d.enforceRealBlocks = a.enforceRealBlocks;
            d.activeFilter = d.filter = h;
            a._.nestedEditable = {element: g.element, container: e, remaining: g.remaining, iterator: d};
            return 1
        }
        ...
        a.prototype = {getNextParagraph: function (a) {
            ...
            if (!this._.started) {
                ...
                h = f.endContainer.hasAscendant("pre", true) || f.startContainer.hasAscendant("pre", true);
                f.enlarge(this.forceBrBreak && !h || !this.enlargeBr ? CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS : CKEDITOR.ENLARGE_BLOCK_CONTENTS);
                if (!f.collapsed) {
                    h = new CKEDITOR.dom.walker(f.clone());
                    var s = CKEDITOR.dom.walker.bookmark(true, true);
                    h.evaluator = s;
                    ...
                    if (this._.lastNode && this._.lastNode.type == CKEDITOR.NODE_TEXT && !CKEDITOR.tools.trim(this._.lastNode.getText()) && this._.lastNode.getParent().isBlockBoundary()) {
                        s = this.range.clone();
                        s.moveToPosition(this._.lastNode, CKEDITOR.POSITION_AFTER_END);
                        if (s.checkEndOfBlock()) {
                            s = new CKEDITOR.dom.elementPath(s.endContainer, s.root);
                            this._.lastNode = (s.block || s.blockLimit).getNextSourceNode(true)
                        }
                    }
            ...
            s = this._.nextNode;
            f = this._.lastNode;
            for (this._.nextNode = null; s;) {
                var y = 0, l = s.hasAscendant("pre"), p = s.type != CKEDITOR.NODE_ELEMENT, k = 0;
                if (p)s.type == CKEDITOR.NODE_TEXT && d.test(s.getText()) && (p = 0); else {
                    var q = s.getName();
                    if (CKEDITOR.dtd.$block[q] && s.getAttribute("contenteditable") == "false") {
                        b = s;
                        c(this, a, b);
                        break
                    } else if (s.isBlockBoundary(this.forceBrBreak && !l && {br: 1})) {
                        if (q == "br")p = 1; else if (!h && !s.getChildCount() &&
                            q != "hr") {
                            b = s;
                            r = s.equals(f);
                            break
                        ...
                        if (h) {
                            h.setEndAt(s, CKEDITOR.POSITION_BEFORE_START);
                            if (q != "br")this._.nextNode = s
                        }
                        y = 1
                    } else {
                        if (s.getFirst()) {
                            if (!h) {
                                h = this.range.clone();
                                h.setStartAt(s, CKEDITOR.POSITION_BEFORE_START)
                            }
                            s = s.getFirst();
                            continue
                        }
                ...
                r = (!y || p) && s.equals(f);
                if (h && !y)for (; !s.getNext(m) && !r;) {
                    q = s.getParent();
                    if (q.isBlockBoundary(this.forceBrBreak && !l && {br: 1})) {
                        y = 1;
                        p = 0;
                        r || q.equals(f);
                ...
                p && h.setEndAt(s, CKEDITOR.POSITION_AFTER_END);
                s = e(s, k, f);
                if ((r = !s) || y && h)break
            }
            if (!b) {
                ...
                y = {div: 1, th: 1, td: 1};
                b = b.block;
                if (!b && s && !this.enforceRealBlocks && y[s.getName()] && h.checkStartOfBlock() && h.checkEndOfBlock() && !s.equals(h.root))b = s; else if (!b || this.enforceRealBlocks && b.getName() == "li") {
                ...
                } else if (!r)this._.nextNode = b.equals(f) ? null : e(h.getBoundaryNodes().endNode, 1, f)
            }
            ...
            if (u)(o = b.getLast()) && o.type == CKEDITOR.NODE_ELEMENT && o.getName() == "br" && (!CKEDITOR.env.needsBrFiller || o.getPrevious(g) || o.getNext(g)) && o.remove();
            if (!this._.nextNode)this._.nextNode = r || b.equals(f) || !f ? null : e(b, 1, f);
            return b
        }};
    ...
    (function () {
        function a(a, b, c, f, l) {
            var k = b.name;
            if ((f || typeof a.elements != "function" || a.elements(k)) && (!a.match || a.match(b))) {
                if (f = !l) {
                    a:if (a.nothingRequired)f = true; else {
                        if (l = a.requiredClasses) {
                            k = b.classes;
                            for (f = 0; f < l.length; ++f)if (CKEDITOR.tools.indexOf(k, l[f]) == -1) {
                                f = false;
                                break a
                            }
                        }
                ...
                if (!f) {
                    ...
                    if (!c.allClasses) {
                        ...
                        if (a)if (a === true)b = true; else {
                            for (var l = 0, k = b.length, g; l < k; ++l) {
                                g = b[l];
                                f[g] || (f[g] = a(g))
                            }
                            b = false
        ...
        function c(b) {
            ...
            return b._.filterFunction = function (f, e, l, k, g, q, h) {
                var p = f.name, t, y = false;
                if (g)f.name = p = p.replace(c, "$1");
                if (l = l && l[p]) {
                    j(f);
                    for (p = 0; p < l.length; ++p)s(b, f, l[p]);
                    i(f)
                }
                if (e) {
                    var p = f.name, l = e.elements[p], z = e.generic, e = {valid: false, validAttributes: {}, validClasses: {}, validStyles: {},
                    ...
                    if (l) {
                        p = 0;
                        for (t = l.length; p < t; ++p)a(l[p], f, e, true, q)
                    }
                    if (z) {
                        p = 0;
                        for (t = z.length; p < t; ++p)a(z[p], f, e, false, q)
                    }
                    if (!e.valid) {
                        k.push(f);
                        return true
                    ...
                    l = e.validClasses;
                    t = f.attributes;
                    var z = f.styles, m = t["class"], J = t.style, w, C, K = [], H = [], o = /^data-cke-/, r = false;
                    delete t.style;
                    delete t["class"];
                    if (!e.allAttributes)for (w in t)if (!q[w])if (o.test(w)) {
                        if (w != (C = w.replace(/^data-cke-saved-/, "")) && !q[C]) {
                            delete t[w];
                            r = true
                        }
                    } else {
                    ...
                    if (e.allStyles) {
                        ...
                        for (w in z)p[w] ? K.push(w + ":" + z[w]) : r = true;
                        if (K.length)t.style = K.sort().join("; ")
                    }
                    if (e.allClasses)m && (t["class"] = m); else {
                        for (w in l)l[w] && H.push(w);
                        H.length && (t["class"] = H.sort().join(" "));
                        m && H.length < m.split(/\s+/).length && (r = true)
                    }
                    r && (y = true);
                    if (!h && !n(f)) {
                        k.push(f);
                ...
                if (g)f.name = f.name.replace(d, "cke:$1");
                return y
            }
        }
        ...
        function h(a) {
            for (var b, c, d, f, e = {}, l = 1, a = t(a); b = a.match(C);) {
                if (c = b[2]) {
                    d = m(c, "styles");
                    f = m(c, "attrs");
                    c = m(c, "classes")
                } else d = f = c = null;
                e["$" + l++] = {elements: b[1], classes: c, styles: d, attributes: f};
        ...
        function u(a) {
            return a.type == CKEDITOR.NODE_ELEMENT && (a.name == "br" || q.$block[a.name])
        }

        function f(a, b, c) {
            var d = a.name;
            if (q.$empty[d] || !a.children.length)if (d == "hr" && b == "br")a.replaceWith(o()); else {
                a.parent && c.push({check: "it", el: a.parent});
                a.remove()
            } else if (q.$block[d] || d == "tr")if (b == "br") {
                ...
                b:{
                    f = q[b];
                    for (var e = 0, l = d.length, k; e < l; ++e) {
                        k = d[e];
                        if (k.type ==
                            CKEDITOR.NODE_ELEMENT && !f[k.name]) {
                            f = false;
                            break b
                        }
                    }
                ...
                if (f) {
                    ...
                    f = a.parent;
                    for (var e = f.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || f.name == "body", g, l = d.length; l > 0;) {
                        k = d[--l];
                        if (e && (k.type == CKEDITOR.NODE_TEXT || k.type == CKEDITOR.NODE_ELEMENT && q.$inline[k.name])) {
                            if (!g) {
                            ...
                            g = null;
                            k.insertAfter(a);
                            f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && (k.type ==
                                CKEDITOR.NODE_ELEMENT && !q[f.name][k.name]) && c.push({check: "el-up", el: k})
                        }
                    }
                    a.remove()
                }
        ...
        function y(a, b) {
            var c = b.getDefinition(), d = c.attributes, f = c.styles, e, l, k, g;
            if (a.name != c.element)return false;
            for (e in d)if (e == "class") {
                c = d[e].split(/\s+/);
                for (k = a.classes.join("|"); g =
                    c.pop();)if (k.indexOf(g) == -1)return false
            } else if (a.attributes[e] != d[e])return false;
            for (l in f)if (a.styles[l] != f[l])return false;
            return true
        }
        ...
        var q = CKEDITOR.dtd, z = CKEDITOR.tools.copy, t = CKEDITOR.tools.trim, J = "cke-test", H = ["", "p", "br", "div"];
        CKEDITOR.filter = function (a) {
            ...
            if (a instanceof CKEDITOR.editor) {
                ...
                if (b === true)this.disabled = true; else {
                    ...
                    this.allow(H[a.enterMode] + " " + H[a.shiftEnterMode],
                        "default", 1)
                }
            } else {
        ...
        CKEDITOR.filter.prototype = {allow: function (a, c, d) {
            ...
            for (l in a) {
                e = a[l];
                e = typeof e == "boolean" ? {} : typeof e == "function" ? {match: e} : z(e);
                if (l.charAt(0) != "$")e.elements = l;
                ...
                for (q in w) {
                    k[q] = b(k[q], g) || null;
                    var p = k, s = K[q], t = b(k[K[q]], g), i = k[q], j = [], y = true, m = void 0;
                    t ? y = false : t = {};
                    for (m in i)if (m.charAt(0) == "!") {
                        m = m.slice(1);
                        j.push(m);
                        t[m] = true;
                        y = false
            ...
            for (k = d.length; e < k; ++e) {
                g = z(d[e]);
                q = g.classes === true || g.styles === true || g.attributes === true;
                p = g;
                s = void 0;
                for (s in w)p[s] = r(p[s]);
                t = true;
                for (s in K) {
                    s = K[s];
                    p[s] = CKEDITOR.tools.objectKeys(p[s]);
                    p[s] && (t = false)
                }
                p.nothingRequired = t;
                if (g.elements === true || g.elements === null) {
                    g.elements = r(g.elements);
                    a[q ? "unshift" : "push"](g)
                } else {
                    p = g.elements;
                    delete g.elements;
                    for (f in p)if (l[f])l[f][q ? "unshift" : "push"](g); else l[f] = [g]
                }
            }
            c.elements = l;
            ...
            var l = [], k = !d && this._.rules, g = this._.transformations, p = c(this), s = this.editor && this.editor.config.protectedSource, t = false;
            a.forEach(function (a) {
                if (a.type == CKEDITOR.NODE_ELEMENT) {
                    if (a.attributes["data-cke-filter"] ==
                        "off")return false;
                    if (!b || !(a.name == "span" && ~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")))p(a, k, g, l, b) && (t = true)
                    ...
                    a:{
                        ...
                        c = [];
                        var f, e, B;
                        if (s)for (e = 0; e < s.length; ++e)if ((B = d.match(s[e])) && B[0].length == d.length) {
                            c = true;
                            break a
                        }
            ...
            l.length && (t = true);
            for (var h, a = [], e = H[e || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)]; d = l.pop();)d.type == CKEDITOR.NODE_ELEMENT ? f(d, e, a) : d.remove();
            for (; h = a.pop();) {
                d = h.el;
                if (d.parent)switch (h.check) {
                    case "it":
                        q.$removeEmpty[d.name] && !d.children.length ? f(d, e, a) : n(d) || f(d, e, a);
                        break;
                    case "el-up":
                        d.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && !q[d.parent.name][d.name] && f(d, e, a);
                        break;
                    case "parent-down":
                        d.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT && !q[d.parent.name][d.name] && f(d.parent, e, a)
                }
            }
            return t
            ...
            if (!this.disabled && a) {
                ...
                for (f = 0; f < a.length; ++f) {
                    b = a[f];
                    var e = void 0, l = void 0, g = void 0, q = void 0, s = void 0, t = void 0;
                    c = [];
                    for (l = 0; l < b.length; ++l) {
                        ...
                        if (!e) {
                            e = g;
                            e = e.element ? e.element : q ? q.match(/^([a-z0-9]+)/i)[0] : e.left.getDefinition().element
                        }
                        s instanceof CKEDITOR.style && (s = p(s));
                        c.push({check: q == e ? null : q, left: s, right: typeof t == "string" ? k(t) : t})
                    }
                    b = e;
                    d[b] || (d[b] = []);
                    d[b].push(c)
            ...
            if (typeof a == "string") {
                ...
                var k = f.classes;
                f.name = f.elements;
                f.classes = k = k ? k.split(/\s*,\s*/) : [];
                f.styles = g(e);
                f.attributes = g(f.attributes);
                f.children = [];
                k.length && (f.attributes["class"] = k.join(" "));
                ...
                e = {name: f.element, attributes: k,
                    classes: k["class"] ? k["class"].split(/\s+/) : [], styles: e, children: []}
            }
            var k = CKEDITOR.tools.clone(e), q = [], p;
            if (b !== false && (p = this._.transformations[e.name])) {
                for (f = 0; f < p.length; ++f)s(this, e, p[f]);
                i(e)
            }
            c(this)(k, this._.rules, b === false ? false : this._.transformations, q, false, !d, !d);
            b = q.length > 0 ? false : CKEDITOR.tools.objectCompare(e.attributes, k.attributes, true) ? true : false;
        ...
        var w = {styles: 1, attributes: 1, classes: 1}, K = {styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses"}, C = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, O = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, I = CKEDITOR.filter.transformationsTools =
        {sizeToStyle: function (a) {
            ...
            if (!(c in a.attributes)) {
                ...
                f ? a.attributes[c] = f[1] : d == J && (a.attributes[c] =
                    J)
            }
            delete a.styles[b]
            ...
            if (typeof b == "string")a.name = b; else {
                var c = b.getDefinition(), d = c.styles, f = c.attributes, e, l, k, g;
                a.name = c.element;
                for (e in f)if (e ==
                    "class") {
                    c = a.classes.join("|");
                    for (k = f[e].split(/\s+/); g = k.pop();)c.indexOf(g) == -1 && a.classes.push(g)
    ...
    (function () {
        var a, e = function (b) {
            var b = b.data, d = b.getKeystroke(), e = this.keystrokes[d], h = this._.editor;
            a = h.fire("key", {keyCode: d}) === false;
            if (!a) {
                e && (a = h.execCommand(e, {from: "keystrokeHandler"}) !== false);
    ...
    CKEDITOR.scriptLoader = function () {
        var a = {}, e = {};
        return{load: function (b, c, d, g) {
            var h = typeof b == "string";
            h && (b = [b]);
            d || (d = CKEDITOR);
            var m = b.length, j = [], i = [], n = function (a) {
                c && (h ? c.call(d, a) : c.call(d, j, i))
            };
            if (m === 0)n(true); else {
                var r = function (a, b) {
                    (b ? j : i).push(a);
    ...
    CKEDITOR.resourceManager.prototype = {add: function (a, e) {
        ...
        for (var c = this.loaded, d = this.registered, g = [], h = {}, m = {}, j = 0; j < a.length; j++) {
            var i = a[j];
            if (i)if (!c[i] && !d[i]) {
                var n = this.getFilePath(i);
                g.push(n);
                n in h || (h[n] = []);
                h[n].push(i)
            } else m[i] =
        ...
        CKEDITOR.scriptLoader.load(g, function (a, d) {
            if (d.length)throw'[CKEDITOR.resourceManager.load] Resource name "' + h[d[0]].join(",") + '" was not found at "' + d[0] + '".';
            for (var g = 0; g < a.length; g++)for (var f = h[a[g]], s = 0; s < f.length; s++) {
                var i = f[s];
                m[i] = this.get(i);
                c[i] = 1
            }
        ...
        return function (b, c, d) {
            var g = {}, h = function (b) {
                a.call(this, b, function (a) {
                    ...
                    var b = [], m;
                    for (m in a) {
                        var r = a[m], o = r && r.requires;
                        if (!e[m]) {
                            if (r.icons)for (var u = r.icons.split(","), f = u.length; f--;)CKEDITOR.skin.addIcon(u[f], r.path + "icons/" + (CKEDITOR.env.hidpi && r.hidpi ? "hidpi/" : "") + u[f] + ".png");
                            e[m] = 1
                        }
                        if (o) {
                            o.split && (o = o.split(","));
                            for (r = 0; r < o.length; r++)g[o[r]] || b.push(o[r])
                        }
                    }
    ...
    (function () {
        function a(a, c, g) {
            ...
            if (c !== void 0) {
                ...
                if (!(g == CKEDITOR.ELEMENT_MODE_INLINE ? c.is(CKEDITOR.dtd.$editable) || c.is("textarea") : g == CKEDITOR.ELEMENT_MODE_REPLACE ?
        ...
        function n(a) {
            ...
            if (d)var k = RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?=,|$)",
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                a.plugins = c;
                for (var l in c) {
                    var p = c[l], h = p.lang, i = null, j = p.requires, v;
                    CKEDITOR.tools.isArray(j) && (j = j.join(","));
                    if (j && (v = j.match(g)))for (; j = v.pop();)CKEDITOR.tools.setTimeout(function (a, b) {
                        throw Error('Plugin "' + a.replace(",", "") + '" cannot be removed from the plugins list, because it\'s required by "' +
                            b + '" plugin.');
                    }, 0, null, [j, l]);
                    if (h && !a.lang[l]) {
                        h.split && (h = h.split(","));
                        if (CKEDITOR.tools.indexOf(h, a.langCode) >= 0)i = a.langCode; else {
                            i = a.langCode.replace(/-.*/, "");
                            i = i != a.langCode && CKEDITOR.tools.indexOf(h, i) >= 0 ? i : CKEDITOR.tools.indexOf(h, "en") >= 0 ? "en" : h[0]
                        }
                        if (!p.langEntries || !p.langEntries[i])k.push(CKEDITOR.getUrl(p.path + "lang/" + i + ".js")); else {
                            a.lang[l] = p.langEntries[i];
                            i = null
                        }
                    }
                    e.push(i);
                ...
                CKEDITOR.scriptLoader.load(k, function () {
                    for (var c = ["beforeInit", "init", "afterInit"], k = 0; k < c.length; k++)for (var l =
                        0; l < d.length; l++) {
                        var g = d[l];
                        k === 0 && (e[l] && g.lang && g.langEntries) && (a.lang[g.name] = g.langEntries[e[l]]);
                        if (g[c[k]])g[c[k]](a)
                    }
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.prototype = {onTagOpen: function () {
            ...
            for (var c, d, g = 0, h; c = this._.htmlPartsRegex.exec(b);) {
                d = c.index;
                if (d > g) {
                    g = b.substring(g, d);
                    if (h)h.push(g); else this.onText(g)
                }
                g =
                ...
                if (h)h.push(c[0]); else if (d = c[3]) {
                    d = d.toLowerCase();
                    if (!/="/.test(d)) {
                        var m = {}, j;
                        c = c[4];
                        var i = !!(c && c.charAt(c.length - 1) == "/");
                        if (c)for (; j = a.exec(c);) {
                            var n = j[1].toLowerCase();
                            j = j[2] || j[3] || j[4] || "";
                            m[n] = !j && e[n] ? n : CKEDITOR.tools.htmlDecodeAttr(j)
                        }
                        this.onTagOpen(d, m, i);
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (d, g, h) {
            function m(a) {
                ...
                if (s.length > 0)for (var c = 0; c < s.length; c++) {
                    var d =
                        s[c], e = d.name, f = CKEDITOR.dtd[e], k = l.name && CKEDITOR.dtd[l.name];
            ...
            function r(a, b) {
                if ((a == f || a.name == "body") && h && (!a.name || CKEDITOR.dtd[a.name][h])) {
                    var c, d;
            ...
            var u = new CKEDITOR.htmlParser, f = g instanceof CKEDITOR.htmlParser.element ? g : typeof g == "string" ? new CKEDITOR.htmlParser.element(g) : new CKEDITOR.htmlParser.fragment, s = [], y = [], l = f, p = f.name == "textarea", k = f.name == "pre";
            u.onTagOpen = function (d, f, g, h) {
                f = new CKEDITOR.htmlParser.element(d, f);
                if (f.isUnknown && g)f.isEmpty = true;
                f.isOptionalClose = h;
                if (a(f))s.push(f); else {
                    if (d == "pre")k =
                        true; else {
                        if (d == "br" && k) {
                    ...
                    if (d == "br")y.push(f); else {
                        for (; ;) {
                            h = (g = l.name) ? CKEDITOR.dtd[g] || (l._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                            if (!f.isUnknown && !l.isUnknown && !h[d])if (l.isOptionalClose)u.onTagClose(g); else if (d in b && g in b) {
                                g = l.children;
                                (g = g[g.length - 1]) && g.name == "li" || n(g = new CKEDITOR.htmlParser.element("li"), l);
                                !f.returnPoint && (f.returnPoint = l);
                                l = g
                            } else if (d in CKEDITOR.dtd.$listItem && !o(d, g))u.onTagOpen(d ==
                                "li" ? "ul" : "dl", {}, 0, 1); else if (g in e && !o(d, g)) {
                                !f.returnPoint && (f.returnPoint = l);
                                l = l.parent
                            } else {
                                g in CKEDITOR.dtd.$inline && s.unshift(l);
                                if (l.parent)n(l, l.parent, 1); else {
                                    f.isOrphan = 1;
                                    break
                                }
                            } else break
            ...
            u.onText = function (a) {
                if ((!l._.hasInlineStarted || y.length) && !k && !p) {
                    a = CKEDITOR.tools.ltrim(a);
                    if (a.length === 0)return
                }
                var d = l.name, f = d ? CKEDITOR.dtd[d] || (l._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                if (!p && !f["#"] && d in e) {
        ...
        CKEDITOR.htmlParser.fragment.prototype = {type: CKEDITOR.NODE_DOCUMENT_FRAGMENT, add: function (a, b) {
            ...
            if (!c && (!b || this.type == b))var e = a(this);
            if (e !== false)for (var c = this.children, j = 0; j < c.length; j++) {
                e = c[j];
                e.type == CKEDITOR.NODE_ELEMENT ? e.forEach(a, b) : (!b || e.type == b) && a(e)
            }
        }, getFilterContext: function (a) {
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({$: function (b) {
            ...
            for (var d = [this.elementsRules["^"], this.elementsRules[c.name], this.elementsRules.$], e, h = 0; h < 3; h++)if (e = d[h]) {
                e = e.exec(a, c, this);
        ...
        a.prototype = {add: function (a, c, d) {
            ...
            for (var e = [this.findIndex(c), 0], h = 0, m = a.length; h < m; h++)e.push({value: a[h], priority: c, options: d});
            this.rules.splice.apply(this.rules, e)
        }, findIndex: function (a) {
            for (var c = this.rules, d = c.length - 1; d >= 0 && a < c[d].priority;)d--;
            return d + 1
        }, exec: function (a, c) {
            var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, e = Array.prototype.slice.call(arguments, 1), h = this.rules, m = h.length, j, i, n, r;
            for (r = 0; r < m; r++) {
                if (d) {
                    j = c.type;
                    i = c.name
                ...
                if (!(a.nonEditable && !n.options.applyToAll ||
                    ...
                    n = n.value.apply(null, e);
                    if (n === false || d && n && (n.name != i || n.type != j))return n;
                    n != void 0 && (e[0] = c = n)
                }
            }
            return c
        }, execOnName: function (a, c) {
            for (var d = 0, e = this.rules, h = e.length, m; c && d < h; d++) {
                m = e[d];
                !(a.nonEditable && !m.options.applyToAll || a.nestedEditable && m.options.excludeNestedEditable) && (c = c.replace(m.value[0], m.value[1]))
            }
            return c
        }}
    })();
    (function () {
        function a(a, e) {
            ...
            function k(a, d) {
                return function (e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var k = [], p = b(e), B, q;
                        if (p)for (l(p, 1) && k.push(p); p;) {
                            if (g(p) && (B = c(p)) && l(B))if ((q = c(B)) && !g(q))k.push(B); else {
                                f(v).insertAfter(B);
                                B.remove()
                            }
                            p = p.previous
                        }
                        for (p = 0; p < k.length; p++)k[p].remove();
            ...
            function l(a, b) {
                ...
                if (a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(y))) {
                    ...
                    if (!v)if ((c = a.previous) && c.name == "br" || !c || g(c))return true
                }
                return false
            }

            var t = {elements: {}}, v = e == "html", i = CKEDITOR.tools.extend({}, q), j;
            for (j in i)"#"in p[j] || delete i[j];
            for (j in i)t.elements[j] = k(v, a.config.fillEmptyBlocks !== false);
            t.root = k(v);
                ...
                return function (b) {
                    if (b.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if ("data-cke-bogus"in e || "data-cke-eol"in
                            ...
                            var k = c(b);
                            !e && g(b.parent) ? h(b.parent, f(a)) : g(e) && (k && !g(k)) && f(a).insertBefore(e)
                        }
                    }
                }
            }(v);
        ...
        function i(a) {
            return a.replace(w, function (a, b, c) {
                return"<" + b + c.replace(K, function (a, b) {
        ...
        function s(a, b) {
            ...
            a = a.replace(f, function (a, b, d) {
                return"<\!--" +
                    l + (b ? "{C}" : "") + encodeURIComponent(c[d]).replace(/--/g, "%2D%2D") + "--\>"
            });
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            c.addRules(z);
            c.addRules(t, {applyToAll: true});
            c.addRules(a(b, "data"), {applyToAll: true});
            d.addRules(J);
            d.addRules(H, {applyToAll: true});
            d.addRules(a(b, "html"), {applyToAll: true});
            b.on("toHtml", function (a) {
                var a = a.data, c = a.dataValue, c = s(c, b), c = n(c, O), c = i(c), c = n(c, C), c = c.replace(v, "$1cke:$2"), c = c.replace(G, "<cke:$1$2></cke:$1>"), c = CKEDITOR.env.opera ? c : c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g, "$1$2$2"), d = a.context || b.editable().getName(), f;
        ...
        var y = /(?:&nbsp;|\xa0)$/, l = "{cke_protected}", p = CKEDITOR.dtd, k = ["caption", "colgroup", "col", "thead", "tfoot",
            "tbody"], q = CKEDITOR.tools.extend({}, p.$blockLimit, p.$block), z = {elements: {input: m, textarea: m}}, t = {attributeNames: [
            [/^on/, "data-cke-pa-on"],
            [/^data-cke-expando$/, ""]
        ]}, J = {elements: {embed: function (a) {
            var b = a.parent;
            if (b && b.name == "object") {
            ...
            }, input: j, textarea: j}, attributes: {"class": function (a) {
                return CKEDITOR.tools.ltrim(a.replace(/(?:^|\s+)cke_[^\s]*/g, "")) || false
            }}};
        if (CKEDITOR.env.ie)H.attributes.style = function (a) {
            return a.replace(/(^|;)([^\:]+)/g, function (a) {
                return a.toLowerCase()
            })
        };
        var w = /<(a|area|img|input|source)\b([^>]*)>/gi, K = /\s(on\w+|href|src|name)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, C = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,
            O = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, I = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, v = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi, x = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, G = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {type: CKEDITOR.NODE_ELEMENT, add: b.add, clone: function () {
            ...
            var e = this, h, m, b = e.getFilterContext(b);
            if (b.off)return true;
            if (!e.parent)a.onRoot(b, e);
            for (; ;) {
                h = e.name;
                if (!(m = a.onElementName(b, h))) {
                    this.remove();
                    return false
                }
                e.name = m;
            ...
            for (j in h) {
                i = j;
                for (m = h[j]; ;)if (i = a.onAttributeName(b, j))if (i != j) {
                    delete h[j];
                    j = i
                } else break; else {
                    delete h[j];
            ...
            !a.nonEditable && this.attributes.contenteditable == "false" ? b.push("nonEditable", true) : !a.nestedEditable && this.attributes.contenteditable == "true" &&
                b.push("nestedEditable", true);
            if (b.length)for (var a = CKEDITOR.tools.copy(a), e = 0; e < b.length; e = e + 2)a[b[e]] = b[e + 1];
            return a
        }}, true)
    })();
    (function () {
    ...
    (function () {
        ...
        CKEDITOR.inlineAll = function () {
            var a, e, b;
            for (b in CKEDITOR.dtd.$editable)for (var c = CKEDITOR.document.getElementsByTag(b), d = 0, g = c.count(); d < g; d++) {
                a = c.getItem(d);
                if (a.getAttribute("contenteditable") == "true") {
                    e = {element: a, config: {}};
    ...
    (function () {
        function a(a, c, h, m) {
            ...
            a = CKEDITOR.dom.element.get(a);
            if (a.getEditor())throw'The editor instance "' + a.getEditor().name + '" is already attached to the provided element.';
            var j = new CKEDITOR.editor(c, a, m);
            if (m == CKEDITOR.ELEMENT_MODE_REPLACE) {
            ...
            j.on("loaded", function () {
                b(j);
                m == CKEDITOR.ELEMENT_MODE_REPLACE && (j.config.autoUpdateElement &&
        ...
        function b(a) {
            var b = a.name, e = a.element, m = a.elementMode,
                j = a.fire("uiSpace", {space: "top", html: ""}).html, i = a.fire("uiSpace", {space: "bottom", html: ""}).html;
            ...
            b = CKEDITOR.dom.element.createFromHtml(c.output({id: a.id, name: b, langDir: a.lang.dir, langCode: a.langCode, voiceLabel: [a.lang.editor, a.name].join(", "), topHtml: j ? '<span id="' + a.ui.spaceId("top") + '" class="cke_top cke_reset_all" role="presentation" style="height:auto">' + j + "</span>" : "", contentId: a.ui.spaceId("contents"), bottomHtml: i ? '<span id="' + a.ui.spaceId("bottom") + '" class="cke_bottom cke_reset_all" role="presentation">' + i + "</span>" : "", outerEl: CKEDITOR.env.ie ? "span" : "div"}));
            if (m == CKEDITOR.ELEMENT_MODE_REPLACE) {
                e.hide();
                b.insertAfter(e)
            } else e.append(b);
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, c, e) {
            ...
            n && (n.style.width = "1%");
            i.setStyle("height", Math.max(b - (c ? 0 : (e.$.offsetHeight || 0) - (i.$.clientHeight || 0)), 0) + "px");
            n && (n.style.width = "100%");
            this.fire("resize")
        };
    ...
    (function () {
        function a(a) {
            var b = a.editor, d = a.data.path, l = d.blockLimit, p = a.data.selection, k = p.getRanges()[0], g;
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller)if (p = e(p, d)) {
                p.appendBogus();
                g = CKEDITOR.env.ie
            }
            if (b.config.autoParagraph !== false && b.activeEnterMode != CKEDITOR.ENTER_BR && b.editable().equals(l) && !d.block && k.collapsed && !k.getCommonAncestor().isReadOnly()) {
                d = k.clone();
                d.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS);
                l = new CKEDITOR.dom.walker(d);
                l.guard = function (a) {
                    return!c(a) || a.type ==
                        CKEDITOR.NODE_COMMENT || a.isReadOnly()
                };
                if (!l.checkForward() || d.checkStartOfBlock() && d.checkEndOfBlock()) {
        ...
        function g(a) {
            var b, e = a.getRanges()[0], d = a.root, p = {table: 1, ul: 1, ol: 1, dl: 1};
            if (e.startPath().contains(p)) {
                var a =
                    function (a) {
                        return function (e, d) {
                            d && (e.type == CKEDITOR.NODE_ELEMENT && e.is(p)) && (b = e);
                            if (!d && c(e) && (!a || !j(e)))return false
                        }
                    }, k = e.clone();
                k.collapse(1);
                k.setStartAt(d, CKEDITOR.POSITION_AFTER_START);
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({base: CKEDITOR.dom.element, $: function (a, b) {
        ...
        }, attachListener: function (a, b, c, e, d, k) {
            ...
            if (!b) {
                var d = /\n{2}/g;
                if (d.test(a))var k = "<" + c + ">", g = "</" + c + ">", a = k + a.replace(d, function () {
                    return g + k
                }) + g
            }
            a = a.replace(/\n/g, "<br>");
            ...
            var g, h;
            if (k)for (; (g = b.getCommonAncestor(0, 1)) && (h = CKEDITOR.dtd[g.getName()]) && (!h || !h[d]);)if (g.getName()in CKEDITOR.dtd.span)b.splitElement(g); else if (b.checkStartOfBlock() && b.checkEndOfBlock()) {
                b.setStartBefore(g);
                b.collapse(true);
                g.remove()
            ...
            var b = this.editor, e = b.activeEnterMode, b = b.getSelection(), d = b.getRanges()[0], g = a.getName(), g = CKEDITOR.dtd.$block[g];
            h(this);
            if (this.insertElementIntoRange(a, d)) {
                d.moveToPosition(a, CKEDITOR.POSITION_AFTER_END);
                if (g)if ((g = a.getNext(function (a) {
                    return c(a) && !j(a)
                })) && g.type == CKEDITOR.NODE_ELEMENT && g.is(CKEDITOR.dtd.$block))g.getDtd()["#"] ? d.moveToElementEditStart(g) : d.moveToElementEditEnd(a); else if (!g && e != CKEDITOR.ENTER_BR) {
                    g = d.fixBlock(true, e == CKEDITOR.ENTER_DIV ?
                        "div" : "p");
                    d.moveToElementEditStart(g)
                }
            }
            b.selectRanges([d]);
            m(this, CKEDITOR.env.opera)
                ...
                if (!this.is("textarea")) {
                    ...
                    if (l) {
                        ...
                        if (!d.getCustomData("stylesheet")) {
                            l = e.appendStyleText(l);
                            l = new CKEDITOR.dom.element(l.ownerNode || l.owningElement);
                            d.setCustomData("stylesheet", l);
                            l.data("cke-temp", 1)
                        }
                    }
                    ...
                    this.attachListener(a, "key", function (b) {
                        ...
                        if (c in p) {
                            var b = a.getSelection(), d, l = b.getRanges()[0], h = l.startPath(), i, j, m, c = c == 8;
                            if (CKEDITOR.env.ie && CKEDITOR.env.version < 11 && (d = b.getSelectedElement()) || (d = g(b))) {
                                a.fire("saveSnapshot");
                                l.moveToPosition(d, CKEDITOR.POSITION_BEFORE_START);
                                d.remove();
                                l.select();
                                a.fire("saveSnapshot");
                                e = 1
                            } else if (l.collapsed)if ((i = h.block) && (m = i[c ? "getPrevious" : "getNext"](n)) && m.type == CKEDITOR.NODE_ELEMENT && m.is("table") &&
                                l[c ? "checkStartOfBlock" : "checkEndOfBlock"]()) {
                                a.fire("saveSnapshot");
                                l[c ? "checkEndOfBlock" : "checkStartOfBlock"]() && i.remove();
                                l["moveToElementEdit" + (c ? "End" : "Start")](m);
                                l.select();
                                a.fire("saveSnapshot");
                                e = 1
                            } else if (h.blockLimit && h.blockLimit.is("td") && (j = h.blockLimit.getAscendant("table")) && l.checkBoundaryOfElement(j, c ? CKEDITOR.START : CKEDITOR.END) && (m = j[c ? "getPrevious" : "getNext"](n))) {
                                a.fire("saveSnapshot");
                                l["moveToElementEdit" + (c ? "End" : "Start")](m);
                                l.checkStartOfBlock() && l.checkEndOfBlock() ? m.remove() :
                                    l.select();
                                a.fire("saveSnapshot");
                                e = 1
                            } else if ((j = h.contains(["td", "th", "caption"])) && l.checkBoundaryOfElement(j, c ? CKEDITOR.START : CKEDITOR.END))e = 1
                        }
                        return!e
                    });
                    a.blockless && (CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller) && this.attachListener(this, "keyup", function (b) {
                        if (b.data.getKeystroke()in p && !this.getFirst(c)) {
                            this.appendBogus();
                            b = a.createRange();
        ...
        var j =
            CKEDITOR.dom.walker.bogus(), i = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi, n = CKEDITOR.dom.walker.whitespaces(true), r = CKEDITOR.dom.walker.bookmark(false, true);
        ...
        var o = function () {
            ...
            function b(c, e) {
                var d, k, l, g, p = [], t = e.range.startContainer;
                d = e.range.startPath();
                for (var t =
                    h[t.getName()], i = 0, j = c.getChildren(), m = j.count(), n = -1, J = -1, r = 0, o = d.contains(h.$list); i < m; ++i) {
                    d = j.getItem(i);
                    if (a(d)) {
                        l = d.getName();
                        if (o && l in CKEDITOR.dtd.$list)p = p.concat(b(d, e)); else {
                            g = !!t[l];
                            if (l == "br" && d.data("cke-eol") && (!i || i == m - 1)) {
                                r = (k = i ? p[i - 1].node : j.getItem(i + 1)) && (!a(k) || !k.is("br"));
                                k = k && a(k) && h.$block[k.getName()]
                            }
                            n == -1 && !g && (n = i);
                            g || (J = i);
                            p.push({isElement: 1, isLineBreak: r, isBlock: d.isBlockBoundary(), hasBlockSibling: k, node: d, name: l, allowed: g});
                            k = r = 0
                        }
                    } else p.push({isElement: 0, node: d,
                        allowed: 1})
                }
                if (n > -1)p[n].firstNotAllowed = 1;
                if (J > -1)p[J].lastNotAllowed = 1;
                return p
            }

            function e(b, c) {
                var d = [], k = b.getChildren(), l = k.count(), g, p = 0, i = h[c], t = !b.is(h.$inline) || b.is("br");
                for (t && d.push(" "); p < l; p++) {
                    g = k.getItem(p);
                    a(g) && !g.is(i) ? d = d.concat(e(g, c)) : d.push(g)
                }
                t && d.push(" ");
                return d
            }
            ...
            function g(b, c, e, d) {
                ...
                if ((l = (new CKEDITOR.dom.walker(k)).next()) &&
                    a(l) && i[l.getName()] && (h = l.getPrevious()) && a(h) && !h.getParent().equals(b.startContainer) && e.contains(h) && d.contains(l) && l.isIdentical(h)) {
                    l.moveChildren(h);
                    l.remove();
                    g(b, c, e, d)
                }
            ...
            var h = CKEDITOR.dtd, i = {p: 1, div: 1,
                h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1}, t = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, j = CKEDITOR.tools.extend({}, h.$inline);
            delete j.br;
            return function (i, n, r) {
                var o = i.editor;
                i.getDocument();
                var z = o.getSelection().getRanges()[0], u = false;
                if (n == "unfiltered_html") {
                    n = "html";
                    u = true
                }
                if (!z.checkReadOnly()) {
                    var v = (new CKEDITOR.dom.elementPath(z.startContainer, z.root)).blockLimit || z.root, n = {type: n, dontFilter: u, editable: i, editor: o, range: z, blockLimit: v, mergeCandidates: [], zombies: []},
                        o = n.range, u = n.mergeCandidates, x, G, B, D;
                    if (n.type == "text" && o.shrink(CKEDITOR.SHRINK_ELEMENT, true, false)) {
                        x = CKEDITOR.dom.element.createFromHtml("<span>&nbsp;</span>", o.document);
                        o.insertNode(x);
                        o.setStartAfter(x)
                    }
                    G = new CKEDITOR.dom.elementPath(o.startContainer);
                    n.endPath = B = new CKEDITOR.dom.elementPath(o.endContainer);
                    if (!o.collapsed) {
                        var v = B.block || B.blockLimit, V = o.getCommonAncestor();
                        v && (!v.equals(V) && !v.contains(V) && o.checkEndOfBlock()) && n.zombies.push(v);
                        o.deleteContents()
                    }
                    for (; (D = a(o.startContainer) &&
                        o.startContainer.getChild(o.startOffset - 1)) && a(D) && D.isBlockBoundary() && G.contains(D);)o.moveToPosition(D, CKEDITOR.POSITION_BEFORE_END);
                    g(o, n.blockLimit, G, B);
                    if (x) {
                        o.setEndBefore(x);
                        o.collapse();
                        x.remove()
                    ...
                    x = o.startPath();
                    if (v = x.contains(d, false, 1)) {
                        o.splitElement(v);
                        n.inlineStylesRoot = v;
                        n.inlineStylesPeak = x.lastElement
                    }
                    x = o.createBookmark();
                    (v = x.startNode.getPrevious(c)) && a(v) && d(v) && u.push(v);
                    (v = x.startNode.getNext(c)) && a(v) && d(v) && u.push(v);
                    for (v = x.startNode; (v = v.getParent()) && d(v);)u.push(v);
                    o.moveToBookmark(x);
                    if (x = r) {
                        x = n.range;
                        if (n.type == "text" && n.inlineStylesRoot) {
                            D = n.inlineStylesPeak;
                            o = D.getDocument().createText("{cke-peak}");
                            for (u = n.inlineStylesRoot.getParent(); !D.equals(u);) {
                                o = o.appendTo(D.clone());
                                D = D.getParent()
                            }
                            r = o.getOuterHtml().split("{cke-peak}").join(r)
                        }
                        D = n.blockLimit.getName();
                        if (/^\s+|\s+$/.test(r) && "span"in CKEDITOR.dtd[D])var P = '<span data-cke-marker="1">&nbsp;</span>', r = P + r + P;
                        r = n.editor.dataProcessor.toHtml(r, {context: null, fixForBody: false, dontFilter: n.dontFilter, filter: n.editor.activeFilter,
                        ...
                        if ((P = x.startPath().block) && !(P.getChildCount() == 1 && P.getBogus()))a:{
                            var E;
                            if (D.getChildCount() == 1 && a(E = D.getFirst()) && E.is(t)) {
                                P = E.getElementsByTag("*");
                                x = 0;
                                for (u = P.count(); x < u; x++) {
                                    o = P.getItem(x);
                                    if (!o.is(j))break a
                    ...
                    if (x) {
                        E = n.range;
                        var P = E.document, A, r = n.blockLimit;
                        x = 0;
                        var L;
                        D = [];
                        var F, Q, u = o = 0, M, S;
                        G = E.startContainer;
                        var v = n.endPath.elements[0], T;
                        B = v.getPosition(G);
                        V = !!v.getCommonAncestor(G) && B != CKEDITOR.POSITION_IDENTICAL && !(B & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                        G = b(n.dataWrapper, n);
                        for (k(G, E); x < G.length; x++) {
                            B = G[x];
                            if (A = B.isLineBreak) {
                                A = E;
                                M = r;
                                var N = void 0, W = void 0;
                                if (B.hasBlockSibling)A = 1; else {
                                    N = A.startContainer.getAscendant(h.$block, 1);
                                    if (!N || !N.is({div: 1, p: 1}))A = 0; else {
                                        W = N.getPosition(M);
                                        if (W == CKEDITOR.POSITION_IDENTICAL || W == CKEDITOR.POSITION_CONTAINS)A = 0; else {
                                            M = A.splitElement(N);
                                            A.moveToPosition(M,
                                                CKEDITOR.POSITION_AFTER_START);
                                            A = 1
                            ...
                            if (A)u = x > 0; else {
                                A = E.startPath();
                                if (!B.isBlock && n.editor.config.autoParagraph !== false && (n.editor.activeEnterMode != CKEDITOR.ENTER_BR && n.editor.editable().equals(A.blockLimit) && !A.block) && (Q = n.editor.activeEnterMode != CKEDITOR.ENTER_BR && n.editor.config.autoParagraph !== false ? n.editor.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : false)) {
                                    Q = P.createElement(Q);
                                    Q.appendBogus();
                                    E.insertNode(Q);
                                    CKEDITOR.env.needsBrFiller && (L = Q.getBogus()) && L.remove();
                                    E.moveToPosition(Q,
                                        CKEDITOR.POSITION_BEFORE_END)
                                }
                                if ((A = E.startPath().block) && !A.equals(F)) {
                                    if (L = A.getBogus()) {
                                        L.remove();
                                        D.push(A)
                                    }
                                ...
                                if (o && B.isElement) {
                                    A = E.startContainer;
                                    for (M = null; A && !h[A.getName()][B.name];) {
                                        if (A.equals(r)) {
                                            A = null;
                                            break
                                        }
                                    ...
                                    if (A) {
                                        ...
                                        A = x == G.length - 1;
                                        M = e(B.node, M);
                                        for (var N = [], W = M.length, Z = 0, aa = void 0, ba = 0, ca = -1; Z < W; Z++) {
                                            aa = M[Z];
                                            if (aa == " ") {
                                                if (!ba && (!T || Z)) {
                                ...
                                if (T) {
                                    for (; A = T.pop();)E.insertNode(A);
                                    T = 0
                                } else E.insertNode(B.node);
                                if (B.lastNotAllowed && x < G.length - 1) {
                                    (S = V ? v : S) && E.setEndAt(S, CKEDITOR.POSITION_AFTER_START);
                                    o = 0
                                }
                                E.collapse()
                            }
                        ...
                        n.dontMoveCaret = u;
                        n.bogusNeededBlocks = D
                    }
                    L = n.range;
                    var X;
                    S = n.bogusNeededBlocks;
                    for (T = L.createBookmark(); F = n.zombies.pop();)if (F.getParent()) {
                        Q = L.clone();
                        Q.moveToElementEditStart(F);
                        Q.removeEmptyBlocksAtEnd()
                    }
                    if (S)for (; F = S.pop();)CKEDITOR.env.needsBrFiller ? F.appendBogus() :
                        F.append(L.document.createText(" "));
                    for (; F = n.mergeCandidates.pop();)F.mergeSiblings();
                    L.moveToBookmark(T);
                    if (!n.dontMoveCaret) {
                        for (F = a(L.startContainer) && L.startContainer.getChild(L.startOffset - 1); F && a(F) && !F.is(h.$empty);) {
                            if (F.isBlockBoundary())L.moveToPosition(F, CKEDITOR.POSITION_BEFORE_END); else {
                                if (d(F) && F.getHtml().match(/(\s|&nbsp;)$/g)) {
                                    X = null;
                                    break
                                }
                                X = L.clone();
            ...
            return function (e) {
                var d =
                    e.startContainer, k = d.getAscendant("table", 1), g = false;
                c(k.getElementsByTag("td"));
                c(k.getElementsByTag("th"));
                k = e.clone();
                k.setStart(d, 0);
                k = a(k).lastBackward();
                if (!k) {
                    k = e.clone();
                    k.setEndAt(d, CKEDITOR.POSITION_BEFORE_END);
                    k = a(k).lastForward();
                    g = true
                }
                k || (k = d);
                if (k.is("table")) {
                    e.setStartAt(k, CKEDITOR.POSITION_BEFORE_START);
                    e.collapse(true);
                    k.remove()
                } else {
                    k.is({tbody: 1, thead: 1, tfoot: 1}) && (k = b(k, "tr", g));
                    k.is("tr") && (k = b(k, k.getParent().is("thead") ? "th" : "td", g));
                    (d = k.getBogus()) && d.remove();
                    e.moveToPosition(k,
    ...
    (function () {
        ...
        function c(a) {
            ...
            var c = a.startContainer, e = a.getPreviousNode(o, null, c), d = a.getNextNode(o, null, c);
        ...
        var n, r, o = CKEDITOR.dom.walker.invisible(1), u = function () {
            function a(b) {
                return function (a) {
        ...
        CKEDITOR.on("instanceCreated", function (b) {
            ...
            d.on("contentDom", function () {
                var b = d.document, c = CKEDITOR.document, l = d.editable(), h = b.getBody(), p = b.getDocumentElement(), j = l.isInline(), n, m;
                CKEDITOR.env.gecko && l.attachListener(l, "focus", function (a) {
                    a.removeListener();
                    if (n !== 0)if ((a = d.getSelection().getNative()) &&
                        a.isCollapsed && a.anchorNode == l.$) {
                        a = d.createRange();
                ...
                l.attachListener(l, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function () {
                    n && CKEDITOR.env.webkit && (n = d._.previousActive && d._.previousActive.equals(b.getActive()));
                    d.unlockSelection(n);
                    n = 0
                }, null, null, -1);
                ...
                if (CKEDITOR.env.ie || CKEDITOR.env.opera || j) {
                    var o = function () {
                        m = new CKEDITOR.dom.selection(d.getSelection());
                        m.lock()
                    };
                    f ? l.attachListener(l, "beforedeactivate",
                        o, null, null, -1) : l.attachListener(d, "selectionCheck", o, null, null, -1);
                ...
                if (CKEDITOR.env.ie && !j) {
                    ...
                    l.attachListener(l, "mousedown", function (a) {
                        if (a.data.$.button == 2) {
                            ...
                            if (!a || a.getType() == CKEDITOR.SELECTION_NONE)r = d.window.getScrollPosition()
                        }
                    });
                    l.attachListener(l, "mouseup", function (a) {
                        if (a.data.$.button == 2 && r) {
                            d.document.$.documentElement.scrollLeft =
                                r.x;
                            d.document.$.documentElement.scrollTop = r.y
                        }
                        r = null
                    });
                    if (b.$.compatMode != "BackCompat") {
                        if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat)p.on("mousedown", function (a) {
                            function b(a) {
                                a = a.data.$;
                                if (e) {
                ...
                l.attachListener(l, "selectionchange", a, d);
                l.attachListener(l, "keyup", e, d);
                l.attachListener(l, CKEDITOR.env.webkit ? "DOMFocusIn" : "focus", function () {
                ...
                if (j ? CKEDITOR.env.webkit || CKEDITOR.env.gecko : CKEDITOR.env.opera) {
                    ...
                    l.attachListener(b.getDocumentElement(), "mouseup", function () {
                        x && e.call(d);
                        x = 0
                    })
                } else l.attachListener(CKEDITOR.env.ie ? l : b.getDocumentElement(), "mouseup", e, d);
                CKEDITOR.env.webkit &&
                l.attachListener(b, "keydown", function (a) {
                ...
                l.attachListener(l, "keydown", i(d), null, null, -1)
            });
        ...
        var f = typeof window.getSelection != "function", s = 1;
        CKEDITOR.dom.selection = function (a) {
            ...
            if (CKEDITOR.env.webkit)(b.type == "None" && this.document.getActive().equals(a) || b.type == "Caret" && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && m(a, b); else if (CKEDITOR.env.gecko)b && (this.document.getActive().equals(a) && b.anchorNode && b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT) && m(a, b, true); else if (CKEDITOR.env.ie) {
                var d;
                try {
                    d = this.document.getActive()
                } catch (e) {
                }
                if (f)b.type == "None" && (d && d.equals(this.document.getDocumentElement())) && m(a, null, true); else {
                    (b = b && b.anchorNode) && (b = new CKEDITOR.dom.node(b));
                    d && (d.equals(this.document.getDocumentElement()) && b && (a.equals(b) || a.contains(b))) && m(a, null, true)
                }
            }
            d = this.getNative();
            var g, h;
        ...
        {getNative: function () {
            ...
            var a = f ? function () {
                ...
                var b = function (b, c) {
                    ...
                    for (var e = d.children, f, g, k = b.duplicate(), l = 0, h = e.length - 1, i = -1, j, n; l <= h;) {
                        i = Math.floor((l + h) / 2);
                        f = e[i];
                        k.moveToElementText(f);
                        j = k.compareEndPoints("StartToStart", b);
                        if (j > 0)h = i - 1; else if (j < 0)l = i + 1; else return{container: d, offset: a(f)}
                    }
                    if (i == -1 || i == e.length - 1 && j < 0) {
                        ...
                        return{container: n, offset: -k}
                    }
                    k.collapse(j > 0 ? true : false);
                    k.setEndPoint(j > 0 ? "StartToStart" : "EndToStart", b);
                    k = k.text.replace(/(\r\n|\r)/g, "\n").length;
                    if (!k)return{container: d, offset: a(f) + (j > 0 ? 0 : 1)};
                    for (; k > 0;)try {
                    ...
                    return{container: n, offset: j > 0 ? -k : n.nodeValue.length + k}
                };
                return function () {
            ...
            this.reset();
            if (b)for (var b = this.root, d, e = 0; e < a.length; ++e) {
                d = a[e];
            ...
            if (a.length)if (this.isLocked) {
                ...
                this.selectRanges(a);
                this.lock();
                !h.equals(this.root) && h.focus()
            } else {
                var i;
                a:{
                    var j, n;
                    if (a.length == 1 && !(n = a[0]).collapsed && (i = n.getEnclosedNode()) && i.type == CKEDITOR.NODE_ELEMENT) {
                        n = n.clone();
                        n.shrink(CKEDITOR.SHRINK_ELEMENT, true);
                        if ((j = n.getEnclosedNode()) && j.type == CKEDITOR.NODE_ELEMENT)i = j;
                        if (i.getAttribute("contenteditable") == "false")break a
                    }
                    i = void 0
                }
                if (i)this.fake(i); else {
                    if (f) {
                        ...
                        if (a.length > 1) {
                            i = a[a.length - 1];
                            a[0].setEnd(i.endContainer, i.endOffset)
                        }
                        i = a[0];
                        var a = i.collapsed, m, o, r;
                        if ((d = i.getEnclosedNode()) && d.type == CKEDITOR.NODE_ELEMENT && d.getName()in y && (!d.is("a") || !d.getText()))try {
                            r = d.$.createControlRange();
                            r.addElement(d.$);
                            r.select();
                            return
                        } catch (s) {
                        }
                        (i.startContainer.type == CKEDITOR.NODE_ELEMENT && i.startContainer.getName()in b || i.endContainer.type == CKEDITOR.NODE_ELEMENT && i.endContainer.getName()in b) && i.shrink(CKEDITOR.NODE_ELEMENT, true);
                        r = i.createBookmark();
                        b =
                            r.startNode;
                        if (!a)h = r.endNode;
                        r = i.document.$.body.createTextRange();
                        r.moveToElementText(b.$);
                        r.moveStart("character", 1);
                        if (h) {
                            j = i.document.$.body.createTextRange();
                            j.moveToElementText(h.$);
                            r.setEndPoint("EndToEnd", j);
                            r.moveEnd("character", -1)
                        } else {
                            m = b.getNext(n);
                            o = b.hasAscendant("pre");
                            m = !(m && m.getText && m.getText().match(j)) && (o || !b.hasPrevious() || b.getPrevious().is && b.getPrevious().is("br"));
                            o = i.document.createElement("span");
                            o.setHtml("&#65279;");
                            o.insertBefore(b);
                            m && i.document.createText("﻿").insertBefore(b)
                        }
                        i.setStartBefore(b);
                        b.remove();
                        if (a) {
                            if (m) {
                                r.moveStart("character", -1);
                                r.select();
                                i.document.$.selection.clear()
                            } else r.select();
                            i.moveToPosition(o, CKEDITOR.POSITION_BEFORE_START);
                            o.remove()
                        } else {
                            i.setEndBefore(h);
                            h.remove();
                        ...
                        for (r = 0; r < a.length; r++) {
                            if (r < a.length - 1) {
                                ...
                                m = a[r + 1];
                                j = i.clone();
                                j.setStart(i.endContainer, i.endOffset);
                                j.setEnd(m.startContainer,
                                    m.startOffset);
                                if (!j.collapsed) {
                                    j.shrink(CKEDITOR.NODE_ELEMENT, true);
                                    o = j.getCommonAncestor();
                                    j = j.getEnclosedNode();
                                    if (o.isReadOnly() || j && j.isReadOnly()) {
                                        m.setStart(i.startContainer, i.startOffset);
                                        a.splice(r--, 1);
                                        continue
                                    }
                                }
                            ...
                            m = i.startContainer;
                            if (CKEDITOR.env.opera && i.collapsed && m.type == CKEDITOR.NODE_ELEMENT) {
                                j = m.getChild(i.startOffset - 1);
                                n = m.getChild(i.startOffset);
                                if (!j && !n && m.is(CKEDITOR.dtd.$removeEmpty) || j && j.type == CKEDITOR.NODE_ELEMENT || n && n.type == CKEDITOR.NODE_ELEMENT) {
                                    i.insertNode(this.document.createText(""));
                                    i.collapse(1)
                                }
                            }
                            if (i.collapsed && CKEDITOR.env.webkit && c(i)) {
                                m = this.root;
                                g(m, false);
                                ...
                                if ((m = j.getNext()) && !j.getPrevious() && m.type == CKEDITOR.NODE_ELEMENT && m.getName() == "br") {
                                    g(this.root);
                                    i.moveToPosition(m, CKEDITOR.POSITION_BEFORE_START)
                                } else i.moveToPosition(j, CKEDITOR.POSITION_AFTER_END)
                            }
                            o.setStart(i.startContainer.$, i.startOffset);
                            try {
                                o.setEnd(i.endContainer.$, i.endOffset)
                            } catch (u) {
                                if (u.toString().indexOf("NS_ERROR_ILLEGAL_VALUE") >=
                                    0) {
                                    i.collapse(1);
                                    o.setEnd(i.endContainer.$, i.endOffset)
                                } else throw u;
        ...
        if (!b) {
            ...
            this.on("selectionChange", function (a) {
                for (var d = 0; d < b.length; d++) {
                    var e = b[d], h = e.style.checkActive(a.data.path) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
                    e.fn.call(this, h)
                }
            })
        }
    ...
    (function () {
        ...
        function e(b) {
            ...
            if (b.collapsed) {
                ...
                var f = this.element, g = this._.definition, i, h = g.ignoreReadonly, j = h || g.includeReadonly;
                ...
                b.trim();
                var l = b.createBookmark(), n = l.startNode, m = l.endNode, o = n, r;
                if (!h) {
                    var p = b.getCommonAncestor(), h = a(n, p), p = a(m, p);
                    h && (o = h.getNextSourceNode(true));
                    p && (m = p)
                }
                for (o.getPosition(m) == CKEDITOR.POSITION_FOLLOWING && (o = 0); o;) {
                    ...
                    if (o.equals(m)) {
                        ...
                        var q = o.type == CKEDITOR.NODE_ELEMENT ? o.getName() : null, p = q && o.getAttribute("contentEditable") == "false", s = q && o.getAttribute("data-nostyle");
                        if (q && o.data("cke-bookmark")) {
                            o =
                                o.getNextSourceNode(true);
                            continue
                        }
                        if (p && j && CKEDITOR.dtd.$block[q])for (var t = o, w = c(t), z = void 0, C = w.length, H = 0, t = C && new CKEDITOR.dom.range(t.getDocument()); H < C; ++H) {
                            var z = w[H], J = CKEDITOR.filter.instances[z.data("cke-filter")];
                            if (J ? J.check(this) : 1) {
                                t.selectNodeContents(z);
                                e.call(this, t)
                            }
                        }
                        w = q ? !k[q] || s ? 0 : p && !j ? 0 : (o.getPosition(m) | O) == O && (!g.childRule || g.childRule(o)) : 1;
                        if (w)if ((w = o.getParent()) && ((w.getDtd() || CKEDITOR.dtd.span)[f] || i) && (!g.parentRule || g.parentRule(w))) {
                            if (!r && (!q || !CKEDITOR.dtd.$removeEmpty[q] ||
                                (o.getPosition(m) | O) == O)) {
                                r = b.clone();
                                r.setStartBefore(o)
                            }
                            q = o.type;
                            if (q == CKEDITOR.NODE_TEXT || p || q == CKEDITOR.NODE_ELEMENT && !o.getChildCount()) {
                                for (var q = o, Y; (h = !q.getNext(K)) && (Y = q.getParent(), k[Y.getName()]) && (Y.getPosition(n) | I) == I && (!g.childRule || g.childRule(Y));)q = Y;
                                r.setEndAfter(q)
                            }
                        } else h = true; else h = true;
                        o = o.getNextSourceNode(s || p)
                    }
                    if (h && r && !r.collapsed) {
                        for (var h = y(this, d), p = h.hasAttributes(), s = r.getCommonAncestor(), q = {}, w = {}, z = {}, C = {}, U, R, $; h && s;) {
                            if (s.getName() == f) {
                                for (U in g.attributes)if (!C[U] &&
                                    ($ = s.getAttribute(R)))h.getAttribute(U) == $ ? w[U] = 1 : C[U] = 1;
                                for (R in g.styles)if (!z[R] && ($ = s.getStyle(R)))h.getStyle(R) == $ ? q[R] = 1 : z[R] = 1
                            }
                            s = s.getParent()
                        }
                        for (U in w)h.removeAttribute(U);
                        for (R in q)h.removeStyle(R);
                        p && !h.hasAttributes() && (h = null);
                        if (h) {
                            r.extractContents().appendTo(h);
                            r.insertNode(h);
                            u.call(this, h);
                            h.mergeSiblings();
        ...
        function b(a) {
            function b() {
                for (var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(l.getParent()), e = null, f = null, g = 0; g < a.elements.length; g++) {
                    var h = a.elements[g];
                    if (h == a.block || h == a.blockLimit)break;
                    n.checkElementRemovable(h) && (e = h)
                }
                for (g = 0; g < c.elements.length; g++) {
                    h = c.elements[g];
                    if (h == c.block || h == c.blockLimit)break;
                    n.checkElementRemovable(h) && (f = h)
                }
                f && l.breakParent(f);
                e && d.breakParent(e)
            }
            ...
            if (a.collapsed) {
                for (var e = new CKEDITOR.dom.elementPath(d.getParent(), a.root), g, h = 0, i; h < e.elements.length && (i = e.elements[h]); h++) {
                    ...
                    if (this.checkElementRemovable(i)) {
                        ...
                        if (a.collapsed && (a.checkBoundaryOfElement(i, CKEDITOR.END) || (j = a.checkBoundaryOfElement(i, CKEDITOR.START)))) {
                            ...
                            i.mergeSiblings();
                            i.is(this.element) ? o.call(this, i) : f(i, k(this)[i.getName()])
                        }
                    }
                }
                if (g) {
                    ...
                    for (h = 0; ; h++) {
                        j = e.elements[h];
                        if (j.equals(g))break; else if (j.match)continue; else j = j.clone();
                        j.append(i);
                        i = j
                    }
                    i[g.match == "start" ? "insertBefore" : "insertAfter"](g)
                }
            } else {
                var l = c.endNode, n = this;
                b();
                for (e = d; !e.equals(l);) {
                    g = e.getNextSourceNode();
                    if (e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e)) {
                        e.getName() == this.element ? o.call(this, e) : f(e, k(this)[e.getName()]);
        ...
        function d(a) {
            ...
            (a = (new CKEDITOR.dom.elementPath(b, a.root)).contains(this.element, 1)) && !a.isReadOnly() && l(a, this)
        }
        ...
        function j(a, b) {
            ...
            if (d && !e) {
                ...
                b = e
            } else f ? b = r(c ? [a.getHtml()] : i(a), b) : a.moveChildren(b);
            b.replace(a);
            if (d) {
                var c = b, h;
        ...
        function o(a, b) {
            var c = this._.definition,
                d = c.attributes, c = c.styles, e = k(this)[a.getName()], g = CKEDITOR.tools.isEmpty(d) && CKEDITOR.tools.isEmpty(c), h;
            for (h in d)if (!((h == "class" || this._.definition.fullMatch) && a.getAttribute(h) != q(h, d[h])) && !(b && h.slice(0, 5) == "data-")) {
                g = a.hasAttribute(h);
                a.removeAttribute(h)
            }
            for (var i in c)if (!(this._.definition.fullMatch && a.getStyle(i) != q(i, c[i], true))) {
                g = g || !!a.getStyle(i);
                a.removeStyle(i)
            }
            f(a, e, t[a.getName()]);
            g && (this._.definition.alwaysRemoveElement ? s(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode ==
                CKEDITOR.ENTER_BR && !a.hasAttributes() ? s(a) : a.renameNode(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div"))
        }
        ...
        function s(a, b) {
            if (!a.hasAttributes() || b)if (CKEDITOR.dtd.$block[a.getName()]) {
                var c = a.getPrevious(C), d = a.getNext(C);
        ...
        function p(a, b) {
            for (var c in a)a[c] = a[c].replace(w, function (a, c) {
                return b[c]
            })
        }
        ...
        var t = {address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1}, J = {a: 1,
            embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1}, H = /\s*(?:;\s*|$)/, w = /#\((.+?)\)/g, K = CKEDITOR.dom.walker.bookmark(0, 1), C = CKEDITOR.dom.walker.whitespaces(1);
        CKEDITOR.style = function (a, b) {
            ...
            c = this.element = a.element ? typeof a.element == "string" ? a.element.toLowerCase() :
                a.element : "*";
            this.type = a.type || (t[c] ? CKEDITOR.STYLE_BLOCK : J[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE);
            if (typeof this.element == "object")this.type = CKEDITOR.STYLE_OBJECT;
            this._ = {definition: a}
        };
        CKEDITOR.editor.prototype.applyStyle = function (a) {
            a.checkApplicable(this.elementPath()) && z.call(a, this.getSelection())
        };
        CKEDITOR.editor.prototype.removeStyle = function (a) {
            a.checkApplicable(this.elementPath()) && z.call(a, this.getSelection(), 1)
        };
        CKEDITOR.style.prototype = {apply: function (a) {
            ...
            remove: function (a) {
                ...
                return(this.applyToRange = this.type == CKEDITOR.STYLE_INLINE ? e : this.type == CKEDITOR.STYLE_BLOCK ? h : this.type == CKEDITOR.STYLE_OBJECT ? d : null).call(this, a)
            }, removeFromRange: function (a) {
                return(this.removeFromRange = this.type == CKEDITOR.STYLE_INLINE ? b : this.type == CKEDITOR.STYLE_BLOCK ? m : this.type == CKEDITOR.STYLE_OBJECT ? g : null).call(this, a)
        ...
        CKEDITOR.style.getStyleText = function (a) {
            ...
            for (var e in b) {
                var f = b[e], g = (e + ":" + f).replace(H, ";");
                f == "inherit" ? d = d + g : c = c + g
            }
            c.length && (c = CKEDITOR.tools.normalizeCssText(c, true));
            return a._ST = c + d
        };
        var O = CKEDITOR.POSITION_PRECEDING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED, I = CKEDITOR.POSITION_FOLLOWING | CKEDITOR.POSITION_IDENTICAL | CKEDITOR.POSITION_IS_CONTAINED
    })();
    ...
    (function () {
        ...
        CKEDITOR.dom.elementPath = function (b, d) {
            var g = null, h = null, m = [], j = b, i, d = d || b.getDocument().getBody();
            do if (j.type == CKEDITOR.NODE_ELEMENT) {
                ...
                if (!h) {
                    i = j.getName();
                    j.getAttribute("contenteditable") == "true" ? h = j : !g && e[i] && (g = j);
                    if (a[i]) {
                        var n;
                        if (n = !g) {
                            if (i = i == "div") {
    ...
    CKEDITOR.dom.elementPath.prototype = {compare: function (a) {
        ...
        var d = this.elements, g = d.length;
        e && g--;
        if (b) {
            d = Array.prototype.slice.call(d, 0);
            d.reverse()
        }
        for (e = 0; e < g; e++)if (c(d[e]))return d[e];
        return null
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {type: CKEDITOR.NODE_TEXT, getLength: function () {
        ...
        var e = this.$.parentNode, b = e.childNodes.length, c = this.getLength(), d = this.getDocument(), g = new CKEDITOR.dom.text(this.$.splitText(a), d);
    ...
    (function () {
        function a(a, c, d) {
            var e = a.serializable, h = c[d ? "endContainer" : "startContainer"], m = d ? "endOffset" : "startOffset", j = e ? c.document.getById(a.startNode) : a.startNode, a = e ? c.document.getById(a.endNode) : a.endNode;
            ...
            h.equals(j.getParent()) && c[m]++;
            h.equals(a.getParent()) && c[m]++;
        ...
        var e = {createIterator: function () {
            ...
            return{getNextRange: function (h) {
                ...
                var m = a[e];
                if (m && a.length > 1) {
                    if (!e)for (var j = a.length - 1; j >= 0; j--)d.unshift(a[j].createBookmark(true));
                    if (h)for (var i = 0; a[e + i + 1];) {
                        for (var n = m.document, h = 0, j = n.getById(d[i].endNode), n = n.getById(d[i +
                            1].startNode); ;) {
                            j = j.getNextSourceNode(false);
                            if (n.equals(j))h = 1; else if (c(j) || j.type == CKEDITOR.NODE_ELEMENT && j.isBlockBoundary())continue;
                            break
                        }
                        if (!h)break;
                        i++
                    }
                    for (m.moveToBookmark(d.shift()); i--;) {
                        j = a[++e];
                        j.moveToBookmark(d.shift());
                        m.setEnd(j.endContainer, j.endOffset)
                    }
                }
                return m
            }}
    ...
    (function () {
        ...
        var h = "cke_ui_color", m = [], j = /\$color/g;
    ...
    (function () {
        function w(b) {
            ...
            function k(a, d) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    if (CKEDITOR.env.webkit || CKEDITOR.env.gecko)h = i.once("blur", k, null, null, -100);
                    f &&
                    j.focus();
                    ...
                    setTimeout(function () {
                        ...
                        j.remove();
                        var a;
                        if (CKEDITOR.env.webkit && (a = j.getFirst()) && a.is && a.hasClass("Apple-style-span"))j =
                            a;
            ...
            function p(a) {
                if ("wysiwyg" == b.mode)switch (a.data.keyCode) {
                    ...
                    case CKEDITOR.SHIFT + 45:
                        ...
                        (CKEDITOR.env.opera ||
                            CKEDITOR.env.gecko && 10900 > CKEDITOR.env.version) && a.fire("paste");
                        break;
        ...
        function z() {
            var b = new CKEDITOR.htmlParser.filter, a = {blockquote: 1, dl: 1, fieldset: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ol: 1, p: 1, table: 1, ul: 1}, c = CKEDITOR.tools.extend({br: 0}, CKEDITOR.dtd.$inline),
                d = {p: 1, br: 1, "cke:br": 1}, f = CKEDITOR.dtd, h = CKEDITOR.tools.extend({area: 1, basefont: 1, embed: 1, iframe: 1, map: 1, object: 1, param: 1}, CKEDITOR.dtd.$nonBodyContent, CKEDITOR.dtd.$cdata), l = function (a) {
                    delete a.name;
    ...
    (function () {
        ...
        CKEDITOR.ui.button.prototype = {render: function (a, b) {
            ...
            return b ? (b.setState(a, "cke_button"), a == CKEDITOR.TRISTATE_DISABLED ? b.setAttribute("aria-disabled",
                !0) : b.removeAttribute("aria-disabled"), this.hasArrow ? (a = a == CKEDITOR.TRISTATE_ON ? this._.editor.lang.button.selectedLabel.replace(/%1/g, this.label) : this.label, CKEDITOR.document.getById(this._.id + "_label").setText(a)) : a == CKEDITOR.TRISTATE_ON ? b.setAttribute("aria-pressed", !0) : b.removeAttribute("aria-pressed"), !0) : !1
        }, getState: function () {
            return this._.state
    ...
    CKEDITOR.plugins.add("link", {requires: "dialog,fakeobjects", onLoad: function () {
        ...
        CKEDITOR.dialog.isTabEnabled(b,
            "link", "target") && (a = a.replace("]", ",target,onclick]"));
