...
(function () {
    ...
    a.buildOptionLang = function (b, c) {
        ...
        if (0 === d.options.length) {
            ...
            e.sort();
            for (var k = 0; k < e.length; k++)g = document.createElement("option"), g.setAttribute("value", e[k][1]), h = document.createTextNode(e[k][0]),
    ...
    var q = function (a) {
        ...
        if ("no_any_suggestions" == b) {
            ...
            c("ChangeTo");
            c("ChangeAll")
        } else a.LocalizationButton.ChangeTo.instance.enable(),
        ...
        for (b = 0; b < d.length; b++)p.add(d[b], d[b]);
        l();
        ...
        for (var b = b.grammSuggest, c = b.length, d = !0, f = 0; f < c; f++)a.grammerSuggest.getElement().append(z(b[f],
            b[f], d)), d = !1;
        l();
        a.div_overlay.setDisable()
        ...
        a = a || window.event;
        if ((a = window.JSON.parse(a.data)) && a.id)B[a.id](a)
    }, t = function (b, c, d, f) {
