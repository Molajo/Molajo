...
/**
* @package		Construct Template Framework + Blankslate template for Molajo
* @author		Matt Thomas | Joomla Engineering http://joomlaengineering.com + Template Design: Cristina Solana | Nightshift Creative
* @copyright	Copyright (C) 2010 Construct Template Framework: Matt Thomas + Template Design: Cristina Solana. All rights reserved.
...
<a id="page-top" name="page-top"></a>
			...
			<div id="access-wrapper" class="clearfix">
				<div id="access-container" class="clearfix">
	...
	<div id="footer-push">
		...
		<div id="header" class="clear clearfix">
			...
			<div class="gutter clearfix">
				...
				<h1 id="logo"><a href="<?php echo $this->baseurl ?>/" title="<?php echo $app->getCfg('sitename');?>"><jdoc:include type="modules" name="logo" style="raw" /></a></h1>
