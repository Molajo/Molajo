...
?>
<form action="<?php echo MolajoRouteHelper::_('index.php?option=' . $this->request['option'] . '&view=' . $this->state->get('request.view') . $function); ?>"
      method="post" name="adminForm" id="adminForm">
    <fieldset class="filter clearfix">
        <div class="left">
            <label for="filter_search">
                <?php echo MolajoTextHelper::_('JSearch_Filter_Label'); ?>
            </label>
            <input type="text" name="filter_search" id="filter_search"
                   value="<?php echo $this->escape($this->queryState->get('filter.search')); ?>" size="30"
                   title="<?php echo MolajoTextHelper::_('MOLAJO_FILTER_SEARCH_DESC'); ?>"/>

            <button type="submit">
                <?php echo MolajoTextHelper::_('JSEARCH_FILTER_SUBMIT'); ?></button>
            <button type="button" onclick="document.id('filter_search').value='';this.form.submit();">
                <?php echo MolajoTextHelper::_('JSEARCH_FILTER_CLEAR'); ?></button>
        </div>

        <div class="right">
            <select name="filter_published" class="inputbox" onchange="this.form.submit()">
                <option value=""><?php echo MolajoTextHelper::_('JOPTION_SELECT_PUBLISHED');?></option>
            ...
            <select name="filter_category_id" class="inputbox" onchange="this.form.submit()">
                <option value=""><?php echo MolajoTextHelper::_('JOPTION_SELECT_CATEGORY');?></option>
                <?php echo MolajoHTML::_('select.options', MolajoHTML::_('category.options', 'articles'), 'value', 'text', $this->queryState->get('filter.category_id'));?>
            </select>
    ...
    <table class="adminlist">
        ...
        <tr class="row<?php echo $i % 2; ?>">
            ...
            <td class="center nowrap">
                <?php echo MolajoHTML::_('date', $item->created, MolajoTextHelper::_('DATE_FORMAT_LC4')); ?>
            </td>
            <td class="center">
