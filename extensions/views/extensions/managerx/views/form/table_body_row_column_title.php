...
<td>
    ...
    <a href="<?php echo MolajoRouteHelper::_('index.php?option=' . $this->request['option'] . '&task=edit&id=' . $this->row->id);?>">
    ...
    <p class="smallsub"><?php echo MolajoTextHelper::sprintf('JGLOBAL_LIST_ALIAS', $this->escape($this->row->alias));?></p>
    <?php endif; ?>
</td>