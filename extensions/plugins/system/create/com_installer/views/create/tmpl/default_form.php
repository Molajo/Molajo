...
<form enctype="multipart/form-data" action="<?php echo MolajoRouteHelper::_('index.php?option=com_installer&view=create');?>" method="post" name="adminForm" id="adminForm">
