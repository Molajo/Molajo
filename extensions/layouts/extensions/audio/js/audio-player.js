/*
 @package     Molajo
 @subpackage  SWFObject v2.2 <http://code.google.com/p/swfobject/>
 @copyright   Copyright (c) 2010 Martin Laine. All rights reserved.
        ...
        if (m.win && m.ie) {
            ...
            if (y) {
                ...
                if (AC) {
                    var x = AC.length;
                    for (var z = 0; z < x; z++) {
                        if (!(AC[z].nodeType == 1 && AC[z].nodeName == "PARAM") && !(AC[z].nodeType == 8)) {
                            AA.appendChild(AC[z].cloneNode(true))
                        }
                    }
                }
            }
...
var AudioPlayer = function() {
    ...
    return{setup:function(J, I) {
        F = J;
        A = I;
        if (audioplayer_swfobject.hasFlashPlayerVersion(G)) {
        ...
        O.playerID = I;
        audioplayer_swfobject.embedSWF(F, I, N.width.toString(), "24", G, false, O, J, M);
        H.push(I)
