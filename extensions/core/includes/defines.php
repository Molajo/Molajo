...
if (defined('PLATFORM_MOLAJO_MVC')) {
} else {
    define('PLATFORM_MOLAJO_MVC', PLATFORM_MOLAJO . '/mvc');
}
...
if (defined('MOLAJO_APPLICATIONS_CORE_DATA_ENTITIES')) {
    ...
    define('MOLAJO_APPLICATIONS_CORE_DATA_ENTITIES', MOLAJO_APPLICATIONS_CORE . '/data');
}
...
define('MOLAJO_EXTENSION_OPTION_ID_FORMATS', 2000);
define('MOLAJO_EXTENSION_OPTION_ID_FORMATS_DEFAULT', 2100);

define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_STATIC', 3010);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_STATIC_DEFAULT', 3020);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_STATIC_WRAP', 3030);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_STATIC_WRAP_DEFAULT', 3040);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_STATIC_PAGE', 3050);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_STATIC_PAGE_DEFAULT', 3060);

define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_ITEM', 3110);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_ITEM_DEFAULT', 3120);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_ITEM_WRAP', 3130);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_ITEM_WRAP_DEFAULT', 3140);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_ITEM_PAGE', 3150);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_ITEM_PAGE_DEFAULT', 3160);

define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_ITEMS', 3210);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_ITEMS_DEFAULT', 3220);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_ITEMS_WRAP', 3230);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_ITEMS_WRAP_DEFAULT', 3240);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_ITEMS_PAGE', 3250);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_ITEMS_PAGE_DEFAULT', 3260);

define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_EDIT', 3310);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_EDIT_DEFAULT', 3320);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_EDIT_WRAP', 3330);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_EDIT_WRAP_DEFAULT', 3340);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_EDIT_PAGE', 3350);
define('MOLAJO_EXTENSION_OPTION_ID_VIEWS_EDIT_PAGE_DEFAULT', 3360);
