...
class MolajoRendererHead extends MolajoRenderer
{
    ...
    {
        $this->request->set('view', MolajoController::getApplication()->get('head_view_id', 'head'));
        $this->request->set('wrap', MolajoController::getApplication()->get('head_wrap_id', 'none'));
