...
class MolajoRendererHead extends MolajoRenderer
{
    ...
    {
        $this->mvc->set('view', MolajoController::getApplication()->get('head_view_id', 'head'));
        $this->mvc->set('wrap', MolajoController::getApplication()->get('head_wrap_id', 'none'));
        ...
        /** Model */
        $this->mvc->set('model', 'MolajoModelHead');
