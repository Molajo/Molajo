...
class MolajoMenuRenderer
{
    ...
    {
        $this->_request->set('view', MolajoController::getApplication()->get('menu_view_id', 'menu'));
        $this->_request->set('wrap', MolajoController::getApplication()->get('menu_wrap_id', 'none'));
        ...
        /** Model */
        $this->_request->set('model', 'MolajoModelMenu');
