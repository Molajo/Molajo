...
class MolajoRendererDefer extends MolajoRenderer
{
    ...
    {
        $this->mvc->set('view', MolajoController::getApplication()->get('defer_view_id', 'defer'));
        $this->mvc->set('wrap', MolajoController::getApplication()->get('defer_wrap_id', 'none'));
        ...
        /** Model */
        $this->mvc->set('model', 'MolajoModelDefer');
