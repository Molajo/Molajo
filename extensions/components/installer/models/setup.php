...
class MolajoInstallationModelSetup extends JModel
{
    ...
    public function storeOptions($options)
    {
        ...
        if (!empty($options['language'])) {
            ...
            MolajoController::getLanguage()->setLanguage($options['language']);
        }
    ...
    public function getPhpOptions()
    {
        ...
        $option = new stdClass;
        $option->label = MolajoTextHelper::_('INSTL_PHP_VERSION') . ' >= 5.2.4';
        ...
        $option = new stdClass;
        $option->label = MolajoTextHelper::_('INSTL_ZLIB_COMPRESSION_SUPPORT');
        ...
        $option = new stdClass;
        $option->label = MolajoTextHelper::_('INSTL_XML_SUPPORT');
        ...
        $option = new stdClass;
        $option->label = MolajoTextHelper::_('INSTL_MYSQL_SUPPORT');
        ...
        if (extension_loaded('mbstring')) {
            ...
            $option = new stdClass;
            $option->label = MolajoTextHelper::_('INSTL_MB_LANGUAGE_IS_DEFAULT');
            $option->state = (strtolower(ini_get('mbstring.language')) == 'neutral');
            $option->notice = ($option->state) ? null : MolajoTextHelper::_('INSTL_NOTICEMBLANGNOTDEFAULT');
            $options[] = $option;

            // Check for MB function overload.
            $option = new stdClass;
            $option->label = MolajoTextHelper::_('INSTL_MB_STRING_OVERLOAD_OFF');
            $option->state = (ini_get('mbstring.func_overload') == 0);
            $option->notice = ($option->state) ? null : MolajoTextHelper::_('INSTL_NOTICEMBSTRINGOVERLOAD');
            $options[] = $option;
        }

        // Check for a missing native parse_ini_file implementation
        $option = new stdClass;
        $option->label = MolajoTextHelper::_('INSTL_PARSE_INI_FILE_AVAILABLE');
        ...
        $option = new stdClass;
        $option->label = MolajoTextHelper::_('INSTL_JSON_SUPPORT_AVAILABLE');
        ...
        $option = new stdClass;
        $option->label = 'configuration.php ' . MolajoTextHelper::_('INSTL_WRITABLE');
        $option->state = (is_writable('../configuration.php') || (!file_exists('../configuration.php') && is_writable('../')));
        $option->notice = ($option->state) ? null : MolajoTextHelper::_('INSTL_NOTICEYOUCANSTILLINSTALL');
        $options[] = $option;
    ...
    public function getPhpSettings()
    {
        ...
        $setting->label = MolajoTextHelper::_('INSTL_SAFE_MODE');
        ...
        $setting = new stdClass;
        $setting->label = MolajoTextHelper::_('INSTL_DISPLAY_ERRORS');
        ...
        $setting = new stdClass;
        $setting->label = MolajoTextHelper::_('INSTL_FILE_UPLOADS');
        ...
        $setting = new stdClass;
        $setting->label = MolajoTextHelper::_('INSTL_MAGIC_QUOTES_RUNTIME');
        ...
        $setting = new stdClass;
        $setting->label = MolajoTextHelper::_('INSTL_REGISTER_GLOBALS');
        ...
        $setting = new stdClass;
        $setting->label = MolajoTextHelper::_('INSTL_OUTPUT_BUFFERING');
        ...
        $setting = new stdClass;
        $setting->label = MolajoTextHelper::_('INSTL_SESSION_AUTO_START');
