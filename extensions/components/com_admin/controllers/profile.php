	...
	public function save($key = null, $urlVar = null)
	{
		...
		if (isset($data['password']) && isset($data['password2'])) {
			...
			if ($data['password'] != $data['password2']) {
				...
				$this->setRedirect(MolajoRouteHelper::_('index.php?option=com_admin&view=profile&layout=edit&id='.MolajoFactory::getUser()->id, false));
				return false;
			}
		...
		if ($this->getTask() != 'apply') {
			...
			$this->setRedirect(MolajoRouteHelper::_('index.php', false));
		}
