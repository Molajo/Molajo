...
?>
<form action="<?php echo MolajoRouteHelper::_('index.php?option=com_modules&view=positions&layout=modal&layout=component&function='.$function.'&application_id=' .$application_id);?>" method="post" name="adminForm" id="adminForm">
