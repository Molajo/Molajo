...
class MenusControllerMenu extends JControllerForm
{
	...
	{
		$this->setRedirect(MolajoRouteHelper::_('index.php?option=com_menus&view=menus', false));
	}
	...
	public function save($key = null, $urlVar = null)
	{
		...
		if (isset($data['application_id']) && $data['application_id'] == 1){
			...
			$this->setRedirect(MolajoRouteHelper::_('index.php?option=com_menus&view=menu&layout=edit', false));
		...
		switch ($task)
		{
			case 'apply':
				...
				// Redirect back to the edit screen.
				$this->setRedirect(MolajoRouteHelper::_('index.php?option=com_menus&view=menu&layout=edit'.$this->getRedirectToItemAppend($recordId), false));
				break;
