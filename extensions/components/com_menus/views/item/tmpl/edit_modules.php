	...
	<table class="adminlist">
		...
		<?php foreach ($this->modules as $i => &$module) : ?>
			<tr class="row<?php echo $i % 2;?>">
				<td>
					<?php $link = 'index.php?option=com_modules&amp;application_id=0&amp;task=module.edit&amp;id='. $module->id.'&amp;layout=component&amp;view=module&amp;layout=modal' ; ?>
				...
				<td class="center">
					<?php if (is_null($module->menu_item_id)) : ?>
						<?php if ($module->except):?>
							<?php echo MolajoText::_('JYES'); ?>
						<?php else : ?>
							<?php echo MolajoText::_('JNO'); ?>
						<?php endif;?>
					<?php elseif ($module->menu_item_id > 0) : ?>
						<?php echo MolajoText::_('JYES'); ?>
					<?php elseif ($module->menu_item_id < 0) : ?>
						<?php echo MolajoText::_('JNO'); ?>
					<?php else : ?>
						<?php echo MolajoText::_('JALL'); ?>
					<?php endif; ?>
				</td>
			</tr>
		<?php endforeach; ?>
