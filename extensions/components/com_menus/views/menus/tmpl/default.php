			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<ul>
					...
					if (isset($this->modules[$item->menu_id])) :
						...
						<li>
							<?php if ($canEdit) : ?>
								<a class="modal" href="<?php echo MolajoRoute::_('index.php?option=com_modules&task=module.edit&id='.$module->id.'&return='.$return.'&tmpl=component&layout=modal');?>" rel="{handler: 'iframe', size: {x: 1024, y: 450}}"  title="<?php echo MolajoText::_('MENU_EDIT_MODULE_SETTINGS');?>">
