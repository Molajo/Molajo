...
class TemplatesControllerSource extends JController
{
	...
	{
		$this->setRedirect(MolajoRouteHelper::_('index.php?option=com_templates&view=templates', false));
	}
	...
	public function cancel()
	{
		...
		$app->setUserState($context.'.data',	null);
		$this->setRedirect(MolajoRouteHelper::_('index.php?option=com_templates&view=template&id='.$returnId, false));
	}
	...
	public function save()
	{
		...
		if ($data === false)
		{
			...
			$this->setRedirect(MolajoRouteHelper::_('index.php?option=com_templates&view=source&layout=edit', false));
			return false;
		}
		...
		switch ($task)
		{
			...
			default:
				...
				$this->setRedirect(MolajoRouteHelper::_('index.php?option=com_templates&view=template&id='.$model->getState('extension.id'), false));
				break;
		}
	}
}
