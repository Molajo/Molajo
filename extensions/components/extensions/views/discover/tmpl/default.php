...
?>
<form action="<?php echo MolajoRouteHelper::_('index.php?option=installer&view=discover');?>" method="post"
    ...
    <table class="adminlist">
        ...
        <tr>
            ...
            <th width="10%" class="center"><?php echo MolajoTextHelper::_('JDATE'); ?></th>
            ...
            <th width="15%" class="center"><?php echo MolajoTextHelper::_('JAUTHOR'); ?></th>
        ...
        <tr class="row<?php echo $i % 2;?>">
            ...
            <td><span class="bold hasTip"
                      title="<?php echo htmlspecialchars($item->name . '::' . $item->description); ?>"><?php echo $item->name; ?></span>
            </td>
            <td class="center"><?php echo MolajoTextHelper::_('INSTALLER_TYPE_' . $item->type); ?></td>
    ...
    <?php echo MolajoTextHelper::_('INSTALLER_MSG_DISCOVER_DESCRIPTION'); ?>
    <?php else : ?>
    <p>
        <?php echo MolajoTextHelper::_('INSTALLER_MSG_DISCOVER_DESCRIPTION'); ?>
    </p>
    <p>
        <?php echo MolajoTextHelper::_('INSTALLER_MSG_DISCOVER_NOEXTENSION'); ?>
    </p>
    <?php endif; ?>
