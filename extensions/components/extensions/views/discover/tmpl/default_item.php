...
<tr class="<?php echo "row" . $this->item->index % 2; ?>" <?php echo $this->item->style; ?>>
    ...
    <td>
        <input type="checkbox" id="cb<?php echo $this->item->index;?>" name="eid[]"
               value="<?php echo $this->item->extension_id; ?>"
               onclick="isChecked(this.checked);" <?php echo $this->item->cbd; ?> />
    ...
    <td>
		<span class="editlinktip hasTip"
              title="<?php echo addslashes(htmlspecialchars(MolajoTextHelper::_('INSTALLER_AUTHOR_INFORMATION') . '::' . $this->item->author_info)); ?>">
