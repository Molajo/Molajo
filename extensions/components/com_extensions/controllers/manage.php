...
class InstallerControllerManage extends JController
{
	...
	public function publish()
	{
		...
		if (empty($ids)) {
			MolajoError::raiseWarning(500, MolajoText::_('COM_INSTALLER_ERROR_NO_EXTENSIONS_SELECTED'));
		} else {
			// Get the model.
		...
		$this->setRedirect(MolajoRouteHelper::_('index.php?option=com_installer&view=manage',false));
	}
