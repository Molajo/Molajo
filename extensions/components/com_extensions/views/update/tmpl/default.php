...
?>
<form action="<?php echo MolajoRouteHelper::_('index.php?option=com_installer&view=update');?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist" cellspacing="1">
		<thead>
			<tr>
				...
				<th class="nowrap"><?php echo MolajoHTML::_('grid.sort', 'COM_INSTALLER_HEADING_INSTALLTYPE', 'extension_id', $listDirn, $listOrder); ?></th>
				<th ><?php echo MolajoHTML::_('grid.sort', 'COM_INSTALLER_HEADING_TYPE', 'type', $listDirn, $listOrder); ?></th>
