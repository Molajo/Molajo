	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th class="nowrap">
					<?php echo MolajoHTML::_('grid.sort', 'COM_INSTALLER_HEADING_NAME', 'name', $listDirn, $listOrder); ?>
				</th>
				<th>
					<?php echo MolajoHTML::_('grid.sort', 'COM_INSTALLER_HEADING_LOCATION', 'application_id', $listDirn, $listOrder); ?>
				</th>
				<th width="10%" class="center">
					<?php echo MolajoHTML::_('grid.sort', 'JSTATUS', 'enabled', $listDirn, $listOrder); ?>
				</th>
				<th>
					<?php echo MolajoHTML::_('grid.sort', 'COM_INSTALLER_HEADING_TYPE', 'type', $listDirn, $listOrder); ?>
				</th>
				<th width="10%" class="center">
				...
				<th>
					<?php echo MolajoHTML::_('grid.sort', 'COM_INSTALLER_HEADING_FOLDER', 'folder', $listDirn, $listOrder); ?>
				</th>
				<th width="10">
					<?php echo MolajoHTML::_('grid.sort', 'COM_INSTALLER_HEADING_ID', 'extension_id', $listDirn, $listOrder); ?>
				</th>
			</tr>
		</thead>
		<tfoot>
