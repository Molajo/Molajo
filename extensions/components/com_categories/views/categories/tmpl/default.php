...
?>
<form action="<?php echo MolajoRoute::_('index.php?option=com_categories&view=categories');?>" method="post" name="adminForm" id="adminForm">
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td>
						...
						<?php if ($canEdit || $canEditOwn) : ?>
							<a href="<?php echo MolajoRoute::_('index.php?option=com_categories&task=category.edit&id='.$item->id.'&extension='.$extension);?>">
