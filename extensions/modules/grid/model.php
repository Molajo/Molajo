 ...
 * @since       1.0
 */
class GridModuleModelDisplay extends MolajoModelDisplay
{
    /**
     * __construct
     *
    ...
    public function getItems()
    {
        ...
        /** footer line 1 */
        if (JString::strpos(MolajoTextHelper :: _('GRID_LINE1'), '%date%')) {
            $line1 = str_replace('%date%', MolajoController::getDate()->format('Y'), MolajoTextHelper :: _('GRID_LINE1'));
        } else {
            $line1 = MolajoTextHelper :: _('GRID_LINE1');
        }
