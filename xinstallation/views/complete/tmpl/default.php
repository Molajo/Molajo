...
<div id="step">
	...
	<span class="steptitle"><?php echo MolajoText::_('INSTL_COMPLETE'); ?></span>
</div>

<form action="index.php" method="post" id="adminForm" class="form-validate">
	<div id="installer">
		<div class="m">
			<h2><?php echo MolajoText::_('INSTL_COMPLETE_TITLE'); ?></h2>
			<div class="install-text">
				<p><?php echo MolajoText::_('INSTL_COMPLETE_DESC1'); ?></p>
				<p><?php echo MolajoText::_('INSTL_COMPLETE_DESC2'); ?></p>
				<p><?php echo MolajoText::_('INSTL_COMPLETE_DESC3'); ?></p>
			</div>
			<div class="install-body">
				<div class="m">
					<fieldset>
								...
								<p class="error">
									<?php echo MolajoText::_('INSTL_COMPLETE_REMOVE_INSTALLATION'); ?>
								</p>
							
							<input class="button white" type="button" name="instDefault"
                                           value="<?php echo MolajoText::_('INSTL_COMPLETE_REMOVE_FOLDER'); ?>"
							...
							<p>
									...
									<h3>
									<?php echo MolajoText::_('INSTL_COMPLETE_ADMINISTRATION_LOGIN_DETAILS'); ?>
									</h3>
								
							<dl>
								<dt class="notice">
									<?php echo MolajoText::_('JUSERNAME'); ?> : </dt>
							...
							<?php if ($this->config) : ?>
							<p>
								<?php echo MolajoText::_('INSTL_CONFPROBLEM'); ?>
							</p>
