...
if (class_exists('MolajoFileHelper')) {
    ...
    if (file_exists(COM_INSTALLER_OVERRIDES.'/helper/file.php')) {
        JLoader::register('MolajoFileHelper', COM_INSTALLER_OVERRIDES.'/helper/file.php');
    } else {
...
$filehelper->requireClassFile (COM_INSTALLER_OVERRIDES.'/controllers/controller.php', 'InstallerController');
...
/** Add new Model **/
$filehelper->requireClassFile (COM_INSTALLER_OVERRIDES.'/models/create.php', 'InstallerModelCreate');

/** Add new View **/
$filehelper->requireClassFile (COM_INSTALLER_OVERRIDES.'/views/create/view.html.php', 'InstallerViewCreate');
