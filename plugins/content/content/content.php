...
//        }
        ...
        if ($systemParams->def('enable_hidden_notes', 0) == 1) {
            ...
            MolajoContentNotes::driver ($context, &$content, &$params, $page = 0, $this->location);
        }
        /** add line breaks **/
        ...
        if (($systemParams->def('enable_blockquotes', 0) == 1) || ($systemParams->def('enable_pullquotes', 0) == 1)) {
            ...
            MolajoContentQuotes::driver ($context, &$content, &$params, $page = 0, $this->location);
        }
        /** syntax highlighter **/
        if ($systemParams->def('enable_syntax_highlighter', 0) == 1) {
            require_once dirname(__FILE__) . '/syntaxhighlighter/driver.php';
            MolajoContentSyntaxHighlighter::driver ($context, &$content, &$params, $page = 0, $this->location);
        }
        /** smilies functions **/
