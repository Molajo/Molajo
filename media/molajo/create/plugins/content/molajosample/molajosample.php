...
/**
 * DISPLAY METHOD - Events in order of occurrence --- include methods for form display too
 *
 ...
 * 6. onContentAfterSave - respond to save event
 * 7. onContentChangeState - handle change in state actions
 */    
	/**
