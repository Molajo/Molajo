...
class plgContentPagebreak extends JPlugin
{
    ...
    protected function _createTOC(&$row, &$matches, &$page)
    {
        ...
        <li>
            ...
            <a href="' . JRoute::_(ContentHelperRoute::getArticleRoute($row->alias, $row->catid) . '&showall=&limitstart=') . '" class="' . $class . '">'
            . $heading .
            '</a>
        ...
        foreach ($matches as $bot) {
            $link = JRoute::_(ContentHelperRoute::getArticleRoute($row->alias, $row->catid) . '&showall=&limitstart=' . ($i - 1));
        ...
        if ($this->params->get('showall')) {
            $link = JRoute::_(ContentHelperRoute::getArticleRoute($row->alias, $row->catid) . '&showall=1&limitstart=');
    ...
    protected function _createNavigation(&$row, $page, $n)
    {
        ...
        if ($page < $n - 1) {
            ...
            $link_next = JRoute::_(ContentHelperRoute::getArticleRoute($row->alias, $row->catid) . '&showall=&limitstart=' . ($page_next));
            // Next >>
        ...
        if ($page > 0) {
            ...
            $link_prev = JRoute::_(ContentHelperRoute::getArticleRoute($row->alias, $row->catid) . '&showall=&limitstart=' . ($page_prev));
            // << Prev
