...
<table class="responsive">
    <thead>
        <tr>
            ...
            <th width="1%">
                <?php echo Services::Language()->translate('Delete'); ?><input type="checkbox" class="checkall">
            </th>
        </tr>
    </thead>
    <tbody>
...
<?php } else { ?>
    <tr>
        ...
        <td><input id="<?php echo $this->row->id; ?>" value="<?php echo $this->row->value; ?>" type="checkbox"></td>
    </tr>
<?php }
