...
<?php echo $begin_conditional; ?>
	<link rel="stylesheet" href="<?php echo $this->row->url; ?>"<?php if ((int)$this->row->html5 == 0): ?>
		  type="<?php echo $this->row->mimetype; ?>"<?php endif; ?><?php if ($this->row->media != null): ?>
		  media="<?php echo $this->row->media; ?>"<?php endif; ?><?php if (trim($this->row->attributes) != ''): ?><?php echo $this->row->attributes; ?><?php endif; ?><?php echo $end; ?><?php echo $end_conditional;
