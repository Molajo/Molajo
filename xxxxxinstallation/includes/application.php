...
//echo MOLAJO_APPLICATION_PATH;
		define('JPATH_COMPONENT', MOLAJO_PATH_ROOT.'/installation/components/com_installer');
...
die;
        try
        {
            ...
            JRequest::setCmd('option', $component);
            ...
            switch($document->getType())
            {
                case 'html':
                    // Get language
                    $lang_code = MolajoFactory::getConfig()->get('language');
