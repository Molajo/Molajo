...
Class PageViewHelper
{
	...
	public function get($page_view_id = 0)
	{
		...
		$item = Helpers::Extension()->get($page_view_id, 'Page', $node);
		...
		Services::Registry()->set('Parameters', 'page_view_table_registry_name', $item->table_registry_name);
	...
	public function getPath($node)
	{
		...
		/** 3. View */
		if (file_exists(EXTENSIONS_VIEWS . '/Page/' . ucfirst(strtolower($node)) . '/Configuration.xml')) {
