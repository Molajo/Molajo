 ...
 */
namespace Molajo\Extension\Plugin\Admingrid;
 ...
 * @since       1.0
 */
class AdmingridPlugin extends ContentPlugin
{
    /**
     * Prepares data for the Administrator Grid  - run AdmingridPlugin after AdminmenuPlugin
     *
     * @return boolean
     * @since   1.0
     */
    public function onBeforeParse()
    {
        ...
        if (Services::Registry()->get('Configuration', 'profiler_output_queries_table_registry', 1) == 1) {
            ...
            $profiler_message = 'AdmingridPlugin Model Type ' . $this->get('model_type')
