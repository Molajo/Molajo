...
<article>
	<include:wrap name=Header wrap_class=blue value="<h2>The Title Goes Here</h2>" />

	<include:wrap name=Aside value="This is aside text lorem ipsum dolor sit amet consectetur adipisicing." />
	...
	<include:wrap name=Footer value="<h2>Posted August 22, 2011</h2>" />
</article>
