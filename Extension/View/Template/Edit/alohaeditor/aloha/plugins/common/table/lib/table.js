...
define([
    ...
    Table.prototype.activate = function () {
        ...
        htmlTableWrapper.get(0).ondragstart = function (e) {
            return false;
        };
        htmlTableWrapper.get(0).onmovestart = function (e) {
            return false;
        };
        htmlTableWrapper.get(0).onselectstart = function (e) {
            return false;
        };
        ...
        for (var i = 0; i < numColumns; i++) {
            ...
            if (i > 0) {
                ...
                var clickHandler = function (e) {
                    ...
                    // following exception:
                    //uncaught exception: [Exception... "Resource returned failure code: 0x80004005 (NS_ERROR_FAILURE) [nsIDOMHTMLInputElement.setSelectionRange]" nsresult: "0x80004005 (NS_ERROR_FAILURE)" location: "JS frame :: src/dep/ext-3.2.1/ext-all.js :: <TOP_LEVEL> :: line 11" data: no]
...
//			}
            ...
            var gridColumns = this.selection.selectedColumnIdxs.sort(function (a, b) {
                return b - a;
            });
    ...
    Table.prototype.addColumns = function (position) {
        ...
        selectedColumnIdxs.sort(function (a, b) {
            return a - b;
        });
