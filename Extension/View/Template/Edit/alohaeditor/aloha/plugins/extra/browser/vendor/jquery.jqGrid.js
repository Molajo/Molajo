define(['aloha/jquery'], function (jQuery) {
    ...
    (function (b) {
        ...
        b.extend(b.jgrid, {htmlDecode:function (f) {
            if (f && (f == "&nbsp;" || f == "&#160;" || f.length == 1 && f.charCodeAt(0) == 160))return"";
            ...
            f += "";
            var j = /<("[^"]*"|'[^']*'|[^'">])*>/gi;
            if (f)return(f = f.replace(j, "")) && f !== "&nbsp;" && f !== "&#160;" ? f.replace(/\"/g, "'") : ""; else return f
            ...
            if (j && j !== null && j !== undefined) {
                ...
                for (g = f.length; c < g; c++) {
                    ...
                    if (j[c] !==
                        undefined)h[f[c].toLowerCase()] = parseInt(j[c], 10)
                }
                h.m = parseInt(h.m, 10) - 1;
                c = h.y;
                if (c >= 70 && c <= 99)h.y = 1900 + h.y; else if (c >= 0 && c <= 69)h.y = 2E3 + h.y
            }
            ...
            h = f[j];
            if (h === undefined)try {
                if (typeof j === "string")g = j.split(".");
                if (k = g.length)for (h = f; h &&
                    k--;) {
                    c = g.shift();
                    h = h[c]
                }
            ...
            return new function (j, h) {
                ...
                this._repeatCommand = function (m, o) {
                    if (v === null)return c;
                    if (m !== null && o !== null)return v(m, o);
                    if (z === null)return v(m);
                    if (!O)return v(m);
                    return v(z, m)
                };
                ...
                this.startsWith = function (m, o) {
                    ...
                    if (O)c._append(c._getStr("jQuery.jgrid.getAccessor(this,'" + m + "')") + ".substr(0," + q + ") == " + c._getStr('"' + c._toStr(o) + '"')); else {
                    ...
                    var c =
                        ...
                        g = {headers:[], cols:[], footers:[], dragStart:function (e, d, i) {
                            ...
                            if (this.resizing) {
                                ...
                                if (this.footers.length > 0)this.footers[e].style.width = d + "px";
                                if (c.forceFit === true) {
                                    ...
                                    if (this.footers.length > 0)this.footers[e + c.nv].style.width = d + "px";
                            ...
                            if (e) {
                                ...
                                if (n) {
                                    ...
                                    if (y)if (!(c.lastpage && t > c.lastpage || c.lastpage == 1 || t === c.page && t === c.lastpage))if (g.hDiv.loading)g.timer = setTimeout(g.populateVisible, c.scrollTimeout); else {
                                        c.page = t;
                                        if (x) {
                            ...
                            g.hDiv.scrollLeft =
                                g.bDiv.scrollLeft;
                            if (c.footerrow)g.sDiv.scrollLeft = g.bDiv.scrollLeft;
                            e.stopPropagation()
                            ...
                            d.gridComplete = function () {
                                d.selrow = null;
                                d.selarrrow = [];
                                if (d.multiselect && n && n.length > 0)for (var s = 0; s < n.length; s++)n[s] != i && b(e).jqGrid("setSelection", n[s], false);
                    ...
                    if (this.tagName !=
                        ...
                        if (this.p.colNames.length !== this.p.colModel.length)alert(b.jgrid.errors.model); else {
                            ...
                            var K = function (e, d) {
                                ...
                                if (F)t += "text-align:" + F + ";";
                                if (s.hidden === true)t += "display:none;";
                                if (d === 0)t += "width: " + g.headers[e].width + "px;"; else if (s.cellattr && b.isFunction(s.cellattr))if ((e = s.cellattr.call(a, p, i, n, s, A)) && typeof e === "string") {
                                    e = e.replace(/style/i, "style").replace(/title/i, "title");
                                    if (e.indexOf("title") > -1)s.title = false;
                                    if (e.indexOf("class") > -1)y = undefined;
                                    w = e.split("style");
                                    if (w.length === 2) {
                                        w[1] = b.trim(w[1].replace("=", ""));
                                        if (w[1].indexOf("'") === 0 || w[1].indexOf('"') === 0)w[1] = w[1].substring(1);
                                        t += w[1].replace(/'/gi, '"')
                                    } else t += '"'
                                }
                                if (!w.length) {
                                ...
                                if (!d || !d.length)d = b.map(a.p.colModel, function (i, n) {
                                    return n
                                });
                                if (e)d = b.map(d, function (i) {
                                    return i < e ? null : i - e
                                });
                                return d
                            }, W = function (e, d, i) {
                                ...
                                if (i === true)if (a.p.treeGrid === true) {
                                    a.p.data = [];
                                    a.p._index = {}
                                }
                            }, U = function () {
                                ...
                                if (b.isXMLDoc(e)) {
                                    ...
                                    if (e && V) {
                                        ...
                                        var oa = "";
                                        if (a.p.grouping && a.p.groupingView.groupCollapse === true)oa =
                                            ' style="display:none;"';
                                        for (; Z < V;) {
                                            u = e[Z];
                                            C = F(u, ra + Z);
                                            ...
                                            if (a.p.grouping) {
                                                ...
                                                for (var xa = [], ya = 0; ya < t; ya++)xa.push(I[a.p.groupingView.groupField[ya]]);
                                    ...
                                    if (a.p.gridview === true) {
                                        ...
                                        if (a.p.grouping) {
                                            ...
                                            ia = null
                                        } else a.p.treeGrid === true && y > 0 ? b(a.rows[y]).after(H.join("")) : b("tbody:first", d).append(H.join(""))
                                    }
                                    ...
                                    if (x > 0)if (a.p.records === 0)a.p.records = V;
                                    H = null;
                                    if (a.p.treeGrid ===
                                        true)try {
                                ...
                                if (e) {
                                    ...
                                    for (; e < N;) {
                                        ...
                                        if (C === undefined) {
                                            C = Z + e;
                                            if (w.length === 0)if (d.cell)C = b.jgrid.getAccessor(p, d.cell)[s] || C
                                        }
                                        y = i === 1 ? 0 : i;
                                        y = (y + e) % 2 == 1 ? ha : "";
                                        ...
                                        if (d.repeatitems) {
                                            if (d.cell)p = b.jgrid.getAccessor(p, d.cell);
                                            G || (G = D(Q + M + L))
                                        }
                                        ...
                                        if (a.p.grouping) {
                                            ...
                                            x = [];
                                            for (var oa = 0; oa < y; oa++)x.push(I[a.p.groupingView.groupField[oa]]);
                                    ...
                                    if (a.p.gridview === true) {
                                        ...
                                        if (a.p.grouping)b(a).jqGrid("groupingRender", fa, a.p.colModel.length); else a.p.treeGrid === true && u > 0 ? b(a.rows[u]).after(H.join("")) : b("#" + b.jgrid.jqID(a.p.id) +
                                    ...
                                    a.p.totaltime = new Date - A;
                                    if (t > 0)if (a.p.records === 0)a.p.records = N;
                                ...
                                function e(u) {
                                    var C = 0, H, ha, V;
                                    if (u.groups !== undefined)for (H = 0; H < u.groups.length; H++) {
                                        try {
                                            e(u.groups[H])
                                        } catch (Z) {
                                            alert(Z)
                                ...
                                if (b.isArray(a.p.data)) {
                                    ...
                                    b.each(a.p.colModel, function () {
                                        ...
                                        if (F == "date" || F == "datetime") {
                                            ...
                                            } else s = t = this.datefmt || "Y-m-d";
                                            n[this.name] = {stype:F, srcfmt:s, newfmt:t}
                                        } else n[this.name] = {stype:F, srcfmt:"", newfmt:""};
                                        if (a.p.grouping && this.name == y.groupField[0]) {
                                            var u = this.name;
                                            if (typeof this.index != "undefined")u = this.index;
                                            p[0] = n[u];
                                            A.push(u)
                                        }
                                        if (!i &&
                                    ...
                                    if (a.p.treeGrid)b(a).jqGrid("SortTree", d, a.p.sortorder, n[d].stype, n[d].srcfmt); else {
                                        var x = {eq:function (u) {
                                            return u.equals
                                        }, ne:function (u) {
                                            return u.notEquals
                                        ...
                                        if (a.p.ignoreCase)w = w.ignoreCase();
                                        if (a.p.search === true) {
                                            var G = a.p.postData.filters;
                                            if (G) {
                                                if (typeof G ==
                                                    "string")G = b.jgrid.parse(G);
                                                e(G)
                                            } else try {
                                        ...
                                        if (d && a.p.sortorder && i)a.p.sortorder.toUpperCase() == "DESC" ? w.orderBy(a.p.sortname, "d", n[d].stype, n[d].srcfmt) : w.orderBy(a.p.sortname, "a", n[d].stype, n[d].srcfmt);
                                        G = w.select();
                                ...
                                if (!a.grid.hDiv.loading) {
                                    ...
                                    if (p.search !== null)i[p.search] = a.p.search;
                                    if (p.nd !== null)i[p.nd] = (new Date).getTime();
                                    if (p.rows !== null)i[p.rows] = a.p.rowNum;
                                    if (p.page !== null)i[p.page] = a.p.page;
                                    if (p.sort !== null)i[p.sort] = a.p.sortname;
                                    if (p.order !== null)i[p.order] = a.p.sortorder;
                                    if (a.p.rowTotal !== null && p.totalrows !== null)i[p.totalrows] =
                                        a.p.rowTotal;
                                    ...
                                    if (a.p.grouping) {
                                        ...
                                        if (a.p.groupingView.groupDataSorted === true)i[p.sort] = a.p.groupingView.groupField[0] + " " + a.p.groupingView.groupOrder[0] + ", " + i[p.sort]
                                    }
                                    b.extend(a.p.postData, i);
                                    var t = !a.p.scroll ? 1 : a.rows.length -
                                        1;
                                    if (b.isFunction(a.p.datatype))a.p.datatype.call(a, a.p.postData, "load_" + a.p.id); else {
                            ...
                            v = function (e, d) {
                                var i = "", n = "<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>", p = "", A, s, F, t, y = function (x) {
                                    var w;
                                    if (b.isFunction(a.p.onPaging))w = a.p.onPaging.call(a, x);
                                    a.p.selrow = null;
                                    if (a.p.multiselect) {
                                        a.p.selarrrow =
                                            [];
                                ...
                                if (l == "rtl")n += p;
                                if (a.p.pginput === true)i = "<td dir='" + l + "'>" + b.jgrid.format(a.p.pgtext || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>",
                                ...
                                b(".ui-pg-selbox", "#" + A).bind("change", function () {
                                    ...
                                    a.p.rowNum =
                                        this.value;
                                    if (d)b(".ui-pg-selbox", a.p.pager).val(this.value); else a.p.toppager && b(".ui-pg-selbox", a.p.toppager).val(this.value);
                                    if (!y("records"))return false;
                                    ja();
                                    return false
                                });
                                if (a.p.pgbuttons === true) {
                                    ...
                                    b("#first" + d + ", #prev" + d + ", #next" + d + ", #last" + d, "#" + e).click(function () {
                                        ...
                                        if (w === 0 || w === 1)N = L = M = Q = false; else if (w > 1 && x >= 1)if (x === 1)M = Q = false; else {
                                            if (!(x > 1 && x < w))if (x === w)N = L = false
                                        } else if (w > 1 && x === 0) {
                                            N = L = false;
                                            x = w - 1
                                        }
                            ...
                            var Ca = function (e, d, i, n) {
                                if (a.p.colModel[d].sortable)if (!(a.p.savedRow.length > 0)) {
                                    ...
                                    if (n)if (a.p.lastsort == d && a.p.sortorder == n && !i)return; else a.p.sortorder = n;
                                    ...
                                    i = a.p.sortorder;
                                    if (b.isFunction(a.p.onSortCol))if (a.p.onSortCol.call(a, e, d, i) == "stop") {
                                        a.p.lastsort = d;
                                        return
                                    }
                                    ...
                                    ja();
                                    a.p.lastsort = d;
                                    if (a.p.sortname != e && d)a.p.lastsort = d
                                }
                            }, Fa = function (e) {
                            ...
                            this.p.id = this.id;
                            if (b.inArray(a.p.multikey, ["shiftKey", "altKey", "ctrlKey"]) ==
                                -1)a.p.multikey = false;
                            a.p.keyIndex = false;
        ...
        a.jgrid.extend({editRow:function (e, x, l, r, t, y, u, j, s) {
            ...
            return this.each(function () {
                ...
                if (d.grid) {
                    ...
                    if (k !== false)if ((a(k).attr("editable") || "0") == "0" &&
        ...
        jQuery(n).each(function () {
            if (!this.grid) {
                ...
                for (a = 0; a < f.length; a++) {
                    b = null;
                    if (h.length > 0)if ((b = h[a]) && b.replace)b = encodeURIResource(b).replace(/[.\-%]/g, "_");
                    if (b === null)b = a + 1;
