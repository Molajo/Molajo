...
(function () {
    ...
    e.Model = function (a, b) {
        ...
        this._previousAttributes =
            f.clone(this.attributes);
        if (b && b.collection)this.collection = b.collection;
        this.initialize(a, b)
    };
    f.extend(e.Model.prototype, e.Events, {_previousAttributes:null, _changed:false, initialize:function () {
    }, toJSON:function () {
        ...
        fetch:function (a) {
            ...
            var c = this, d = j(b.error, c, b), g = this.isNew() ? "create" : "update";
            ...
            a || (a = this.attributes);
            var b = this._previousAttributes, c = false, d;
    ...
    f.extend(e.Collection.prototype, e.Events, {model:e.Model, initialize:function () {
        ...
        var c = this;
        b || (b = {});
        if (a instanceof e.Model)a.collection = c; else a = new this.model(a, {collection:c});
        return a.save(null, {success:function (d, g) {
            c.add(d);
        ...
        b || (b = {});
        a instanceof e.Model || (a = new this.model(a, {collection:this}));
        var c = this.getByCid(a);
        if (c)throw Error(["Can't add the same model to a set twice", c.id]);
        this._byId[a.id] = a;
        this._byCid[a.cid] = a;
        a.collection = this;
        this.models.splice(this.comparator ? this.sortedIndex(a, this.comparator) :
            this.length, 0, a);
    ...
    var o = /:([\w\d]+)/g, p = /\*([\w\d]+)/g;
    f.extend(e.Controller.prototype, e.Events, {initialize:function () {
    ...
    var l = /^#*/;
    f.extend(e.History.prototype, {interval:50, getFragment:function (a) {
        ...
        this.handlers.push({route:a, callback:b})
    }, checkUrl:function () {
        var a = this.getFragment();
        if (a == this.fragment && this.iframe)a = this.getFragment(this.iframe.location);
        if (a == this.fragment || a == decodeURIResource(this.fragment))return false;
    ...
    e.Model.extend = e.Collection.extend = e.Controller.extend = e.View.extend =
        m;
    ...
    e.sync = function (a, b, c, d) {
        ...
        b = {url:k(b), type:g, contentType:"application/json", data:a, dataType:"json", processData:false, success:c, error:d};
        if (e.emulateJSON) {
