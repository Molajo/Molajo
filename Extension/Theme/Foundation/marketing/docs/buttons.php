    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="six columns">
                <h3>Buttons</h3>
                <h4 class="subheader">We &lt;3 buttons. And so do you! That's why Foundation has multiple buttons styles
                    and color that are not only badass out of the box, but easy to customize for your projects.</h4>
                <hr/>

                <h4>Simple Buttons</h4>

                <p>Foundation buttons have a number of parameters and styles - you can see a few examples below. The out
                    of the box classes include size, color and style (square, slightly rounded, and completely
                    rounded).</p>

                <p>
                    <script src="http://snipt.net/embed/269a08f1db74949e80ee8b40351e609c"></script>
                </p>
                <br/>
                ...
                <p>Nice buttons have a little more pizazz using a background image, but they still support the same
                    classes as any other button including color, size, and corner radius.</p>

                <p>
                    <script type="text/javascript"
                            src="http://snipt.net/embed/ac514168311a363dd4b5130a20cd1efb"></script>
                </p>
                <br/>
