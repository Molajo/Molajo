    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="six columns">
                <h3>Orbit</h3>
                <h4 class="subheader">Orbit is all the rage in jQuery hotness right now. It's a killer, lightweight
                    slider for images &amp; content.</h4>
                <hr/>
                ...
                <!-- Captions for Orbit -->
                <span class="orbit-caption" id="htmlCaption"><strong>I'm A Badass Caption:</strong> I can haz <a
                    href="#">links</a>, <em>style</em> or anything that is valid markup :)</span>

                <h4>The Basic Implementation</h4>

                <p>Orbit is going to be the easiest slider you've ever hooked up. Below are the steps, but for more
                    detail checkout the <a href="http://www.zurb.com/playground/orbit-jquery-image-slider">playground
                        docs</a>.</p>
                <ol>
                    <li>Get some markup like this in your page: <br/><br/>
                        <script src="http://snipt.net/embed/227e566c916fdf7dfa91327dd245787b"></script>
                        <br/>
                    </li>
                    <li>Activate Orbit. You can embed the call in the specific page like this: <br/><br/>
                        <script src="http://snipt.net/embed/190e852a2d48b2c8091028bf35e2a2ad"></script>
                        <br/>
