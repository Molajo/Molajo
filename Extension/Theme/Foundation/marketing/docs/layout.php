    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="six columns example">
                <h3>Layout</h3>
                <h4 class="subheader">Reusable, easy to modify layout conventions, for when the Grid isn't quite
                    enough.</h4>
                <hr/>

                <h4>Mobile Visibility</h4>

                <p>With Foundation 2.0 we've included various mobile visibility affordance classes. Want to hide
                    something on phones, or show it only on tablets? Got you covered.</p>
                ...
                <p>Each of these classes have an implied 'only' as in 'show <strong>only</strong> on tablet' or 'hide
                    <strong>only</strong> on phones'.</p>

                <hr/>
                <h4>Block Grids</h4>

                <p>Block grids are ULs with 2-up, 3-up, 4-up and 5-up styles. These are ideal for blocked-in content
                    generated by an application, as they do not require rows or even numbers of elements to display
                    correctly.</p>

                <p>By default these blocks will stay in their N-up configuration on mobile devices, but you can add a
                    class of 'mobile' to have them reshuffle on smartphones into one element per line, just like the
                    Grid.</p>
