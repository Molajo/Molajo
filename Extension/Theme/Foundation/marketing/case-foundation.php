<?php $page_title = "Foundation Case Study" ?>
    ...
    <div id="insideContainer" class="container">
        ...
        <div class="row">
            ...
            <div class="four columns">
                ...
                <p>Since day one we've built the Foundation documentation, and now this new site, with Foundation.
                    Dating back to the original fixed-width Foundation (born of the ZURB global CSS) we've always built
                    with the tool to better understand how it works, explain it, and test it.</p>

                <p>See any mistakes on this site or the docs? <a href="mailto:foundation@zurb.com">Let us know</a> and
                    we'll get right on it. We want Foundation to be as badass and bulletproof as possible.</p>
            </div>
        </div>
        <br/><br/>
        ...
        <div class="row">
            <div class="four columns">
                ...
                <p>One thing you may have noticed is the grid background on each page. Try scaling down the
                    homepage &mdash; the background grid actually resizes based on the screen (the lines are attached to
                    divs, not a background image). Nerdy, but we wanted to show the real grid.</p>
            </div>
            <div class="four columns">
                <h5>Mobile Slider</h5>
            ...
            <div class="four columns">
                ...
                <p>Are you using Foundation? We'd love to hear about it! Let us know how you're using Foundation and we
                    might feature you as a case study for the framework. Just <a
                        href="mailto:foundation@zurb.com?subject=I'm%20using%20Foundation">let us know via
                        email &rarr;</a></p>
            </div>
        </div>
