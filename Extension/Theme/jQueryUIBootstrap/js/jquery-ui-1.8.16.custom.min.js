...
(function (c, j) {
    ...
    if (!c.ui.version) {
        ...
        c.extend(c.ui, {trigger:{add:function (a, b, d) {
            a = c.ui[a].prototype;
            for (var e in d) {
                a.triggers[e] = a.triggers[e] || [];
                a.triggers[e].push([b, d[e]])
            }
        }, call:function (a, b, d) {
            if ((b = a.triggers[b]) &&
...
(function (d) {
    ...
    d.ui.trigger.add("draggable", "cursor", {start:function () {
    ...
    d.ui.trigger.add("draggable", "opacity", {start:function (a, b) {
        a = d(b.helper);
    ...
    d.ui.trigger.add("draggable", "scroll", {start:function () {
    ...
    d.ui.trigger.add("draggable", "snap", {start:function () {
    ...
    d.ui.trigger.add("draggable", "stack", {start:function () {
        var a = d(this).data("draggable").options;
    ...
    d.ui.trigger.add("draggable", "zIndex", {start:function (a, b) {
        a = d(b.helper);
        b = d(this).data("draggable").options;
...
(function (e) {
    ...
    e.ui.trigger.add("resizable", "animate", {stop:function (b) {
        var a =
    ...
    e.ui.trigger.add("resizable", "containment", {start:function () {
    ...
    e.ui.trigger.add("resizable", "ghost", {start:function () {
    ...
    e.ui.trigger.add("resizable", "grid", {resize:function () {
        var b =
...
(function (d, C) {
    ...
    d.fn.datepicker = function (a) {
        ...
        if (!d.datepicker.initialised) {
            d(document).mousedown(d.datepicker._checkExternalClick).find("body").append(d.datepicker.dpDiv);
            d.datepicker.initialised = true
        }
    ...
    d.datepicker = new M;
    d.datepicker.initialised = false;
