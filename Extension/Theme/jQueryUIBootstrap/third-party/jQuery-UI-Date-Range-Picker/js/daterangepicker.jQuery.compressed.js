jQuery.fn.daterangepicker = function (s) {
    var c = jQuery(this);
    var d = jQuery.extend({presetRanges:[
    ...
    }, datepickerOptions:null}, s);
    var f = {onSelect:function (z, y) {
    ...
    m.find(".range-start, .range-end").bind("constrainOtherPicker",
        function () {
            if (d.constrainDates) {
    ...
    var e = jQuery('<button class="btnDone ui-state-default ui-corner-all">' + d.doneButtonText + "</button>").click(
        function () {
    ...
    if (d.arrows && c.size() == 1) {
        ...
        jQuery(this).addClass("ui-rangepicker-input ui-widget-content").wrap('<div class="ui-daterangepicker-arrows ui-widget ui-widget-header ui-helper-clearfix ui-corner-all"></div>').before(g).before(q).parent().find("a").click(
            function () {
                ...
                m.find(".range-start, .range-end ").each(function () {
                    ...
                    jQuery(this).datepicker("setDate", z.add({milliseconds:y})).find(".ui-datepicker-current-day").trigger("click")
                });
                return false
            }).hover(function () {
            jQuery(this).addClass("ui-state-hover")
...
(function () {
    ...
    Date.Grammar = {};
    Date.Translator = {hour:function (g) {
        return function () {
            this.hour = Number(g)
        }
    }, minute:function (g) {
        ...
        if (this.timezone) {
            l.set({timezone:this.timezone})
        } else {
            if (this.timezoneOffset) {
                l.set({timezoneOffset:this.timezoneOffset})
            }
        }
        return l
    }, finish:function (g) {
