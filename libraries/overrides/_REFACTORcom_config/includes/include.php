...
/** Override Component Model to add Form Events - will go away when we replace the entire component **/
$filehelper->requireClassFile (MOLAJO_LIBRARY.'/com_config/models/component.php', 'ConfigModelComponent');
