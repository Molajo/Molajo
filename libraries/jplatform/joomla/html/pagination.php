...
class JPagination extends JObject
{
	...
	protected function _buildDataObject()
	{
		...
		$data->all = new JPaginationObject(JText::_('MOLAJO_HTML_VIEW_ALL'), $this->prefix);
		if (!$this->_viewall) {
			$data->all->base	= '0';
		...
		$data->start	= new JPaginationObject(JText::_('MOLAJO_HTML_START'), $this->prefix);
		...
		$data->end	= new JPaginationObject(JText::_('MOLAJO_HTML_END'), $this->prefix);
