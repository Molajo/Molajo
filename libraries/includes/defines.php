...
define('MOLAJO_CONFIG_OPTION_ID_PUBLISH_FIELDS', 2);
...
/** Layouts **/
define('MOLAJO_CONFIG_OPTION_ID_EDIT_LAYOUTS_APPLICATION1', 50);
define('MOLAJO_CONFIG_OPTION_ID_DEFAULT_LAYOUT_APPLICATION1', 51);
define('MOLAJO_CONFIG_OPTION_ID_DISPLAY_LAYOUTS_APPLICATION1', 52);
define('MOLAJO_CONFIG_OPTION_ID_EDIT_LAYOUTS_APPLICATION0', 55);
define('MOLAJO_CONFIG_OPTION_ID_DEFAULT_LAYOUT_APPLICATION0', 56);
define('MOLAJO_CONFIG_OPTION_ID_DISPLAY_LAYOUTS_APPLICATION0', 57);
/** Formats **/
define('MOLAJO_CONFIG_OPTION_ID_FORMAT', 75);
/** Tasks **/
define('MOLAJO_CONFIG_OPTION_ID_DISPLAY_CONTROLLER_TASKS', 80);
define('MOLAJO_CONFIG_OPTION_ID_EDIT_CONTROLLER_TASKS', 85);
