...
abstract class JInstallerHelper
{
	...
	public static function downloadPackage($url, $target = false)
	{
		...
		if (!$inputHandle) {
			JError::raiseWarning(42, JText::sprintf('MOLAJO_INSTALLER_ERROR_DOWNLOAD_SERVER_CONNECT', $error));
			return false;
		}
		...
		while (!feof($inputHandle))
		{
			...
			if ($contents === false)
			{
				JError::raiseWarning(44, JText::sprintf('MOLAJO_INSTALLER_ERROR_FAILED_READING_NETWORK_RESOURCES', $php_errormsg));
				return false;
			}
		}
