...
INSERT INTO `molajo_extension_options`
  (`extension_instance_id`, `option_id`, `option_value`, `option_value_literal`, `ordering`)
    ...
    (1, 210, 'start_publishing_datetime', 'MOLAJO_FIELD_START_PUBLISHING_DATETIME_LABEL', 5),
    (1, 210, 'stop_publishing_datetime', 'MOLAJO_FIELD_STOP_PUBLISHING_DATETIME_LABEL', 4),
    (1, 210, 'status', 'MOLAJO_FIELD_STATUS_LABEL', 6),
    (1, 210, 'stickied', 'MOLAJO_FIELD_STICKIED_LABEL', 7),
    (1, 210, 'group_id_list_view_action', 'MOLAJO_FIELD_GROUP_ID_LIST_VIEW_ACTION_LABEL', 34),
    (1, 210, 'group_id_list_create_action', 'MOLAJO_FIELD_GROUP_ID_LIST_CREATE_ACTION_LABEL', 34),
    (1, 210, 'group_id_list_edit_action', 'MOLAJO_FIELD_GROUP_ID_LIST_EDIT_ACTION_LABEL', 34),
    (1, 210, 'group_id_list_publish_action', 'MOLAJO_FIELD_GROUP_ID_LIST_PUBLISH_ACTION_LABEL', 34),
    (1, 210, 'group_id_list_delete_action', 'MOLAJO_FIELD_GROUP_ID_LIST_DELETE_ACTION_LABEL', 34),
    (1, 210, 'group_id_list_administer_action', 'MOLAJO_FIELD_GROUP_ID_LIST_ADMINISTER_ACTION_LABEL', 34);
...
INSERT INTO `molajo_extension_options`
  (`extension_instance_id`, `option_id`, `option_value`, `option_value_literal`, `ordering`)
    VALUES
    (1, 220, '', '', 0),
    (1, 220, 'custom_fields', 'MOLAJO_FIELD_JSON_CUSTOM_FIELDS_LABEL', 1),
    (1, 220, 'metadata', 'MOLAJO_FIELD_JSON_METADATA_LABEL', 2),
    (1, 220, 'parameters', 'MOLAJO_FIELD_JSON_PARAMETERS_LABEL', 3);
