...
class MolajoLanguage extends JObject
{
     ...
     * @since   11.1
     */
    public static function exists($lang, $basePath = MOLAJO_EXTENSION_LANGUAGES)
    {
        static $paths = array();
     ...
     * @since   11.1
     */
    public function load($extension = 'molajo', $basePath = MOLAJO_EXTENSION_LANGUAGES, $lang = null, $reload = false, $default = true)
    {
        if ($lang) {
        } else {
            $lang = $this->lang;
    ...
    {
        $path = self::getLanguagePath(MOLAJO_EXTENSION_LANGUAGES, $lang);
        $file = "$lang.xml";
     ...
     * @since   11.1
     */
    public static function getKnownLanguages($basePath = MOLAJO_EXTENSION_LANGUAGES)
    {
