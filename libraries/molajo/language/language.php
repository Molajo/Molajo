...
class MolajoLanguage extends JObject
{
     ...
     *
     * @deprecated    12.1
     * @note    Use MolajoLanguage::getPluralSuffixesCallback method instead
     */
    public function getPluralSufficesCallback()
    {
        // Deprecation warning.
        JLog::add('MolajoLanguage::_getPluralSufficesCallback() is deprecated.', JLog::WARNING, 'deprecated');
     ...
     * @since   11.1
     */
    public static function exists($lang, $basePath = MOLAJO_APPLICATION_PATH)
    {
        static $paths = array();
     ...
     * @since   11.1
     */
    public function load($extension = 'molajo', $basePath = MOLAJO_APPLICATIONS_PATH, $lang = null, $reload = false, $default = true)
    {
        if (!$lang) {
            $lang = $this->lang;
        }
    ...
    /**
     * Determine who called MolajoLanguage or JText.
     *
    ...
    protected function getCallerInfo()
    {
        ...
        while ($continue && next($backtrace))
        {
            ...
            if ($class != 'MolajoLanguage' && $class != 'JText') {
     ...
     * @since   11.1
     */
    public static function getKnownLanguages($basePath = MOLAJO_APPLICATION_PATH)
    {
     ...
     * @since   11.1
     */
    public static function getLanguagePath($basePath = MOLAJO_APPLICATION_PATH, $language = null)
    {
    ...
    {
        // Deprecation warning.
        JLog::add('MolajoLanguage::_parseLanguageFiles() is deprecated.', JLog::WARNING, 'deprecated');
    ...
    {
        // Deprecation warning.
        JLog::add('MolajoLanguage::_parseXMLLanguageFiles() is deprecated.', JLog::WARNING, 'deprecated');
