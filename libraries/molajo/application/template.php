...
abstract class MolajoApplicationTemplate
{
    ...
    public static function renderTemplate()
    {
        ...
        $filePath = MOLAJO_EXTENSION_TEMPLATES.'/'.$template[0]->title;
        ...
        $lang->load($template[0]->title, MOLAJO_EXTENSION_TEMPLATES.'/'.$template[0]->title, $lang->getDefault(), false, false);
