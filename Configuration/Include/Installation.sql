...
SET @parameters = CONCAT('
{
    "1":{},
    "2":{
"configuration_tab_class":"mobile",
"configuration_tab_link_namespace":"config",
"configuration_tab_array":"{{Basic,basic}}{{Customfields,customfields}}{{Metadata,metadata}}{{Form,form}}{{Item,item}}{{List,list}}{{Editor,editor}}{{Grid,grid}}",
"configuration_tab":"",
...
"configuration_tab_list":"{{Page,list_parent*,list_theme*,list_page*}}{{Template,list_template*}}{{Wrap,list_wrap*}}{{Model,list_model*}}",
"configuration_tab_editor":"{{Main,editor_toolbar*,editor_main*,editor_secondary*}}{{Publish,editor_publish*}}{{Permissions,editor_permission*}}{{SEO,editor_seo*}}",
"configuration_tab_grid":"{{Grid,grid_toolbar*,grid_stat*,grid_ordering*}}{{Lists,grid_list*}}{{Columns,grid_col*}}{{Batch,grid_batch*}}",
...
"editor_tab_array":"{{Main,main}}{{Publish,publish}}{{Permissions,permissions}}{{SEO,seo}}",
