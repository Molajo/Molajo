...
class ResourcePlugin extends SystemEventPlugin implements SystemInterface
{
    ...
    protected function getResourceMenu()
    {
        ...
        } elseif (strtolower($this->runtime_data->route->page_type) == 'new') {
            $this->getResourceExtension();

        } else {
            $this->plugin_data->resource->criteria_catalog_type_id
                = $this->plugin_data->resource->menuitem->data->catalog_type_id;
            $this->plugin_data->resource->resource_model_name
                = ucfirst($this->plugin_data->resource->menuitem->data->alias);
        }
    ...
    {
        $page_type = ucfirst(strtolower($this->runtime_data->route->page_type));
    ...
    protected function getResourceExtension()
    {
        ...
        $this->plugin_data->resource->criteria_catalog_type_id = $data->catalog_type_id;
