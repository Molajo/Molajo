...
Class BroadcastService
{
	...
	public function __construct()
	{
		...
		$this->on = (int)Service::Registry()->get('Configuration', 'Broadcast', 0);
		if ($this->on == 0)
		{
			return true;
		}
		...
		$options['twitter_tweet'] = Service::Registry()->get('Configuration', 'twitter_tweet', 1);
		$options['twitter_consumer_key'] = Service::Registry()->get('Configuration', 'twitter_consumer_key', '5HroaAP3vnOE3Hqkpjh7og');
		$options['twitter_consumer_secret'] = Service::Registry()->get('Configuration', 'twitter_consumer_secret', 'dtEht0raDHQjAvma2AhJCUhzeq5HyU6NPhhWNxo42Y');
