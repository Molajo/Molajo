...
INSERT INTO `#__categories` ( `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`,
  ...
  `access`, `asset_id` )
  VALUES
    (1, 1, 2, 1, 'uncategorised', 'com_articles', 'Articles', 'articles', '', '', 1, 0, '0000-00-00 00:00:00', '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2010-06-28 13:26:37', 42, '2011-06-03 16:52:26', 0, '*', @default_view_access, @max_asset_id);
