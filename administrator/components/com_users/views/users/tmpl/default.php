	...
	<table class="adminlist">
		...
		?>
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<?php if ($canEdit) : ?>
					<a href="<?php echo MolajoRoute::_('index.php?option=com_users&task=user.edit&id='.(int) $item->id); ?>" title="<?php echo JText::sprintf('COM_USERS_EDIT_USER', $this->escape($item->name)); ?>">
