...
?>
<form action="<?php echo JRoute::_('index.php?option=com_modules&view=positions&layout=modal&tmpl=component&function='.$function.'&application_id=' .$applicationId);?>" method="post" name="adminForm" id="adminForm">
