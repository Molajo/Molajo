<?php
/**
 * @version		$Id: default.php 21031 2011-03-29 16:35:23Z dextercowley $
...
<form action="<?php echo MolajoRoute::_('index.php?option=com_messages'); ?>" method="post" name="adminForm" id="adminForm">
	<div class="width-60 fltlft">
		...
		<li><?php echo MolajoText::_('COM_MESSAGES_FIELD_USER_ID_FROM_LABEL'); ?>
		...
		<li><?php echo MolajoText::_('COM_MESSAGES_FIELD_MESSAGE_LABEL'); ?>
