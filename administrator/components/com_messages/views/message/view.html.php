...
class MessagesViewMessage extends JView
{
	...
	protected function addToolbar()
	{
		if ($this->getLayout() == 'edit') {
			MolajoToolbarHelper::title(MolajoText::_('COM_MESSAGES_WRITE_PRIVATE_MESSAGE'), 'new-privatemessage.png');
			...
			MolajoToolbarHelper::title(MolajoText::_('COM_MESSAGES_VIEW_PRIVATE_MESSAGE'), 'inbox.png');
			$sender = MolajoUser::getInstance($this->item->user_id_from);
