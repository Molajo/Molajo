		...
		if (empty(self::$buttons)) {
			self::$buttons = array(
				array(
					...
					'access' => array('manage', 'com_articles', 'create', 'com_articles', )
				),
				array(
