...
<style>
	...
	.mc-delete {position:absolute;top:0px;right:0px;display:block;background:url(templates/rt_missioncontrol_j16/images/bullet_delete.png);width:16px;height:16px;}
