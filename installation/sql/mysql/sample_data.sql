...
INSERT INTO `#__assets`
  ( `content_id`, `id`, `content_table`, `option`, `path`, `link`, `access`)
    VALUES
    (1, 8210, '__articles', 'com_articles', 'articles/my-first-article', 'index.php?option=com_articles&view=display&id=1', 1),
    (2, 8220, '__articles', 'com_articles', 'articles/my-second-article', 'index.php?option=com_articles&view=display&id=2', 1),
    (3, 8230, '__articles', 'com_articles', 'articles/my-third-article', 'index.php?option=com_articles&view=display&id=3', 1),
    (4, 8240, '__articles', 'com_articles', 'articles/my-fourth-article', 'index.php?option=com_articles&view=display&id=4', 1),
    (5, 8250, '__articles', 'com_articles', 'articles/my-fifth-article', 'index.php?option=com_articles&view=display&id=5', 1);
