...
INSERT INTO `#__categories` ( `id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `subtitle`, `alias`, `note`,
  ...
  VALUES
    ...
    (2, 1, 1, 2, 1, 'uncategorised', 'com_articles', 'Articles', 'Category for Articles', 'articles', '', '', 1, 0, '0000-00-00 00:00:00', '{"category_layout":"","image":""}', '', '', '{"author":"","robots":""}', 42, '2010-06-28 13:26:37', 42, '2011-06-03 16:52:26', 0, '*', 1, 101);

INSERT INTO `#__articles` (
  `id`, `catid`, `title`, `subtitle`, `alias`, `content_type`, `content_text`, `content_link`, `content_email_address`,
...
# menus
INSERT INTO `#__assets` SELECT DISTINCT `asset_id`, '#__menu_items' FROM `#__menu_items`;
# administrator has full control
