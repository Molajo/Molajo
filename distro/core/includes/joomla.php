...
if (defined('JPATH_PLUGINS')) {
    ...
    define('JPATH_PLUGINS', MOLAJO_DISTRO_PLUGINS);
}
...
if (defined('JPATH_MANIFESTS')) {
    ...
    define('JPATH_MANIFESTS', MOLAJO_DISTRO_MANIFESTS);
}
if (defined('JPATH_THEMES')) {
} else {
    define('JPATH_THEMES', MOLAJO_DISTRO_TEMPLATES);
}
if (defined('JPATH_COMPONENT')) {
} else {
    define('JPATH_COMPONENT', MOLAJO_DISTRO_COMPONENTS);
}
