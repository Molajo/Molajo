...
if (defined('MOLAJO_DISTRO')) {
} else {
    define('MOLAJO_DISTRO', MOLAJO_BASE_FOLDER . '/cms');
}
if (defined('MOLAJO_DISTRO_COMPONENTS')) {
} else {
    define('MOLAJO_DISTRO_COMPONENTS', MOLAJO_DISTRO . '/components');
}
if (defined('MOLAJO_DISTRO_LANGUAGES')) {
} else {
    define('MOLAJO_DISTRO_LANGUAGES', MOLAJO_DISTRO . '/languages');
}
if (defined('MOLAJO_DISTRO_LAYOUTS')) {
} else {
    define('MOLAJO_DISTRO_LAYOUTS', MOLAJO_DISTRO . '/layouts');
}
if (defined('MOLAJO_DISTRO_MANIFESTS')) {
} else {
    define('MOLAJO_DISTRO_MANIFESTS', MOLAJO_DISTRO . '/manifests');
}
if (defined('MOLAJO_DISTRO_MODULES')) {
} else {
    define('MOLAJO_DISTRO_MODULES', MOLAJO_DISTRO . '/modules');
}
if (defined('MOLAJO_DISTRO_PLUGINS')) {
} else {
    define('MOLAJO_DISTRO_PLUGINS', MOLAJO_DISTRO . '/plugins');
}
if (defined('MOLAJO_DISTRO_TEMPLATES')) {
} else {
    define('MOLAJO_DISTRO_TEMPLATES', MOLAJO_DISTRO . '/templates');
}

if (defined('MOLAJO_APPLICATION_CORE_DATA')) {
} else {
    define('MOLAJO_APPLICATION_CORE_DATA', MOLAJO_APPLICATION_CORE . '/data');
}
if (defined('MOLAJO_APPLICATION_CORE_DATA')) {
} else {
    define('MOLAJO_APPLICATION_CORE_DATA', MOLAJO_APPLICATION_CORE . '/data');
}
if (defined('MOLAJO_APPLICATION_CORE_DATA_ENTITIES')) {
} else {
    define('MOLAJO_APPLICATION_CORE_DATA_ENTITIES', MOLAJO_APPLICATION_CORE . '/data');
}
if (defined('MOLAJO_APPLICATION_CORE_DATA_PROXIES')) {
} else {
    define('MOLAJO_APPLICATION_CORE_DATA_PROXIES', MOLAJO_APPLICATION_CORE_DATA . '/proxies');
}
