...
abstract class MolajoPageHelper
{
    ...
    static public function getPage()
    {
        ...
        foreach ($pages as $page) {
            ...
            if (file_exists(MOLAJO_DISTRO_TEMPLATES . '/' . $page->title . '/' . 'index.php')) {
            } else {
                $page->title = 'default';
            }
        }
    ...
    public static function renderPage()
    {
        ...
        $filePath = MOLAJO_DISTRO_TEMPLATES . '/' . $page[0]->title;
        ...
        $lang->load($page[0]->title, MOLAJO_DISTRO_TEMPLATES . '/' . $page[0]->title, $lang->getDefault(), false, false);
