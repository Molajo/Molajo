...
abstract class MolajoModule
{
    ...
    public static function renderModule($moduleObject, $attribs = array())
    {
        ...
        $path = MOLAJO_DISTRO_MODULES . '/' . $module->extension_name . '/' . $module->extension_name . '.php';

        // Load the module
        if (file_exists($path)) {

            $lang = MolajoFactory::getLanguage();
            $lang->load($module->extension_name, MOLAJO_DISTRO_MODULES . '/' . $module->extension_name, $lang->getDefault(), false, false);
